...
Test case ID: QUALIF_TEST_TF_B_RGS_VL_Temp
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_B_2663
Description of the requirement:  Description: RGS sends the internal ECU temperature (detected using SBC temperature sensor) on this signal.
************************************************************************************************
...
const CFGc_FunctionOffsetToTest1: Number = 17;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      if (true == bWriteVariableResult)
      {
         ...
         RESULT.ExpectTestResult("Read RGS_VL_Temp from CAN bus", CAN.GetSignalFromFrame("RGS_VL_01", "RGS_VL_Temp")[1], "0xFD");
      }
