...
Test case ID: QUALIF_TEST_TF_B_2664_RGS_VL_Temp_TEMPERATURE_SENSOR_FAILURE
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_B_2664
Description of the requirement:  Signal shall be set to "Error" when ERR_TEMPERATURE_SENSOR_FAILURE is qualified
************************************************************************************************
...
const CFGc_FunctionOffsetToTest1: Number = 113;
const CFGc_FunctionOffsetToTest2: Number = 115;
const CFGc_FunctionOffsetToTest3: Number = 124;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      if (true == bWriteVariableResult)
      {
         ...
         ResultStep("cil_u8RGS_Temp - 0x00", "cil_u8RGS_Temp - 0x00")
      }
