...
Test case ID: QUALIF_TEST_TF_B_2663_RGS_VL_keineStraffungUeberspg
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_B_2663
Description of the requirement:  Signal shall be permanently set to "error not active" because overvoltage error doesn't abort any belt profile.
************************************************************************************************
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      CommentStep("Set Overvoltage conditions")

      SwDevLib_PS1_SetVoltage(iKL30OvervoltageValue);
      ...
      CommentStep("read memory - cil_u8RGS_keine_Straffung_Ueberspg")
      
      iReadVariableValue = debugger_evaluate("cil_u8RGS_keine_Straffung_Ueberspg");

      RESULT.ExpectTestResult("Evaluate cil_u8RGS_keine_Straffung_Ueberspg ",
         iReadVariableValue,
         "1"
      );
         
      ResultStep("cil_u8RGS_keine_Straffung_Ueberspg - 0x01", "cil_u8RGS_keine_Straffung_Ueberspg - 0x01")
