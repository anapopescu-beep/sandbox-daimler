...
Test case ID: QUALIF_TEST_TF_I_BAT_PWR_OVER_VOLTAGE_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_6770
Description of the requirement: ERR_BAT_PWR_OVER_VOLTAGE shall be defined as a Counter based AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "PMP_cbk_CheckPowerSupplyOV"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 72; // should be configured
...
const CFGc_DemEventID = 42 // should be configured
