...
Test case ID: QUALIF_TEST_TF_I_EXT_MOTOR_BLOCKED_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_6990
Description of the requirement: ERR_MOTOR_BLOCKED shall be defined as a Counterbased AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "PAL_cbk_CheckMotorDisengagement"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 48; // should be configured
...
const CFGc_DemEventID = 14 // should be configured
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      /* Set preconditions */
      SetTriggeringPrecond("PRECRASH_4");

      /* Start the PRE_CRASH_0 cycle */
      LaunchMasterBeltProfile("PRECRASH_4");
      
      Wait(125);
      
      CheckStartedProfile("PRECRASH_4");
      ...
      RemoveMasterBeltProfile("PRECRASH_4");
      
      Wait(450);
      
      CheckStartedProfile("SOFT_RELEASE");
