...
Test case ID: QUALIF_TEST_TF_I_TEMPERATURE_SENSOR_FAILURE_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_6880, DES_TF_I_6751
Description of the requirement: DES_TF_I_6880: ⦁	Linked Auto-test: "TF_H13 - To Check Temperature Sensor"
DES_TF_I_6751: ERR_TEMPERATURE_SENSOR_FAILURE shall be defined as a Counterbased AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "PMP_cbk_CheckTemperatureSensor"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 56; // should be configured
...
const CFGc_DemEventID = 12 // should be configured
