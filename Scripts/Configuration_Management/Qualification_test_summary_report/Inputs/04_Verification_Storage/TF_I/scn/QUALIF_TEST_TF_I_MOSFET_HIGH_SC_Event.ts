...
Test case ID: QUALIF_TEST_TF_I_MOSFET_HIGH_SC_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_6967
Description of the requirement: ERR_MOSFET_HIGH_SC shall be defined as a Counterbased AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "PAL_cbk_CheckMosfetHighSC"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 16; // should be configured
...
const CFGc_DemEventID = 2 // should be configured
