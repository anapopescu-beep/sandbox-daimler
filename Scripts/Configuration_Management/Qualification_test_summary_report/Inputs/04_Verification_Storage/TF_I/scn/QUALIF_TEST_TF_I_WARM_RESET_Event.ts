...
Test case ID: QUALIF_TEST_TF_I_WARM_RESET_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_6882
...
const CFGc_AutotestFunction: String = "RCM_Autotest_RunResetCause"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 108; // should be configured
...
const CFGc_DemEventID = 11 // should be configured
