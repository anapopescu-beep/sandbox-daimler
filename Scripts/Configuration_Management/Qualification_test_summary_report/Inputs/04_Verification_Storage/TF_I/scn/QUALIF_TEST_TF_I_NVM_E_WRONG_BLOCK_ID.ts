...
Test case ID: QUALIF_TEST_TF_I_NVM_E_WRONG_BLOCK_ID
Result Test:
************************************************************************************************
Requirement under test: TR6_DES_TF_I_8886, TR6_DES_TF_I_8887, TR6_DES_TF_I_8888
Description of the requirement: ERR_NVM_E_WRONG_BLOCK_ID AEC qualification and deskill instantaneously.
************************************************************************************************
...
CALL(/../../ProjectLib_Development/SBE_Configuration.ts);
 ...
 /*------------------------------------------------------------------------------
                                CONSTANTS
------------------------------------------------------------------------------*/
const AEC_var = "NVM_E_WRONG_BLOCK_ID"
...
const CFGc_SetEventFunction: String = "NvM_ReportReadProductionErrors";
const CFGc_SetEventFunctionOffset1: Number = 87; // should be configured
const CFGc_SetEventFunctionOffset2: Number = 122; // should be configured
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
        ...
        CommentStep("Write memory - NvM_GlobalWorkingStatus set to 0x800")
		bWriteVariableResult = debugger_modify("NvM_GlobalWorkingStatus", 0x800)
