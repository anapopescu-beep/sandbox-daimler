...
Test case ID: QUALIF_TEST_TF_I_EXT_WDG_OUT_OF_ORDER_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_7014
Description of the requirement: ERR_EXT_WDG_OUT_OF_ORDER_FAILURE shall be defined as a Counterbased AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "RCM_cbk_ExtWatchdogTest_Autotest"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 92; // should be configured
...
const CFGc_DemEventID = 13 // should be configured
