...
Test case ID: QUALIF_TEST_TF_I_NVM_INTEGRITY_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_7139, DES_TF_I_7140, DES_TF_I_7142, DES_TF_I_7143, DES_TF_I_7144
Description of the requirement: DES_TF_I_7139: ⦁	Identifier: 0x21
DES_TF_I_7140: ⦁	Linked Auto-test: "TF_H3- To Check NVM Integrity.
DES_TF_I_7142: ERR_NVM_INTEGRITY shall be defined as a Counterbased AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "MIC_cbk_RunEepromMemoryCorruption_Autotest"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 100; // should be configured
...
const CFGc_DemEventID = 33 // should be configured
