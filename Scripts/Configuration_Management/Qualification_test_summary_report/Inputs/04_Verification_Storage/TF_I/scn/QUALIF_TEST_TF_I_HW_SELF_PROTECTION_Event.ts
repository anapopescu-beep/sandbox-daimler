...
Test case ID: QUALIF_TEST_TF_I_HW_SELF_PROTECTION_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_6741
Description of the requirement: ERR_HW_SELF_PROTECTION shall be defined as a Counter based AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "PAL_cbk_CheckHWSelfProtection"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 28; // should be configured
...
const CFGc_DemEventID = 7 // should be configured
