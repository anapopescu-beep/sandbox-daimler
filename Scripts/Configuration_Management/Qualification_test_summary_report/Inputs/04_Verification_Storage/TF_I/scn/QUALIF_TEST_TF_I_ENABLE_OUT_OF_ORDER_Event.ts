...
Test case ID: QUALIF_TEST_TF_I_ENABLE_OUT_OF_ORDER_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_6757
Description of the requirement: ERR_ENABLE_OUT_OF_ORDER shall be defined as a Counterbased AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "PAL_Autotest_CheckCommandConsistency"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 12; // should be configured
...
const CFGc_DemEventID = 6 // should be configured
