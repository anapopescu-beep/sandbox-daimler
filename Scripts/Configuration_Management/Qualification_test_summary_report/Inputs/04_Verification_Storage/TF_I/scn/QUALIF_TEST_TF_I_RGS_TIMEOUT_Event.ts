...
Test case ID: QUALIF_TEST_TF_I_RGS_TIMEOUT_Event
Result Test:
************************************************************************************************
Requirement under test: TR6_DES_TF_I_8873
Description of the requirement: ⦁	Identifier: 0x37
************************************************************************************************
...
const CFGc_AutotestFunction: String = "ATM_cbk_RGS_ANF01_Timeout"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 131; // should be configured
...
const CFGc_DemEventID = 55 // should be configured
