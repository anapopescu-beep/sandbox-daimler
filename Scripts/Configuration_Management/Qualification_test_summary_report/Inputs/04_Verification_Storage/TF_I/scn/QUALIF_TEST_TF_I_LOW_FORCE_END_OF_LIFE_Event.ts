...
Test case ID: QUALIF_TEST_TF_I_LOW_FORCE_END_OF_LIFE_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_6923
Description of the requirement: ERR_LOW_FORCE_END_OF_LIFE shall be defined as a Counterbased AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "EOL_cbk_CheckProductEndOfLifeLowForce"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 112; // should be configured
...
const CFGc_DemEventID = 51 // should be configured
