...
Test case ID: QUALIF_TEST_TF_I_ADC_CALIBRATION_Event
Result Test:
************************************************************************************************
Requirement under test: TR6_DES_TF_I_8871, TR6_DES_TF_I_8919, TR6_DES_TF_I_8921
Description of the requirement: TR6_DES_TF_I_8871: ⦁	Identifier: 0x36
TR6_DES_TF_I_8919: ⦁	Linked Auto-test: "TF-H17: To Check ADC Calibration"
TR6_DES_TF_I_8921: ADC_CALIBRATION_FAILED shall be defined as a Counterbased AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "ADC_cbk_CheckAdcCalib"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 128; // should be configured
...
const CFGc_DemEventID = 54 // should be configured
