...
Test case ID: QUALIF_TEST_TF_I_EXT_MOTOR_CURRENT_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_6974
Description of the requirement: ERR_MOTOR_CURRENT shall be defined as a Counterbased AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "PAL_cbk_CheckMotorCurrent"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 44; // should be configured
...
const CFGc_DemEventID = 16 // should be configured
