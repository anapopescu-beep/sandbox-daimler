...
Test case ID: QUALIF_TEST_TF_I_BAT_PWR_UNDER_VOLTAGE_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_6776
Description of the requirement: ERR_BAT_PWR_UNDER_VOLTAGE shall be defined as a Counter based AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "PMP_cbk_CheckPowerSupplyUV"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 68; // should be configured
...
const CFGc_DemEventID = 43 // should be configured
