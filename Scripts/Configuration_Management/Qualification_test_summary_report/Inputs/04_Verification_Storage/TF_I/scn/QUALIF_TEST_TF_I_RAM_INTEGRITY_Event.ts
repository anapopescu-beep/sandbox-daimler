...
Test case ID: QUALIF_TEST_TF_I_RAM_INTEGRITY_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_7132, DES_TF_I_7134, DES_TF_I_7135, DES_TF_I_7136
Description of the requirement: DES_TF_I_7132: ⦁	Linked Auto-test: "TF_H22- To Check RAM Integrity.
DES_TF_I_7134: ERR_RAM_INTEGRITY shall be defined as a Counterbased AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "MIC_cbk_RunRamMemoryCorruption_Autotest"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 104; // should be configured
...
const CFGc_DemEventID = 36 // should be configured
