...
Test case ID: QUALIF_TEST_TF_I_ADC_OUT_OF_ORDER_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_5607, DES_TF_I_6805, DES_TF_I_6764
Description of the requirement: DES_TF_I_5607: ⦁	Identifier: 0x01
DES_TF_I_6805: ⦁	Linked Auto-test: "TF_H5 - To Check ADC"
DES_TF_I_6764: ERR_ADC_OUT_OF_ORDER shall be defined as a Counter based AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "ADC_cbk_CheckAdc";

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 4;
