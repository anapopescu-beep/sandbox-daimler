...
Test case ID: QUALIF_TEST_TF_I_ERR_CAN_BUS_OFF_Event
Result Test:
************************************************************************************************
Requirement under test: TR6_DES_TF_I_8834, DES_TF_I_6800

Description of the requirement: Qualification count for ERR_CAN_BUS_OFF and counterbased
************************************************************************************************
...
var CFGc_SetEventFunction: String = "CanSM_Do_T_FUCO";
var CFGc_SetEventFunctionOffset1: Number = 2; // should be configured
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
		...
		/*Set a breakpoint in CanSM_Do_T_FUCO at the beginning*/
		...
		CommentStep("Write memory - transition set to 0x33")
		result = debugger_modify("transition", 0x33)
		
		CommentStep("Clear all breakpoints");
		RESULT.ExpectTestResult("Delete all breakpoints",debugger_deleteAllBreakpoints(),true);
		
		CFGc_SetEventFunctionOffset1 = 11;
		CommentStep("Set a BP on the configured function")
		/*Set a breakpoint in CanSM_Do_T_FUCO at the beginning*/
		tRelativeBreakPointParam = debugger_setRelativeFunctionBpAtLine(CFGc_SetEventFunction, CFGc_SetEventFunctionOffset1);
		Wait(sintBPTimeout*5);
