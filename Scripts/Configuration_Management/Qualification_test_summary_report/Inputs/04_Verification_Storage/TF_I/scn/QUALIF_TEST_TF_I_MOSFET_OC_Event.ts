...
Test case ID: QUALIF_TEST_TF_I_MOSFET_OC_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_6959
Description of the requirement: ERR_MOSFET_OC shall be defined as a Counter based AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "PAL_cbk_CheckMosfetOCAT"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 32; // should be configured
...
const CFGc_DemEventID = 4 // should be configured
