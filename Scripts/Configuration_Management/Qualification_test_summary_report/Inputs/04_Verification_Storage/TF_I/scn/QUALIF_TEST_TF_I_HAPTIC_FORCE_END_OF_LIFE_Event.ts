...
Test case ID: QUALIF_TEST_TF_I_HAPTIC_FORCE_END_OF_LIFE_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_7104
Description of the requirement: ERR_HAPTIC_WARNING_END_OF_LIFE shall be defined as a Counterbased AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "EOL_cbk_CheckProductEndOfLifeHapticWarning"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 124; // should be configured
...
const CFGc_DemEventID = 53 // should be configured
