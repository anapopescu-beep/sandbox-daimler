...
Test case ID: QUALIF_TEST_TF_I_PFLASH_INTEGRITY_Event
Result Test:
************************************************************************************************
Requirement under test: TR6_DES_TF_I_8847, TR6_DES_TF_I_8877
Description of the requirement: DES_TF_I_5961: ⦁	Identifier: 0x1B
Linked Auto-test: "TF_H41- To Check P-Flash Integrity.
ERR_P_FLASH_INTEGRITY shall be defined as a Counterbased AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "MIC_cbk_RunPFlashMemoryCorruption_Autotest"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 36; // should be configured
...
const CFGc_DemEventID = 24 // should be configured
