...
Test case ID: QUALIF_TEST_TF_I_BAT_LOG_IMPLAUSIBLE_Event
Result Test:
************************************************************************************************
Requirement under test: DES_TF_I_6813
Description of the requirement: ERR_BAT_LOG_IMPLAUSIBLE shall be defined as a Counter based AEC.
************************************************************************************************
...
const CFGc_AutotestFunction: String = "PMP_cbk_CheckLogicalSupplyImplausible"; // should be configured

const CFGc_ATMSetEventFunction: String = "atm_SetDemEvent";
const CFGc_ATMSetEventFunctionOffset: Number = 88; // should be configured
...
const CFGc_DemEventID = 47 // should be configured
