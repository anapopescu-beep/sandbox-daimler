...
Test case ID: QUALIF_TEST_TF_J_89_System_Context_Save_Time
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_J_89
Description of the requirement: If the time between two system context save requests is less than 1 seconds, then the second system context save request will be ignored. 
************************************************************************************************
...
const CFGc_FunctionToTest2: String = "SCM_StoreSystemContext";
const CFGc_FunctionOffsetToTest2: Number = 18;
const CFGc_FunctionToTest3: String = "scm_ManageSystemContextStorage";
const CFGc_FunctionOffsetToTest3: Number = 89;
const CFGc_FunctionOffsetToTest4: Number = 105;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      CommentStep("write memory - SCM_bIsSystemContextStorageRequested set to B_TRUE")
      ...
      CommentStep("write memory - u32DelaySystemContextStorage set to 0s")
      
      bWriteVariableResult = debugger_modify("u32DelaySystemContextStorage", 0) 
      
      tRelativeBreakPointParam = debugger_setRelativeFunctionBpAtLine(CFGc_FunctionToTest2, CFGc_FunctionOffsetToTest3);
      
      sBPDescription = "BP: File Name = " + tRelativeBreakPointParam[2] + ", Function = " + CFGc_FunctionToTest2 + ", Line Number = " + tRelativeBreakPointParam[1] + ", @ = 0x"   + tRelativeBreakPointParam[3] + "; Function Line offset =" + CFGc_FunctionOffsetToTest3
      ...
      ResultStep("Second system context write request was ignored", "Second system context write request was ignored")
