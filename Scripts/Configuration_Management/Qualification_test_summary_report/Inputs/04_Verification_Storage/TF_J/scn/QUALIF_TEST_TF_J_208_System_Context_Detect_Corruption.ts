...
Test case ID: QUALIF_TEST_TF_J_208_System_Context_Detect_Corruption
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_J_208
Description of the requirement: if the executed cyle in RAM_NO_INIT is corrupted, then NO_CYCLE shall be stored in NVM.
************************************************************************************************
