...
Test case ID: QUALIF_TEST_TF_J_197_Write_System_Context_Block_0_Independently
Result Test:
************************************************************************************************
...
const CFGc_FunctionOffsetToTest4: Number = 20;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      CommentStep("write memory - scm_u8IndexCurrentSystemContext set to 0")
      
      bWriteVariableResult = debugger_modify("scm_u8IndexCurrentSystemContext", 0) 
      ...
      ResultStep("Block 0 can be written independently", "Block 0 can be written independently")
