...
Test case ID: QUALIF_TEST_TF_J_197_Write_System_Context_Block_1_Independently
Result Test:
************************************************************************************************
...
const CFGc_FunctionOffsetToTest4: Number = 24;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      CommentStep("write memory - scm_u8IndexCurrentSystemContext set to 1")
      
      bWriteVariableResult = debugger_modify("scm_u8IndexCurrentSystemContext", 1) 
      ...
      ResultStep("Block 1 can be written independently", "Block 1 can be written independently")
