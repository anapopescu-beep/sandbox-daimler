...
Test case ID: QUALIF_TEST_TF_J_214_System_Context_Detect_Warm_Reset_Corruption
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_J_214
Description of the requirement: In case of warm reset, if the executed cycle in RAM_NO_INIT is corrupted, then NO_CYCLE shall be recovered at startup.
************************************************************************************************
...
const CFGc_FunctionOffsetToTest2: Number = 212;
