...
Test case ID: QUALIF_TEST_TF_H_318_CheckPowerSupplyOV_Running
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_318
Description of the requirement:
ALV_EXT_TF_H_318: This autotest shall be performed periodically, every 100 ms, in both startup autotest phase and running autotest phase.
ARCH_SW_ATM_0215: ATM_runMainFunction shall call the PMP_cbk_CheckPowerSupplyOV function. 
                  Time slot: #4.3
                  Call period: 100ms
************************************************************************************************
