...
Test case ID: QUALIF_TEST_TF_H_659_Autotest_HWSelfProtection_Periodicity10ms
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_659
...
/*------------------------------------------------------------------------------
 ...
 CALL(Config/QUALIF_TESTCFG_TF_H_659_Autotest_HWSelfProtection_Periodicity10ms.ts);
