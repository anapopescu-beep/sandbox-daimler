...
Test case ID: QUALIF_TEST_TF_H_666_667_HB_N_I_Rel_CurrentSense_Periodicity
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_666, ALV_EXT_TF_H_667
Description of the requirement:
The Tensionning current sense [HB_P_I_ten]
The [HB_P_I_ten] signal shall be a 10ms sampled filtered value.
************************************************************************************************
...
/*------------------------------------------------------------------------------
 ...
 CALL(Config/QUALIF_TESTCFG_TF_H_666_667_HB_N_I_Rel_CurrentSense_Periodicity.ts);
