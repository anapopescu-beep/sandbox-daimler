...
Test case ID: QUALIF_TEST_TF_H_884_Input_NVP_Parameter
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_884
Description of the requirement:
- Voltage Threshold above which the motor shall be considered as disconnected NVP_u16MotorDisconnectedVoltageThrs shall be actived shall be an input to the autest which checks the motor connection
************************************************************************************************
...
/*------------------------------------------------------------------------------
 ...
 CALL(Config/QUALIF_TESTCFG_TF_H_884_Input_NVP_Parameter.ts);
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      ------------------------------------------------------------------------------*/
            ...
            RESULT.ExpectTestResult("The NVP_u16MotorDisconnectedVoltageThrs parameter is reached", debugger_isCPUStoppedAtAddress(addressBP1), true);
