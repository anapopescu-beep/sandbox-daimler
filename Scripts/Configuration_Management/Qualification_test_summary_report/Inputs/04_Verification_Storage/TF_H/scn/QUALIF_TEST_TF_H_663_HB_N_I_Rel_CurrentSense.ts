...
Test case ID: QUALIF_TEST_TF_H_663_HB_N_I_Rel_CurrentSense
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_663
Description of the requirement:
The Releasing current sense [HB_N_I_rel]
************************************************************************************************
...
/*------------------------------------------------------------------------------
 ...
 CALL(Config/QUALIF_TESTCFG_TF_H_663_HB_N_I_Rel_CurrentSense.ts);
