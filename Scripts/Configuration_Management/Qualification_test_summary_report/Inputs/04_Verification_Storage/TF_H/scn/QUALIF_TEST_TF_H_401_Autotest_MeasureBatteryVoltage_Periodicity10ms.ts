...
Test case ID: QUALIF_TEST_TF_H_401_Autotest_MeasureBatteryVoltage_Periodicity10ms
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_400, ALV_EXT_TF_H_401
Description of the requirement:
- The Battery Voltage [KL30_Vlevel]
- The battery voltage signal [KL30_Vlevel] shall be a 10ms sampled filtered value.
************************************************************************************************
...
/*------------------------------------------------------------------------------
 ...
 CALL(Config/QUALIF_TESTCFG_TF_H_401_Autotest_MeasureBatteryVoltage_Periodicity10ms.ts);
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      ------------------------------------------------------------------------------*/
            ...
            /* Set a breakpoint in the function MIC_LLD_GetFaultAddress */
            ...
            RESULT.ExpectTestResult("The function PMP_runGetBatteryVoltage_10ms is reached", debugger_isCPUStoppedAtAddress(addressBP1), true);
