...
Test case ID: QUALIF_TEST_TF_H_UnderVoltage_KL30_Level_sampled_filtered_value
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_361, ALV_EXT_TF_H_362
Description of the requirement: 
ALV_EXT_TF_H_361: ⦁	The Battery Voltage [KL30_Vlevel]
ALV_EXT_TF_E_362:   ⦁   The [KL30_Vlevel] signal shall be a 10ms sampled filtered value. // TO-DO : Change 10ms in 100ms
************************************************************************************************
...
[
    ...
    "PMP_Autotest_CheckPowerSupplyUV"
];
...
function PP4G_LibInteg_CheckSubFunctionCall(strFunctionToTest: String, strSubFunctionToTest: String, astrCallStack: String[]): Boolean
{
    ...
    if (true == bIsBPset)
    {
        ...
        if (true == bBreakPointResult)
        {
            ...
            CommentStep("Place a breakpoint on the tested Sub function used to Get the Battery Voltage filtered for 100ms periodic use (KL30)");
