...
Test case ID: QUALIF_TEST_TF_H_370_Normal_Range_After_UnderVoltage_Qualified
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_370
Description of the requirement:
The Voltage threshold above which the [KL30_Vlevel] shall be considered back in normal range when Under-Voltage is qualified. [NVP_u16UnderKL30DeskillingThrs]
************************************************************************************************
                 ...
                 do
                  {
                      if (j == 93)
                      {
                          RESULT.ExpectTestResult("Under Voltage is not qualified anymore",
                          sResponse[j + 2],
                          "0x26");
                      }   
                   /* Go to next Event */
