...
Test case ID: QUALIF_TEST_TF_H_381_KL30_shall_measure_KL30
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_381
Description of the requirement:
[KL30_Vlevel] shall be measured [KL30_Vlevel]
************************************************************************************************
...
/*------------------------------------------------------------------------------
 ...
 CALL(Config/QUALIF_TESTCFG_TF_H_381_KL30_shall_measur_KL30.ts);
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      ------------------------------------------------------------------------------*/
            ...
            debugger_stop();
             ...
             RESULT.ExpectTestResult("Run application", debugger_run(), true);
             RESULT.ExpectTestResult("Wait until return is reached", debugger_waitWhileRunning(2000), true);
             RESULT.ExpectTestResult("The Parameter u16FilteredVbatPowerVoltage is reached", debugger_isCPUStoppedAtAddress(addressBP1), true);
             ...
             RESULT.ExpectTestResult("Run application", debugger_run(), true);
             RESULT.ExpectTestResult("Wait until return is reached", debugger_waitWhileRunning(2000), true);
             RESULT.ExpectTestResult("The measurement of KL30 (Rte_Call_pclKL30_V_raw_Get_100ms) is reached", debugger_isCPUStoppedAtAddress(addressBP1), true);
