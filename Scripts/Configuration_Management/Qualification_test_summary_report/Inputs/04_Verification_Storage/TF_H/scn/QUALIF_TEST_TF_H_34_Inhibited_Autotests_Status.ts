...
Test case ID: QUALIF_TEST_TF_H_34_Inhibited_Autotests_Status
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_34
Description of the requirement: 
ALV_EXT_TF_H_34: In case of Autotest is inhibited or disabled, service shall report "OK". 
************************************************************************************************
   ...
   /****** WARNING : check optionnal parameter of the next function :it's very IMPORTANT ***********/
	...
	if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
	{
      ...
      ------------------------------------------------------------------------------*/
		...
		/* Set a breakpoint in the tested function */
		CommentStep("Set the breakpoints at the end of the "+ CFGc_FunctionToTest1 + " function");
		...
		/* Read the inhibition status */
		CommentStep("Read the inhibited autotest status")
		RESULT.ExpectTestResult("Expected test status : ", debugger_readRegister("R0","uint32"), "1");
