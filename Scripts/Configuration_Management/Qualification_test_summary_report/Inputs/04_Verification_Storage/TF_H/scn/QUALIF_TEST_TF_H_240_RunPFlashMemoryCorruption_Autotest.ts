...
Test case ID: QUALIF_TEST_TF_H_240_RunPFlashMemoryCorruption_Autotest
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_240
Description of the requirement:
IF ([RST_Cause] = P-FLASH_ECC)
THEN   Test is NOK
ELSE   Test is OK
...
const cNameFunction1: String = "MIC_cbk_RunPFlashMemoryCorruption_Autotest";
const cNameFunction2: String = "MIC_Autotest_RunPFlashMemoryCorruption";
...
var sintOffsetBP2: Number = 12; //  u32ResetCause
var sintOffsetBP3: Number = 15; //  KU8_ATM_TEST_NOK
var sintOffsetBP4: Number = 31; // pu8TestResult = u8ResultOfAutoTest
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      MessageBox.Show("Change the value u32ResetCause of to 512", "pause");
      
	  CommentStep("Check autotest NOK because of P-FLASH ECC");
