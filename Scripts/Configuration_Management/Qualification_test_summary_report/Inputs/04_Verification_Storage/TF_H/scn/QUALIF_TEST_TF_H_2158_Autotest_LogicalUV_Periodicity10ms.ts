...
Test case ID: QUALIF_TEST_TF_H_2158_Autotest_LogicalUV_Periodicity10ms
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_H_2158
Description of the requirement:
- This autotest shall be performed periodically, every 10 ms, since the running autotest phase
************************************************************************************************
...
const CFGc_FunctionToTest1: String = "PMP_Autotest_CheckLogicalSupplyUV";
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      ------------------------------------------------------------------------------*/
            ...
            /* Set a breakpoint in the function PMP_Autotest_CheckLogicalSupplyUV */
			...
			CommentStep("Check if periodicity of PMP_Autotest_CheckLogicalSupplyUV() is correct. ")
			RESULT.ExpectTestResult("Check sintPeriodicity", sintPeriodicity, 10);
