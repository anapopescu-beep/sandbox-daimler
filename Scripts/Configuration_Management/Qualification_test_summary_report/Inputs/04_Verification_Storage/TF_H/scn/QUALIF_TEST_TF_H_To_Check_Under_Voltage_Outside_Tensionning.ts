...
Test case ID: QUALIF_TEST_TF_H_To_Check_Under_Voltage_Outside_Tensionning
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_376
Description of the requirement:
ALV_EXT_TF_H_376 : The AD converter autotest has been successfully passed. 
...
const CFGc_FunctionToTest1: String = "PMP_Autotest_CheckPowerSupplyUV";
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      ------------------------------------------------------------------------------*/	 
		...
		CommentStep("TEST QUALIFICATION - ALV_EXT_TF_H_376")		
        ...
        RESULT.ExpectTestResult("Run application", debugger_run(), true);
        RESULT.ExpectTestResult("Wait until return is reached", debugger_waitWhileRunning(4000), true);
        RESULT.ExpectTestResult("Setting breakpoint in order to check if PMP_Autotest_CheckPowerSupplyUV could be performed ", debugger_isCPUStoppedAtAddress(addressBP1), true);
