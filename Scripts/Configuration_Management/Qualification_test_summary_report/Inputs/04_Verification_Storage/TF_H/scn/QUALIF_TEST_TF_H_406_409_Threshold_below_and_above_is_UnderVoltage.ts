...
Test case ID: QUALIF_TEST_TF_H_406_409_Threshold_below_and_above_is_UnderVoltage
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_406, ALV_EXT_TF_H_409
Description of the requirement:
The voltage threshold below which the [KL30_Vlevel] shall be considered in Under-Voltage [NVP_u16UnderKL30DuringTensQualificationThrs]
The voltage threshold above which the [KL30_Vlevel] shall be considered back in normal range when Under-Voltage is qualified [NVP_u16UnderKL30DuringTensDeskillingThrs]
************************************************************************************************
...
try
{
   ...
   vRetFunction = SwDevLib_InitBenchEnvironmentAndPowerSupply(CFGc_FlashMode, CFGc_ResetMode, CFGc_RunMode, CFGc_MinCurrentToRunTest);
      ...
      ------------------------------------------------------------------------------*/
              ...
              RESULT.ExpectTestResult("Set the KL30 below the threshold NVP_u16UnderKL30DuringTensQualificationThrs : to 7,4V" , PS.SetVoltage(_sPS1Name, 7.4)[0],"0000");
              Wait(100);
              ...
              do
              {
                ...
                CommentStep("Unqualification Under Voltage");
                RESULT.ExpectTestResult("Set the KL30 above the threshold NVP_u16UnderKL30DuringTensQualificationThrs: to 11,9V" , PS.SetVoltage(_sPS1Name, 11.9)[0],"0000");
                 ...
                 do
                  {
                      if (j == 96)
                      {
                          RESULT.ExpectTestResult("Under Voltage is not qualified anymore and back in normal range when Under-Voltage is qualified",
                          sResponse[j + 2],
                          "0x26");
                      }   
                   /* Go to next Event */
