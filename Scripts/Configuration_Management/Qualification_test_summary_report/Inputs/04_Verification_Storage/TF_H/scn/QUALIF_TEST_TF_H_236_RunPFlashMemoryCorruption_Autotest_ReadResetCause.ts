...
Test case ID: QUALIF_TEST_TF_H_236_RunPFlashMemoryCorruption_Autotest_ReadResetCause
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_236
Description of the requirement:
For the P-Flash memory corruption autotest, the reset cause shall be read
