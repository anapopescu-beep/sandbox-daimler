...
Test case ID: QUALIF_TEST_TF_H_873_CheckMotorConnection_Running
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_873
Description of the requirement:
ALV_EXT_TF_H_873: This autotest shall be performed periodically, every 100 ms, since the running autotest phase.
************************************************************************************************
...
const CFGc_FunctionName = "PAL_cbk_CheckMotorConnection";
...
const CFGc_ATPosition = 4; /* Auto-test position starts at 0. A position N in architecture document represents a position N-1 in the code */
