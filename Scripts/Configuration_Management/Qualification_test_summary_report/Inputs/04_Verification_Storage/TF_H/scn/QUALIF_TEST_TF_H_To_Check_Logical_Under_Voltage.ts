...
Test case ID: QUALIF_TEST_TF_H_To_Check_Logical_Under_Voltage
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_541
Description of the requirement:
ALV_EXT_TF_H_541 : The AD converter autotest has been successfully passed. 
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      ------------------------------------------------------------------------------*/	 
		...
		CommentStep("TEST QUALIFICATION - ALV_EXT_TF_H_541")		
        ...
        RESULT.ExpectTestResult("Run application", debugger_run(), true);
        RESULT.ExpectTestResult("Wait until return is reached", debugger_waitWhileRunning(4000), true);
        RESULT.ExpectTestResult("Setting breakpoint in order to check if PMP_Autotest_CheckLogicalSupplyUV could be performed ", debugger_isCPUStoppedAtAddress(addressBP1), true);
