...
Test case ID: QUALIF_TEST_TF_H_96_Shutdown_Inhibit
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_96
Description of the requirement: 
ALV_EXT_TF_H_96: When aborted/inhibited by a ECU shutdown procedure, all autotest shall remain deactivated until the next SBE ECU wake-up.
************************************************************************************************
