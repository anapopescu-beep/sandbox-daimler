...
Test case ID: QUALIF_TEST_TF_H_2129_Autotest_LogicalOV_Periodicity10ms
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_H_2129
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      ------------------------------------------------------------------------------*/
            ...
            /* Set a breakpoint in the function PMP_Autotest_CheckLogicalSupplyOV */
			...
			CommentStep("Check if periodicity of PMP_Autotest_CheckLogicalSupplyOV() is correct. ")
