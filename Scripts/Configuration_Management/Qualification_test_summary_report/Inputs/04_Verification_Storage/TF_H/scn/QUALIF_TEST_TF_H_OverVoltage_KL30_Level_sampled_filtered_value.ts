...
Test case ID: QUALIF_TEST_TF_H_OverVoltage_KL30_Level_sampled_filtered_value
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_H_322, ALV_EXT_TF_H_323
Description of the requirement: 
ALV_EXT_TF_H_322: ⦁	The Battery Voltage [KL30_Vlevel]
ALV_EXT_TF_E_323:   ⦁   The [KL30_Vlevel] signal shall be a 10ms sampled filtered value. // TO-DO : Change 10ms in 100ms
************************************************************************************************
