...
Test case ID: QUALIF_TEST_TF_E_8384_0x23EE_DataByte1
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_E_8384
...
const CFGc_SetEventFunction: String = "DIA_runDid23EE_SupplyStatusRightRead";
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
		...
		/*Force the software to enter the DIA_runDid23EE_SupplyStatusRightRead function*/
		result = CAN.SendDiagByValues("0x22 0x23 0xEE");
		Wait(100);
