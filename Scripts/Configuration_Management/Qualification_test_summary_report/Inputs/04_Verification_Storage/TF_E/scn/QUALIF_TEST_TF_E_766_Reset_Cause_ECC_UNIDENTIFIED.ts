...
Test case ID: QUALIF_TEST_TF_E_766_Reset_Cause_ECC_UNIDENTIFIED
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_E_766
Description of the requirement: ⦁	The value 0x86 shall correspond to the last reset cause: ECC UNIDENTIFIED
************************************************************************************************
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      EvalManStepEqual("Write reset Value",debugger_writeVariable("rcm_u32ResetCause","uint32","00004000",0),true);
      ...
      sResponse = CAN.SendDiagByValues(sRequest);
      EvalManStepEqual("Read Last ECU Reset Cause (E2P UNIDENTIFIED)",sResponse[1],"0x62 0xFD 0x08 0x86")
