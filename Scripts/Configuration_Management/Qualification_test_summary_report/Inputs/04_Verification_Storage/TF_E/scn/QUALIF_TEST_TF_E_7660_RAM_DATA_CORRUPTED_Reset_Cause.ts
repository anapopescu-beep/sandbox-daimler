...
Test case ID: QUALIF_TEST_TF_E_7660_RAM_DATA_CORRUPTED_Reset_Cause
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_E_7660
Description of the requirement: 
ALV_EXT_TF_E_7660:The byte 4 shall be reserved for the ReadData: Last SW Reset Causes.
The value 0x89 shall correspond to the last reset cause: RAM DATA CORRUPTED reset
************************************************************************************************
...
try
{
    ...
    vRetFunction = SwDevLib_InitBenchEnvironmentAndPowerSupply("FlashOn","ResetOff","RunOn","5");
    if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
    {
        ...
        CommentStep(" *** SET THE RESET CAUSE TO RAM DATA CORRUPTED RESET *** ");
		
        /* Set Reset Cause into the RCM to RAM DATA CORRUPTED RESET */
        EvalManStepEqual("Write reset Value",debugger_writeVariable("rcm_u32ResetCause","uint32","00040000",0),true);
        ...
        sResponse = CAN.SendDiagByValues(sRequest);
        EvalManStepEqual("Read Last ECU reset Cause (RAM DATA CORRUPTED RESET)",sResponse[1],"0x62 0xFD 0x08 0x89")
