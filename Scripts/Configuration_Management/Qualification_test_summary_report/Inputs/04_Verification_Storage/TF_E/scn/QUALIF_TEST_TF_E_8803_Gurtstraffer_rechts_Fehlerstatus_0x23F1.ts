...
Test case ID: QUALIF_TEST_TF_E_8803_Gurtstraffer_rechts_Fehlerstatus_0x23F1
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_E_8803
Description of the requirement: ⦁	"ERR32" shall be equal to 0x20 for ERR_FLS_ECC error (AEC Id 0x18)
************************************************************************************************
...
const CFGc_FunctionOffsetToTest1: Number = 382;
const CFGc_FunctionOffsetToTest2: Number = 384;
const CFGc_FunctionOffsetToTest3: Number = 391;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      if (true == bWriteVariableResult)
      {
         ...
         iReadVariableValue = debugger_evaluate("pu8Data[64]"); // 64 - (number of error * 2 + 1(total number of errors))-1(array starts from 0)

         RESULT.ExpectTestResult("Evaluate pu8Data[64] ",
            iReadVariableValue,
