...
Test case ID: QUALIF_TEST_TF_E_8801_Gurtstraffer_rechts_Fehlerstatus_0x23F1
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_E_8801
Description of the requirement: ⦁	⦁	"ERR30" shall be equal to 0x1E for  ERR_NVM_ECC error (AEC Id 0x21)
************************************************************************************************
...
const CFGc_FunctionOffsetToTest1: Number = 358;
const CFGc_FunctionOffsetToTest2: Number = 360;
const CFGc_FunctionOffsetToTest3: Number = 367;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      if (true == bWriteVariableResult)
      {
         ...
         iReadVariableValue = debugger_evaluate("pu8Data[60]"); // 60 - (number of error * 2 + 1(total number of errors))-1(array starts from 0)

         RESULT.ExpectTestResult("Evaluate pu8Data[60] ",
            iReadVariableValue,
