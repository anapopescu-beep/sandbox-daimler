...
Test case ID: QUALIF_TEST_TF_E_8180_Gurtstraffer_links_Klemme_30_0x23E7
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_E_8180
...
const CFGc_FunctionToTest: String = "DIA_runDid23E7_SupplyVoltageLeftRead";
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      CommentStep("Read DID 0x23E7");
      sendCANDiagRequest("Read DID 0x23E7", "0x22 0x23 0xE7", "TIMEOUT");
