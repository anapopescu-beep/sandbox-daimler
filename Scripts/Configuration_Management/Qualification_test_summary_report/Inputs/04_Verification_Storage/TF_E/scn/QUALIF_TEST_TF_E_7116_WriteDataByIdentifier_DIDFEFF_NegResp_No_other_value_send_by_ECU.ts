...
Test case ID: QUALIF_TEST_TF_E_7116_WriteDataByIdentifier_DIDFEFF_NegResp_No_other_value_send_by_ECU
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_E_7116
Description of the requirement: 
ALV_EXT_TF_E_7116: No other value shall be send by the ECU.
************************************************************************************************
    ...
    if (vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
    {
		...
		************************************************************************************************************************************************/
		...
		for (var iSize = 0; iSize <= 15; iSize++)
		{
			...
			sRequest = "0x2E 0xF" + SwDevLib_decimalToHexString(iSize) + " 0xFF 0xFF 0xFF 0xFF 0xFF";
			sResponse = CAN.SendDiagByValues(sRequest);
			if ((iSize != 13) && (iSize != 14))
		...
		for (var iSize = 0; iSize <= 15; iSize++)
		{
			...
			sRequest = "0x2E 0xFE 0xF" + SwDevLib_decimalToHexString(iSize) + " 0xFF 0xFF 0xFF 0xFF";
			sResponse = CAN.SendDiagByValues(sRequest);
			if ((iSize != 15))
            EvalManStepEqual("Check negative response for request (" + sRequest + ") - Negative Response:", sResponse[1], sNegativeResponse_NRC_RDBLI31);
		}
		...
		for (var iSize = 0; iSize <= 15; iSize++)
		{
			...
			sRequest = "0x2E 0xFE 0xFF 0xF" + SwDevLib_decimalToHexString(iSize) + " 0xFF 0xFF 0xFF";
			sResponse = CAN.SendDiagByValues(sRequest);
            EvalManStepEqual("Check positive response for request (" + sRequest + ") - Positive Response:", sResponse[1], "0x6E 0xFE 0xFF");
		}
		Wait(500)
		...
		for (var iSize = 0; iSize <= 15; iSize++)
		{
			...
			sRequest = "0x2E 0xFE 0xFF 0xFF 0xF" + SwDevLib_decimalToHexString(iSize) + " 0xFF 0xFF";
			sResponse = CAN.SendDiagByValues(sRequest);
            EvalManStepEqual("Check positive response for request (" + sRequest + ") - Positive Response:", sResponse[1], "0x6E 0xFE 0xFF");
		}
		Wait(500)
		...
		for (var iSize = 0; iSize <= 15; iSize++)
		{
			...
			sRequest = "0x2E 0xFE 0xFF 0xFF 0xFF 0xF" + SwDevLib_decimalToHexString(iSize) + " 0xFF";
			sResponse = CAN.SendDiagByValues(sRequest);
            EvalManStepEqual("Check positive response for request (" + sRequest + ") - Positive Response:", sResponse[1], "0x6E 0xFE 0xFF");
		}
		Wait(500)
		...
		for (var iSize = 0; iSize <= 15; iSize++)
		{
			...
			sRequest = "0x2E 0xFE 0xFF 0xFF 0xFF 0xFF 0xF" + SwDevLib_decimalToHexString(iSize);
			sResponse = CAN.SendDiagByValues(sRequest);
            EvalManStepEqual("Check positive response for request (" + sRequest + ") - Positive Response:", sResponse[1], "0x6E 0xFE 0xFF");
		}
		...
		for (var iSize = 0; iSize <= 15; iSize++)
		{
			...
			sRequest = "0x2E 0xFE 0xFF 0xFF 0xFF 0xFF 0xFF 0x0" + SwDevLib_decimalToHexString(iSize);
			sResponse = CAN.SendDiagByValues(sRequest);
