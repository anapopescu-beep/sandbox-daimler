...
Test case ID: QUALIF_TEST_TF_E_769_Reset_Cause_E2P_ECC
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_E_769
Description of the requirement: ⦁	The value 0x8A shall correspond to the last reset cause: ECC E2P
************************************************************************************************
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      EvalManStepEqual("Write reset Value",debugger_writeVariable("rcm_u32ResetCause","uint32","00008000",0),true);
      ...
      sResponse = CAN.SendDiagByValues(sRequest);
      EvalManStepEqual("Read Last ECU reset Cause (E2P ECC)",sResponse[1],"0x62 0xFD 0x08 0x8A")
