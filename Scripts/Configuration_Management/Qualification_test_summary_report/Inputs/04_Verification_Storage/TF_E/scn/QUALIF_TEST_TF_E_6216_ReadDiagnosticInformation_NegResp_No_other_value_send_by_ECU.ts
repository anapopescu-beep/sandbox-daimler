...
Test case ID: QUALIF_TEST_TF_E_6216_ReadDiagnosticInformation_NegResp_No_other_value_send_by_ECU
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_E_6216
Description of the requirement: 
ALV_EXT_TF_E_6216: No other value shall be send by the ECU.
************************************************************************************************
...
try {
    ...
    if (vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
    {
		...
		/***********************************************************************************************************************************************
		************************************************************************************************************************************************/
        CommentStep("***ReadDiagnosticInformation - ReportMostRecentTestFailedDTC (RMRTFDTC) : NRC 0x12 SubFunctionNotSupported***");
		RESULT.InsertComment(" ");
		...
		/***********************************************************************************************************************************************
		************************************************************************************************************************************************/
		CommentStep("***ReadDiagnosticInformation - ReportMostRecentTestFailedDTC (RMRTFDTC) : NRC 0x13 IncorrectMessageLengthOrInvalidFormat***");
		RESULT.InsertComment(" ");
