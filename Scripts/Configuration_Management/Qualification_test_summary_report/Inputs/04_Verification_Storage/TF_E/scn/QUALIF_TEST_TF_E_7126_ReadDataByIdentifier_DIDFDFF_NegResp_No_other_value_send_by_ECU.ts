...
Test case ID: QUALIF_TEST_TF_E_7126_ReadDataByIdentifier_DIDFDFF_NegResp_No_other_value_send_by_ECU
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_E_7126
Description of the requirement: 
ALV_EXT_TF_E_7126: No other value shall be send by the ECU.
************************************************************************************************
...
try {
    ...
    if (vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
    {
		...
		/***********************************************************************************************************************************************
		************************************************************************************************************************************************/
        CommentStep("***ReadDataByIdentifier - DIDFDFF : NRC 0x13 IncorrectMessageLengthOrInvalidFormat***");
		RESULT.InsertComment(" ");
		...
		/***********************************************************************************************************************************************
		************************************************************************************************************************************************/
        CommentStep("***ReadDataByIdentifier - DIDFDFF : NRC 0x31 RequestOutOfRange***");
		RESULT.InsertComment(" ");
		CommentStep("***Verify NRC31 is received in <Supplier session>***");	
		...
		for (var iSize = 0; iSize <= 15; iSize++)
		{
			...
			sRequest = "0x22 0xFD 0xF" + SwDevLib_decimalToHexString(iSize);
			sResponse = CAN.SendDiagByValues(sRequest);
			if ((iSize != 15))
		...
		for (var iSize = 0; iSize <= 15; iSize++)
		{
			sRequest = "0x22 0xFD 0xFF" + SwDevLib_decimalToHexString(iSize);
			sResponse = CAN.SendDiagByValues(sRequest);
