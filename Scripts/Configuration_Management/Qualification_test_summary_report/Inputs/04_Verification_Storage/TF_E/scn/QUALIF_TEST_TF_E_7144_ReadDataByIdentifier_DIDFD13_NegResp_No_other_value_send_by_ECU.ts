...
Test case ID: QUALIF_TEST_TF_E_7144_ReadDataByIdentifier_DIDFD13_NegResp_No_other_value_send_by_ECU
Result Test:
************************************************************************************************
...
try {
    ...
    if (vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
    {
		...
		/***********************************************************************************************************************************************
		************************************************************************************************************************************************/
        CommentStep("***ReadDataByIdentifier - DIDFD13 : NRC 0x13 IncorrectMessageLengthOrInvalidFormat***");
		RESULT.InsertComment(" ");
		...
		************************************************************************************************************************************************/
		...
		{
			sRequest = "0x22 0xFD 0x13" + SwDevLib_decimalToHexString(iSize);
			sResponse = CAN.SendDiagByValues(sRequest);
