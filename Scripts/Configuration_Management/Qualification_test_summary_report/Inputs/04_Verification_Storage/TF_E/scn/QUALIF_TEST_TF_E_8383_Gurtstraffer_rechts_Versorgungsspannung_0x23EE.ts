...
Test case ID: QUALIF_TEST_TF_E_8383_Gurtstraffer_rechts_Versorgungsspannung_0x23EE
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_E_8383
Description of the requirement: "DB1" DataByte1 shall be equal 0x09, if the measurement of the supply voltage is not possible
(e.g ERR_ADC_OUT_OF_ORDER error is qualified)
************************************************************************************************
...
const CFGc_FunctionOffsetToTest1: Number = 8;
const CFGc_FunctionOffsetToTest2: Number = 10;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      if (true == bWriteVariableResult)
      {
         ...
         ResultStep("*pu8Data - KU8_VOLTAGE_MEAS_NOT_POSSIBLE", "*pu8Data - KU8_VOLTAGE_MEAS_NOT_POSSIBLE")
      }
