...
Test case ID: QUALIF_TEST_TF_E_8802_Gurtstraffer_rechts_Fehlerstatus_0x23F1
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_E_8802
Description of the requirement: ⦁	"ERR31" shall be equal to 0x1F for ERR_RAM_ECC error (AEC Id 0x24)
************************************************************************************************
...
const CFGc_FunctionOffsetToTest1: Number = 370;
const CFGc_FunctionOffsetToTest2: Number = 372;
const CFGc_FunctionOffsetToTest3: Number = 379;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      if (true == bWriteVariableResult)
      {
         ...
         iReadVariableValue = debugger_evaluate("pu8Data[62]"); // 62 - (number of error * 2 + 1(total number of errors))-1(array starts from 0)

         RESULT.ExpectTestResult("Evaluate pu8Data[62] ",
            iReadVariableValue,
