...
Test case ID: QUALIF_TEST_TF_E_8135_Gurtstraffer_links_Stromaufnahme_0x23E5
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_E_8135
...
const CFGc_FunctionToTest: String = "DIA_runDid23E5_CurrentConsumptionLeftRead";
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      CommentStep("Read DID 0x23E5");
      sendCANDiagRequest("Read DID 0x23E5", "0x22 0x23 0xE5", "TIMEOUT");
