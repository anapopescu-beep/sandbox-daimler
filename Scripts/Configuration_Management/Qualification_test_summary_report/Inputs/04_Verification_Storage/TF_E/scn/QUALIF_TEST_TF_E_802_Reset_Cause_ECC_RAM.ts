...
Test case ID: QUALIF_TEST_TF_E_802_Reset_Cause_ECC_RAM
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_E_802
Description of the requirement: ⦁	The value 0x00010000 shall correspond to the Warm Reset Cause: ECC RAM
************************************************************************************************
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      EvalManStepEqual("Write reset Value",debugger_writeVariable("NVP_u32WarmResetCause","uint32","00000100",0),true);
      ...
      sResponse = CAN.SendDiagByValues(sRequest);
      EvalManStepEqual("Read Warm Reset Parameters",sResponse[1],"0x62 0xFD 0x09 0x00 0x01 0x00 0x00 0x01 0x00 0x00 0x00")
