...
Test case ID: QUALIF_TEST_TF_E_804_Reset_Cause_OS_EXCEPTION
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_E_804
Description of the requirement: ⦁	The value 0x00040000 shall correspond to the Warm Reset Cause: OS EXCEPTION 
************************************************************************************************
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      EvalManStepEqual("Write reset Value",debugger_writeVariable("NVP_u32WarmResetCause","uint32","00000400",0),true);
      ...
      sResponse = CAN.SendDiagByValues(sRequest);
      EvalManStepEqual("Read Warm Reset Parameters",sResponse[1],"0x62 0xFD 0x09 0x00 0x04 0x00 0x00 0x01 0x00 0x00 0x00")
