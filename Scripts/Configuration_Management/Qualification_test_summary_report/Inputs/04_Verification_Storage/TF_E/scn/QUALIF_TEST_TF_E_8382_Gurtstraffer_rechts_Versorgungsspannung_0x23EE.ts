...
Test case ID: QUALIF_TEST_TF_E_8382_Gurtstraffer_rechts_Versorgungsspannung_0x23EE
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_E_8382
Description of the requirement: "DB1" DataByte1 shall be equal to 0x03, 
IF
⦁	error bit "RGS_VL_Ueberspannung" is set to active=0
************************************************************************************************
...
const CFGc_FunctionToTest: String = "DIA_runDid23EE_SupplyStatusRightRead";
const CFGc_FunctionOffsetToTest1: Number = 15;
const CFGc_FunctionOffsetToTest2: Number = 27;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      CommentStep("Read DID 0x23EE");
      sendCANDiagRequest("Read DID 0x23EE", "0x22 0x23 0xEE", "TIMEOUT");
      Thread.Sleep(sintDefaultWait);
      ...
      bWriteVariableResult = debugger_modify("bUeberSpannungIsSet", 170) // 0AA
      
      if (true == bWriteVariableResult)
      {
         CommentStep("read memory - bUeberSpannungIsSet")
         
         iReadVariableValue = debugger_evaluate("bUeberSpannungIsSet");

         RESULT.ExpectTestResult("Evaluate bUeberSpannungIsSet ",
            iReadVariableValue,
            "170" // 0xAA
         );
         
         ResultStep("bUeberSpannungIsSet - 0xAA", "bUeberSpannungIsSet - 0xAA")
         ...
         ResultStep("*pu8Data - KU8_VOLTAGE_OVER_THRESHOLD", "*pu8Data - KU8_VOLTAGE_OVER_THRESHOLD")
      }
