...
Test case ID: QUALIF_TEST_TF_E_756_SW_WatchDog_Test_Reset_Cause
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_E_756
Description of the requirement: 
ALV_EXT_TF_E_756:The byte 4 shall be reserved for the ReadData: Last SW Reset Causes.
The value 0x04 shall correspond to the last reset cause: SW WATCHDOG TEST
************************************************************************************************
...
try
{
   ...
   vRetFunction = SwDevLib_InitBenchEnvironmentAndPowerSupply(CFGc_FlashMode, CFGc_ResetMode, CFGc_RunMode, CFGc_MinCurrentToRunTest);
    ...
    if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
    {
        ...
        CommentStep(" *** SET THE RESET CAUSE TO SW WATCHDOG TEST *** ");
        
        /* Set Reset Cause into the RCM to INVALID INTERRUPT */
        EvalManStepEqual("Write reset Value",debugger_writeVariable("rcm_u32ResetCause","uint32","00002000",0),true);
        ...
        sResponse = CAN.SendDiagByValues(sRequest);
        EvalManStepEqual("Read Last ECU reset Cause (SW WATCHDOG TEST)",sResponse[1],"0x62 0xFD 0x08 0x04")
