...
Test case ID: QUALIF_TEST_TF_E_8787_Gurtstraffer_rechts_Fehlerstatus_0x23F1
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_E_8787
Description of the requirement: ⦁	"ERR16" shall be equal to 0x10 for ERR_ADC_OUT_OF_ORDER error (AEC Id 0x01)
************************************************************************************************
...
const CFGc_FunctionOffsetToTest1: Number = 190;
const CFGc_FunctionOffsetToTest2: Number = 192;
const CFGc_FunctionOffsetToTest3: Number = 199;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      if (true == bWriteVariableResult)
      {
         ...
         iReadVariableValue = debugger_evaluate("pu8Data[32]"); // 32 - (number of error * 2 + 1(total number of errors))-1(array starts from 0)

         RESULT.ExpectTestResult("Evaluate pu8Data[32] ",
            iReadVariableValue,
