...
Test case ID: QUALIF_TEST_TF_E_8359_Gurtstraffer_rechts_Stromaufnahme_0x23ED
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_E_8359
Description of the requirement:"DB1" DataByte1 shall be equal 0xFB, if no measurement value is available
...
const CFGc_FunctionToTest: String = "DIA_runDid23ED_CurrentConsumptionRightRead";
const CFGc_FunctionOffsetToTest1: Number = 10;
const CFGc_FunctionOffsetToTest2: Number = 12;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      CommentStep("Read DID 0x23ED");
      sendCANDiagRequest("Read DID 0x23ED", "0x22 0x23 0xED", "TIMEOUT");
      Thread.Sleep(sintDefaultWait);
      ...
      if (true == bWriteVariableResult)
      {
         ...
         ResultStep("*pu8Data - KU8_READ_NOT_POSSIBLE", "*pu8Data - KU8_READ_NOT_POSSIBLE")
      }
