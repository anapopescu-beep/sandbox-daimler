...
Test case ID: QUALIF_TEST_TF_E_763_RAM_ECC_Reset_Cause
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_E_763
Description of the requirement: 
ALV_EXT_TF_E_763:The byte 4 shall be reserved for the ReadData: Last SW Reset Causes.
The value 0x83 shall correspond to the last reset cause: ECC RAM
************************************************************************************************
...
try
{
   ...
   vRetFunction = SwDevLib_InitBenchEnvironmentAndPowerSupply(CFGc_FlashMode, CFGc_ResetMode, CFGc_RunMode, CFGc_MinCurrentToRunTest);
    ...
    if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
    {
        ...
        CommentStep(" *** SET THE RESET CAUSE TO ECC RAM *** ");
		
        /* Set Reset Cause into the RCM to ECC RAM */
        EvalManStepEqual("Write reset Value",debugger_writeVariable("rcm_u32ResetCause","uint32","00000100",0),true);
        ...
        sResponse = CAN.SendDiagByValues(sRequest);
        EvalManStepEqual("Read Last ECU reset Cause (RAM ECC)",sResponse[1],"0x62 0xFD 0x08 0x83")
