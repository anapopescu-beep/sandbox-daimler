...
Test case ID: QUALIF_TEST_TF_E_8407_Gurtstraffer_rechts_Klemme_30_0x23EF
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_E_8407
Description of the requirement: "DB1" DataByte1 shall be equal 0xFB, if the AEC  "ERR_ADC_OUT_OF_ORDER" is qualified (measurement not possible)
************************************************************************************************
...
const CFGc_FunctionToTest: String = "DIA_runDid23EF_SupplyVoltageRightRead";
const CFGc_FunctionOffsetToTest1: Number = 9;
const CFGc_FunctionOffsetToTest2: Number = 11;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      CommentStep("Read DID 0x23EF");
      sendCANDiagRequest("Read DID 0x23EF", "0x22 0x23 0xEF", "TIMEOUT");
      Thread.Sleep(sintDefaultWait);
