...
Test case ID: QUALIF_TEST_TF_E_760_Internal_Watchdog_Reset_Cause
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_E_760
Description of the requirement: 
ALV_EXT_TF_E_760:The byte 4 shall be reserved for the ReadData: Last SW Reset Causes.
The value 0x80 shall correspond to the last reset cause: INTERNAL WATCHDOG
************************************************************************************************
...
try
{
   ...
   vRetFunction = SwDevLib_InitBenchEnvironmentAndPowerSupply(CFGc_FlashMode, CFGc_ResetMode, CFGc_RunMode, CFGc_MinCurrentToRunTest);
    ...
    if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
    {
        ...
        CommentStep(" *** SET THE RESET CAUSE TO INTERNAL WATCHDOG *** ");
        
        /* Set Reset Cause into the RCM to INTERNAL WATCHDOG */
        EvalManStepEqual("Write reset Value",debugger_writeVariable("rcm_u32ResetCause","uint32","00000010",0),true);
        ...
        sResponse = CAN.SendDiagByValues(sRequest);
        EvalManStepEqual("Read Last ECU reset Cause (INTERNAL WATCHDOG)",sResponse[1],"0x62 0xFD 0x08 0x80")
