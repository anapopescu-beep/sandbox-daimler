...
Test case ID: QUALIF_TEST_TF_E_800_Reset_Cause_PLL_FAILURE
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_E_800
Description of the requirement: ⦁	The value 0x08000000 shall correspond to the Warm Reset Cause: PLL FAILURE
************************************************************************************************
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      EvalManStepEqual("Write reset Value",debugger_writeVariable("NVP_u32WarmResetCause","uint32","00000008",0),true);
      ...
      sResponse = CAN.SendDiagByValues(sRequest);
      EvalManStepEqual("Read Warm Reset Parameters",sResponse[1],"0x62 0xFD 0x09 0x08 0x00 0x00 0x00 0x01 0x00 0x00 0x00")
