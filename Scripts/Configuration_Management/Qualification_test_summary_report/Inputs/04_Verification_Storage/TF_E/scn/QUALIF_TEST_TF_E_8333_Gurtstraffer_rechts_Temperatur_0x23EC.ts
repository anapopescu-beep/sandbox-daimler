...
Test case ID: QUALIF_TEST_TF_E_8333_Gurtstraffer_rechts_Temperatur_0x23EC
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_E_8333
Description of the requirement: TR6_EXT_TF_E_8333: "DB1" DataByte1 shall be equal 0xFA, if the temperature of RGS_R is > 84.5°C
************************************************************************************************
...
const CFGc_FunctionOffsetToTest2: Number = 21;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      CommentStep("write memory - s16Temperature_Deg set to 85*C")
         
      bWriteVariableResult = debugger_modify("s16Temperature_Deg", 85) // 0x2F
      ...
      if (true == bWriteVariableResult)
      {
         ...
         ResultStep("s16Temperature_Deg - 85*C", "s16Temperature_Deg - 85*C")
         ...
         ResultStep("*pu8Data - KU8_VALUE_OVER_LIMIT", "*pu8Data - KU8_VALUE_OVER_LIMIT")
      }
