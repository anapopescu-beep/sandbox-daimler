...
Test case ID: QUALIF_TEST_TF_E_8156_Gurtstraffer_links_Versorgungsspannung_0x23E6
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_E_8156
...
const CFGc_FunctionToTest: String = "DIA_runDid23E6_SupplyStatusLeftRead";
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      CommentStep("Read DID 0x23E6");
      sendCANDiagRequest("Read DID 0x23E6", "0x22 0x23 0xE6", "TIMEOUT");
