...
Test case ID: QUALIF_TEST_TF_E_8409_0x23EF_DataByte1
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_E_8409
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
		...
		/*Force the software to enter the DIA_runDid23EF_SupplyVoltageRightRead function*/
		result = CAN.SendDiagByValues("0x22 0x23 0xEF");
		Wait(100);
