...
Test case ID: QUALIF_TEST_TF_R_149_Motor_Activation_Inhibition_Status
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_R_149 
Description of the requirement: 
The motor activation function shall be executed every 10ms.
************************************************************************************************
...
const CFGc_CalledFunctionToTest: String = "UpdateModeStatus_InhibitionOfCyclesByInternalFailure_AllCycles";
