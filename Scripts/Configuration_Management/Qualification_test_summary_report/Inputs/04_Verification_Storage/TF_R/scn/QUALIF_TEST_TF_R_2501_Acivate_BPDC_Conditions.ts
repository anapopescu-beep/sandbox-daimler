...
Test case ID: QUALIF_TEST_TF_R_2501_Acivate_BPDC_Conditions
Result Test:
************************************************************************************************
...
const CFGc_FunctionOffsetToTest2: Number = 48;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
        ...
        /*Set a breakpoint in CIL_runCANToAppli inside KU8_CIL_GURTPARKEN_1 case*/
		...
		/*Set a breakpoint in cil_ManageBPDOCondition FALLING_EDGE switch condition*/
