...
Test case ID: QUALIF_TEST_TF_R_2508_Call_BPDC_Every10ms
Result Test:
************************************************************************************************
Requirement under test: TR6_EXT_TF_R_2508
Description of the requirement: TR6_EXT_TF_R_2508: Call function every 10 ms
************************************************************************************************
...
const CFGc_FunctionToTest1: String = "cil_ManageBPDCCondition";
const CFGc_FunctionOffsetToTest1: Number = 236;
const CFGc_FunctionOffsetToTest2: Number = 4;
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
       ...
       /*Set a breakpoint in CIL_runCANToAppli inside KU8_CIL_GURTPARKEN_2 case*/
		...
		RESULT.InsertComment('numberOfTickInit: ' + numberOfTickInit);
		...
		RESULT.InsertComment('numberOfTick: ' + numberOfTick);
               
		CommentStep("Calculate duration until BP was hit")
		fDuration = (numberOfTick - numberOfTickInit)*25/1000000; // 40Mhz and convert from to us
		CommentStep("The funtion is called every " + fDuration +"ms");
