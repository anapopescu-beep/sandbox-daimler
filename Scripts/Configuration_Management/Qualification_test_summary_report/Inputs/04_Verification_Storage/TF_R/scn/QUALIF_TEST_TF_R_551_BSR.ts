...
Test case ID: QUALIF_TEST_TF_R_551_BSR
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_R_551
Description of the requirement:
The BSR inhibition function shall be executed every 10ms.
************************************************************************************************
...
const CFGc_CallingFunctionToTest: String = "ManageCommonInputsForAllBSR";
const CFGc_CalledFunctionToTest: String = "EvaluatePreConditionsForAllBSR";
