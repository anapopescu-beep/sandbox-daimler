...
Test case ID: QUALIF_TEST_TF_R_1972_BFS_Periodicity
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_R_1972
Description of the requirement:
The BFS function shall be executed every 10ms.
************************************************************************************************
...
const CFGc_CallingFunctionToTest: String = "OS_TASK_OsTask_ALV_BeltFunctionsExec";
const CFGc_CalledFunctionToTest: String = "BFS_runBeltFunctionSelection";
