...
Test case ID: QUALIF_TEST_TF_R_310_pre_pre_tensioning
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_R_310
Description of the requirement:
The inhibition and abortion function shall be executed every 10ms.
************************************************************************************************
...
const CFGc_CallingFunctionToTest: String = "ManageCommonInputsForAllPRE";
const CFGc_CalledFunctionToTest: String = "EvaluatePreConditionsForAllPRE";
