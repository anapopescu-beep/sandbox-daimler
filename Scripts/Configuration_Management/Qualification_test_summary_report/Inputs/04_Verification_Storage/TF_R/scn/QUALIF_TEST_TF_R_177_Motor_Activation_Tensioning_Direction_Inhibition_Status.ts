...
Test case ID: QUALIF_TEST_TF_R_177_Motor_Activation_Tensioning_Direction_Inhibition_Status
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_R_177 
Description of the requirement:
The motor activation in tensioning function shall be executed every 10ms.
************************************************************************************************
...
const CFGc_CallingFunctionToTest: String = "MMG_runUpdateModeStatus";
const CFGc_CalledFunctionToTest: String = "UpdateModeStatus_InhibitionOfCyclesByInternalFailure_TensioningCycles";
...
/*number of OS tick */ 
var CFGc_NumberCounterAddress = 536850804;
