...
Test case ID: QUALIF_TEST_TF_R_Manage_Motor_In_Tensioning_Direction_Inhibition_Status
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_R_188
Description of the requirement:
ALV_EXT_TF_R_188: The [Motor Activation in Tensioning Direction Inhibition Status] shall be initialized to INHIBITED. 
...
const CFGc_FunctionToTest1: String = "UpdateModeStatus_InhibitionOfCyclesByInternalFailure_TensioningCycles";

/* breakpoint offset declaration */
const CFGc_BP1Offset: Number = 8;
/*Parameter and variables address*/ 
//var CFGc_VariableAddress1 = "0x200010D8"; 
...
try
{
   ...
   if(vRetFunction != cENV_NON_INITIALIZED && vRetFunction != cENV_NOK)
   {
      ...
      ------------------------------------------------------------------------------*/
		...
		RESULT.ExpectTestResult("check that the variable value u8ModeStatusIsOk is set to 170, corresponding to Inhibited", debugger_readRegister("R4","uint8"),170);
