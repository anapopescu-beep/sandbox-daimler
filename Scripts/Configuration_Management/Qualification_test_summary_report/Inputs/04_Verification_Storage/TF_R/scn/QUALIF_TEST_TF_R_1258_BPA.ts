...
Test case ID: QUALIF_TEST_TF_R_1258_BPA
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_R_1258 
Description of the requirement:
The BPA request function shall be executed every 10ms.
************************************************************************************************
...
const CFGc_CallingFunctionToTest: String = "ExecuteBP_TriggInterruptBPDO";
const CFGc_CalledFunctionToTest: String = "ExecuteBP_TriggBPDO";
