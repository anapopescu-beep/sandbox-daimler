...
Test case ID: QUALIF_TEST_TF_R_1755_PRO_InhibAbort_Periodicity
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_R_1755
Description of the requirement:
The PRO Cycle inhibition and abortion status shall be called every 10ms.
************************************************************************************************
...
const CFGc_CallingFunctionToTest: String = "ManageCommonInputsForAllPRO";
const CFGc_CalledFunctionToTest: String = "EvaluatePreConditionsForAllPRO";
