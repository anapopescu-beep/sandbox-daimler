...
Test case ID: QUALIF_TEST_TF_R_1813_SFR
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_R_1813 
Description of the requirement:
The function to manage the release inhibition shall be executed every 10ms.
************************************************************************************************
...
const CFGc_CallingFunctionToTest: String = "ManageCommonInputsForAllSFR";
const CFGc_CalledFunctionToTest: String = "EvaluatePreConditionsForAllSFR";
