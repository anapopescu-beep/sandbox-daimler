...
Test case ID: QUALIF_TEST_TF_R_437_pre_pre_tensioning
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_R_437 
Description of the requirement:
The pretensioning request function shall be executed every 10ms.
************************************************************************************************
...
const CFGc_CallingFunctionToTest: String = "PRE_runPreTensioning";
const CFGc_CalledFunctionToTest: String = "DecideForAllPRE";
