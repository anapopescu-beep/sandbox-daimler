...
Test case ID: QUALIF_TEST_TF_R_1598_HWA
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_R_1598 
Description of the requirement:
The function to manage HWA inhibition and abortion shall be executed every 10ms
************************************************************************************************
...
const CFGc_CallingFunctionToTest: String = "EvaluateCommonDataForHWA";
const CFGc_CalledFunctionToTest: String = "EvaluatePreConditionsForHWA";
