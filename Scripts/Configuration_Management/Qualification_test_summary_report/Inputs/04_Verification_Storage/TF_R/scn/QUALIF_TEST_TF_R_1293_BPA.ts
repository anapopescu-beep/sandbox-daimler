...
Test case ID: QUALIF_TEST_TF_R_1293_BPA
Result Test:
************************************************************************************************
Requirement under test: ALV_EXT_TF_R_1293 
Description of the requirement:
The function to manage inhibition and abortion shall be executed every 10ms.
************************************************************************************************
...
const CFGc_CallingFunctionToTest: String = "ExecuteBP_CommonBPAManageInputs";
const CFGc_CalledFunctionToTest: String = "ExecuteBP_EvaluateCommonPreConditions";
