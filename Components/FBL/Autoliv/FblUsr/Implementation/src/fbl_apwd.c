...
# define FBL_APPL_ENABLE_DECOMPRESSION_VECTOR
...
{
   static uint8 SBC_TriggerCounter_u8 = 0U;
...
# endif /* BRS_ENABLE_SUPPORT_TOGGLE_WD_PIN */
   ...
   /* 10ms cyclic call for SBC main function */
   if (0U == (SBC_TriggerCounter_u8 % 10U))
   {
         SBC_MainFunction();
   }
   
   SBC_TriggerCounter_u8++;
   
   if (SBC_TriggerCounter_u8 > 10U)
   {
	   SBC_TriggerCounter_u8 = 1U;
   }
