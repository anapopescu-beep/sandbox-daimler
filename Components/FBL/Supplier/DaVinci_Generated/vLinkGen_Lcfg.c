 ...
 *   Generation Time: 2022-11-03 10:43:47
...
{
  { /*  FblRamConstSection  */ 
     /*  .Start  */ (uint32)_FblRamConstSection_START, 
     /*  .End  */ (uint32)_lc_ge_FblRamConstSection, 
     /*  .Romstart  */ (uint32)_FblRamConstSection_ROM_START, 
     /*  .Romend  */ (uint32)_FblRamConstSection_ROM_LIMIT, 
     /*  .Core  */ 0u, 
     /*  .Alignment  */ 0u
  }, 
  { /*  FblDataDefault  */ 
     /*  .Start  */ (uint32)_FblDataDefault_START, 
     /*  .End  */ (uint32)_lc_ge_FblDataDefault, 
     /*  .Romstart  */ (uint32)_FblDataDefault_ROM_START, 
     /*  .Romend  */ (uint32)_FblDataDefault_ROM_LIMIT, 
     /*  .Core  */ 0u, 
     /*  .Alignment  */ 0u
  }, 
  { /*  FblRamCodeSection  */ 
     /*  .Start  */ (uint32)_FblRamCodeSection_START, 
     /*  .End  */ (uint32)_lc_ge_FblRamCodeSection, 
     /*  .Romstart  */ (uint32)_FblRamCodeSection_ROM_START, 
     /*  .Romend  */ (uint32)_FblRamCodeSection_ROM_LIMIT, 
     /*  .Core  */ 0u, 
     /*  .Alignment  */ 0u
  }, 
  {
