...
extern uint8 _FblDataDefault_ROM_LIMIT[]; 
extern uint8 _FblDataDefault_ROM_START[]; 
extern uint8 _FblDataDefault_START[]; 
extern uint8 _FblRamCodeSection_ROM_LIMIT[]; 
extern uint8 _FblRamCodeSection_ROM_START[]; 
extern uint8 _FblRamCodeSection_START[]; 
extern uint8 _FblRamConstSection_ROM_LIMIT[]; 
extern uint8 _FblRamConstSection_ROM_START[]; 
extern uint8 _FblRamConstSection_START[]; 
extern uint8 _STACK_C0_START[]; 
extern uint8 _bss_START[]; 
extern uint8 _lc_ge_FblDataDefault[]; 
extern uint8 _lc_ge_FblRamCodeSection[]; 
extern uint8 _lc_ge_FblRamConstSection[]; 
