...
#endif
#ifndef CAN_PROCESSOR_TC322L
#define CAN_PROCESSOR_TC322L
#endif
...
#define CanConf_CanController_RBTM_FL_BODY3_180ddaa4                  0u      /**< [RBTM_FL] */
#define CanConf_CanController_RBTM_FR_BODY3_2fec3d37                  0u      /**< [RBTM_FR] */
/**\} */
#define CanConf_RBTM_FL_BODY3_8uqv9blm85ehm0msat385m76v_03d5f5f6_Tx_RBTM_FL 0u
#define CanConf_RBTM_FL_BODY3_8uqv9blm85ehm0msat385m76v_e046a621_Rx_RBTM_FL 1u
#define CanConf_RBTM_FR_BODY3_4xwwtd59665s787n6ctawh7k8_23a94727_Tx_RBTM_FR 0u
#define CanConf_RBTM_FR_BODY3_4xwwtd59665s787n6ctawh7k8_5b8d9de8_Rx_RBTM_FR 1u


#define CanConf_MemorySection_RxBuffer_RBTM_FL_BODY3_180ddaa4 0u
#define CanConf_MemorySection_RxBuffer_RBTM_FR_BODY3_2fec3d37 0u
#define CanConf_MemorySection_RxFifo_RBTM_FL_BODY3_180ddaa4 1u
#define CanConf_MemorySection_RxFifo_RBTM_FR_BODY3_2fec3d37 1u
#define CanConf_MemorySection_TxBuffer_RBTM_FL_BODY3_180ddaa4 2u
#define CanConf_MemorySection_TxBuffer_RBTM_FR_BODY3_2fec3d37 2u
...
#define kCanISRPrio_1                     0x00000030u
...
#define CAN_MAILBOXRXFULLENDIDXOFCONTROLLERCONFIG                                                   STD_OFF  /**< Deactivateable: 'Can_ControllerConfig.MailboxRxFullEndIdx' Reason: 'the optional indirection is deactivated because MailboxRxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'Can_ControllerConfig.MailboxRxFullEndIdx' Reason: 'the optional indirection is deactivated because MailboxRxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CAN_MAILBOXRXFULLLENGTHOFCONTROLLERCONFIG                                                   STD_OFF  /**< Deactivateable: 'Can_ControllerConfig.MailboxRxFullLength' Reason: 'the optional indirection is deactivated because MailboxRxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'Can_ControllerConfig.MailboxRxFullLength' Reason: 'the optional indirection is deactivated because MailboxRxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CAN_MAILBOXRXFULLSTARTIDXOFCONTROLLERCONFIG                                                 STD_OFF  /**< Deactivateable: 'Can_ControllerConfig.MailboxRxFullStartIdx' Reason: 'the optional indirection is deactivated because MailboxRxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'Can_ControllerConfig.MailboxRxFullStartIdx' Reason: 'the optional indirection is deactivated because MailboxRxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CAN_MAILBOXRXFULLUSEDOFCONTROLLERCONFIG                                                     STD_OFF  /**< Deactivateable: 'Can_ControllerConfig.MailboxRxFullUsed' Reason: 'the optional indirection is deactivated because MailboxRxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'Can_ControllerConfig.MailboxRxFullUsed' Reason: 'the optional indirection is deactivated because MailboxRxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
...
#define CAN_MAILBOXTXFULLENDIDXOFCONTROLLERCONFIG                                                   STD_OFF  /**< Deactivateable: 'Can_ControllerConfig.MailboxTxFullEndIdx' Reason: 'the optional indirection is deactivated because MailboxTxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'Can_ControllerConfig.MailboxTxFullEndIdx' Reason: 'the optional indirection is deactivated because MailboxTxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CAN_MAILBOXTXFULLLENGTHOFCONTROLLERCONFIG                                                   STD_OFF  /**< Deactivateable: 'Can_ControllerConfig.MailboxTxFullLength' Reason: 'the optional indirection is deactivated because MailboxTxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'Can_ControllerConfig.MailboxTxFullLength' Reason: 'the optional indirection is deactivated because MailboxTxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CAN_MAILBOXTXFULLSTARTIDXOFCONTROLLERCONFIG                                                 STD_OFF  /**< Deactivateable: 'Can_ControllerConfig.MailboxTxFullStartIdx' Reason: 'the optional indirection is deactivated because MailboxTxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'Can_ControllerConfig.MailboxTxFullStartIdx' Reason: 'the optional indirection is deactivated because MailboxTxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CAN_MAILBOXTXFULLUSEDOFCONTROLLERCONFIG                                                     STD_OFF  /**< Deactivateable: 'Can_ControllerConfig.MailboxTxFullUsed' Reason: 'the optional indirection is deactivated because MailboxTxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'Can_ControllerConfig.MailboxTxFullUsed' Reason: 'the optional indirection is deactivated because MailboxTxFullUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CAN_MAILBOXUNUSEDENDIDXOFCONTROLLERCONFIG                                                   STD_OFF  /**< Deactivateable: 'Can_ControllerConfig.MailboxUnusedEndIdx' Reason: 'the optional indirection is deactivated because MailboxUnusedUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'Can_ControllerConfig.MailboxUnusedEndIdx' Reason: 'the optional indirection is deactivated because MailboxUnusedUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CAN_MAILBOXUNUSEDLENGTHOFCONTROLLERCONFIG                                                   STD_OFF  /**< Deactivateable: 'Can_ControllerConfig.MailboxUnusedLength' Reason: 'the optional indirection is deactivated because MailboxUnusedUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'Can_ControllerConfig.MailboxUnusedLength' Reason: 'the optional indirection is deactivated because MailboxUnusedUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CAN_MAILBOXUNUSEDSTARTIDXOFCONTROLLERCONFIG                                                 STD_OFF  /**< Deactivateable: 'Can_ControllerConfig.MailboxUnusedStartIdx' Reason: 'the optional indirection is deactivated because MailboxUnusedUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'Can_ControllerConfig.MailboxUnusedStartIdx' Reason: 'the optional indirection is deactivated because MailboxUnusedUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CAN_MAILBOXUNUSEDUSEDOFCONTROLLERCONFIG                                                     STD_OFF  /**< Deactivateable: 'Can_ControllerConfig.MailboxUnusedUsed' Reason: 'the optional indirection is deactivated because MailboxUnusedUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'Can_ControllerConfig.MailboxUnusedUsed' Reason: 'the optional indirection is deactivated because MailboxUnusedUsedOfControllerConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
...
#define CAN_SIDFEENDIDXOFSIDFC                                                                      STD_OFF  /**< Deactivateable: 'Can_SIDFC.SIDFEEndIdx' Reason: 'the optional indirection is deactivated because SIDFEUsedOfSIDFC is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'Can_SIDFC.SIDFEEndIdx' Reason: 'the optional indirection is deactivated because SIDFEUsedOfSIDFC is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CAN_SIDFESTARTIDXOFSIDFC                                                                    STD_OFF  /**< Deactivateable: 'Can_SIDFC.SIDFEStartIdx' Reason: 'the optional indirection is deactivated because SIDFEUsedOfSIDFC is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'Can_SIDFC.SIDFEStartIdx' Reason: 'the optional indirection is deactivated because SIDFEUsedOfSIDFC is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CAN_SIDFEUSEDOFSIDFC                                                                        STD_OFF  /**< Deactivateable: 'Can_SIDFC.SIDFEUsed' Reason: 'the optional indirection is deactivated because SIDFEUsedOfSIDFC is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'Can_SIDFC.SIDFEUsed' Reason: 'the optional indirection is deactivated because SIDFEUsedOfSIDFC is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
...
#define CAN_SHMELEMENTSIZE                                                                          STD_OFF  /**< Deactivateable: 'Can_ShmElementSize' Reason: 'the struct is deactivated because all elements are deactivated.' and Deactivateable: 'Can_ShmElementSize' Reason: 'the struct is deactivated because all elements are deactivated.' */
#define CAN_F0DSOFSHMELEMENTSIZE                                                                    STD_OFF  /**< Deactivateable: 'Can_ShmElementSize.F0DS' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'Can_ShmElementSize.F0DS' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
#define CAN_F1DSOFSHMELEMENTSIZE                                                                    STD_OFF  /**< Deactivateable: 'Can_ShmElementSize.F1DS' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'Can_ShmElementSize.F1DS' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
#define CAN_RBDSOFSHMELEMENTSIZE                                                                    STD_OFF  /**< Deactivateable: 'Can_ShmElementSize.RBDS' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'Can_ShmElementSize.RBDS' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
#define CAN_TBDSOFSHMELEMENTSIZE                                                                    STD_OFF  /**< Deactivateable: 'Can_ShmElementSize.TBDS' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'Can_ShmElementSize.TBDS' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
#define CAN_TEFBDSOFSHMELEMENTSIZE                                                                  STD_OFF  /**< Deactivateable: 'Can_ShmElementSize.TEFBDS' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'Can_ShmElementSize.TEFBDS' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
...
#define CAN_NO_CANCONTROLLERDEFAULTBAUDRATEOFCONTROLLERCONFIG                                       255u
...
/** 
  ...
  \{
*/ 
#define Can_Config_RBTM_FL_Ptr                                                                      &(Can_PCConfig.Config_RBTM_FL)  /**< symbolic identifier which shall be used to initialize 'Can' */
#define Can_Config_RBTM_FR_Ptr                                                                      &(Can_PCConfig.Config_RBTM_FR)  /**< symbolic identifier which shall be used to initialize 'Can' */
/** 
  \}
*/ 
...
/** 
  ...
  \{
*/ 
#define Can_Config_RBTM_FL                                                                          Can_PCConfig.Config_RBTM_FL  /**< symbolic identifier which could be used to initialize 'Can */
#define Can_Config_RBTM_FR                                                                          Can_PCConfig.Config_RBTM_FR  /**< symbolic identifier which could be used to initialize 'Can */
/** 
  \}
*/ 
...
#define CAN_INIT_DATA_HASH_CODE                                                                     1624437218  /**< the precompile constant to validate the initialization structure at initialization time of Can with a hashcode. The seed value is '0x501Eu' */
...
#define Can_GetSizeOfXIDFEOfPCConfig()                                                              2u  /**< the number of accomplishable value elements in Can_XIDFE */
...
typedef uint8 Can_CanControllerDefaultBaudrateOfControllerConfigType;
...
typedef uint8 Can_InitObjectBaudrateType;
...
typedef uint8 Can_SizeOfPhysToLogChannelType;
...
/*! \spec weak type invariant () { 
 * (!((self.XIDFEStartIdxOfXIDFC != CAN_NO_XIDFESTARTIDXOFXIDFC)) || (self.XIDFEStartIdxOfXIDFC < Can_GetSizeOfXIDFE())) &&
 * (!((self.XIDFEStartIdxOfXIDFC != CAN_NO_XIDFESTARTIDXOFXIDFC)) || (self.XIDFEEndIdxOfXIDFC < Can_GetSizeOfXIDFE()))
 * } */
...
{
  Can_PCConfigType Config_RBTM_FL;  /**< [Config_RBTM_FL] */
  Can_PCConfigType Config_RBTM_FR;  /**< [Config_RBTM_FR] */
} Can_PCConfigsType;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Can_XIDFEType, CAN_CONST) Can_XIDFE[2];
#define CAN_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
