...
#define VMEMACCM_MULTI_PARTITION_PUBLISH_DATA_SIZE 0x0010u 
...
#define vMemAccM_GetSizeOfAddressAreaOfPCConfig()                                                   2u  /**< the number of accomplishable value elements in vMemAccM_AddressArea */
#define vMemAccM_GetSizeOfAddressAreaVariantOfPCConfig()                                            2u  /**< the number of accomplishable value elements in vMemAccM_AddressAreaVariant */
#define vMemAccM_GetSizeOfSubAddressAreaOfPCConfig()                                                6u  /**< the number of accomplishable value elements in vMemAccM_SubAddressArea */
...
typedef uint8 vMemAccM_NumberOfSectorsOfSubAddressAreaType;
...
typedef uint8 vMemAccM_PageSizeOfSubAddressAreaType;
...
typedef uint16 vMemAccM_SectorSizeOfSubAddressAreaType;
...
/*lint -restore */
extern CONST(vMemAccM_AddressAreaType, VMEMACCM_CONST) vMemAccM_AddressArea[2];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(vMemAccM_AddressAreaVariantType, VMEMACCM_CONST) vMemAccM_AddressAreaVariant[2];
#define VMEMACCM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(vMemAccM_SubAddressAreaType, VMEMACCM_CONST) vMemAccM_SubAddressArea[6];
#define VMEMACCM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
