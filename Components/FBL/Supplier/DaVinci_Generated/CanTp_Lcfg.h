...
typedef uint16 CanTp_NCsOfTxSduCfgType;
...
typedef struct sCanTp_RxSduCfgType
{
  ...
  CanTp_ChannelModeOfRxSduCfgType ChannelModeOfRxSduCfg;
...
{
  CanTp_PCConfigType Config_RBTM_FL;  /**< [Config_RBTM_FL] */
  CanTp_PCConfigType Config_RBTM_FR;  /**< [Config_RBTM_FR] */
} CanTp_PCConfigsType;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(CanTp_RxSduCfgType, CANTP_CONST) CanTp_RxSduCfgRBTM_FL[6];
#define CANTP_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(CanTp_RxSduCfgType, CANTP_CONST) CanTp_RxSduCfgRBTM_FR[6];
#define CANTP_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(CanTp_TxSduCfgType, CANTP_CONST) CanTp_TxSduCfgRBTM_FL[3];
#define CANTP_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(CanTp_TxSduCfgType, CANTP_CONST) CanTp_TxSduCfgRBTM_FR[3];
#define CANTP_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(CanTp_DynFCParameterType, CANTP_VAR_NOINIT) CanTp_DynFCParameters[6];
