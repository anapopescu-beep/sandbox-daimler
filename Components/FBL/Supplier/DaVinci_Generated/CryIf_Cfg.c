 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: CryIf_Cfg.c
 *   Generation Time: 2023-08-16 14:33:35
...
CONST(CryIf_ChannelType, CRYIF_CONST) CryIf_Channel[6] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */ CryptoConf_CryptoDriverObject_Crypto_30_vHsm_Hwa ,                 1u, 0u },  /* [/ActiveEcuC/CryIf/CryIfChannel_vHsm_Hwa, /ActiveEcuC/CryIf, /ActiveEcuC/Csm/CsmQueues/CsmQueue_vHsm_Hwa:CsmChannelRef] */
  ...
  { /*     2 */ CryptoConf_CryptoDriverObject_Crypto_30_LibCv_Rng,                 0u, 2u },  /* [/ActiveEcuC/CryIf/CryIfChannel_CryptoCv_Fbl_Rng, /ActiveEcuC/CryIf, /ActiveEcuC/Csm/CsmQueues/CsmQueue_Rng:CsmChannelRef] */
  { /*     3 */ CryptoConf_CryptoDriverObject_Crypto_30_LibCv    ,                 0u, 3u },  /* [/ActiveEcuC/CryIf/CryIfChannel_CryptoCv_Fbl_Signature, /ActiveEcuC/CryIf, /ActiveEcuC/Csm/CsmQueues/CsmQueue_Standard:CsmChannelRef] */
  { /*     4 */ CryptoConf_CryptoDriverObject_Crypto_30_vHsm_Core,                 1u, 4u },  /* [/ActiveEcuC/CryIf/CryIfChannel_vHsm_Core, /ActiveEcuC/CryIf, /ActiveEcuC/Csm/CsmQueues/CsmQueue_vHsm_Core:CsmChannelRef] */
  { /*     5 */ CryptoConf_CryptoDriverObject_Crypto_30_vHsm_Core,                 1u, 5u }   /* [/ActiveEcuC/CryIf/CryIfChannel_vHsm_Fw_Update, /ActiveEcuC/CryIf, /ActiveEcuC/Csm/CsmQueues/CsmQueue_vHsm_Fw_Update:CsmChannelRef] */
};
...
CONST(CryIf_KeyType, CRYIF_CONST) CryIf_Key[63] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     5 */ CryptoConf_CryptoKey_CryIfKey_KeyMCertificate_OSSL_X509_ECDSA_P384_CA         ,                 1u },  /* [/ActiveEcuC/CryIf/CryIfKey_CryIfKey_KeyMCertificate_OSSL_X509_ECDSA_P384_CA, /ActiveEcuC/CryIf, /ActiveEcuC/Csm/CsmKeys/CsmKey_KeyMCertificate_OSSL_X509_ECDSA_P384_CA:CsmKeyRef] */
  { /*     6 */ CryptoConf_CryptoKey_CryIfKey_KeyMCertificate_OSSL_X509_ECDSA_P384_IA         ,                 1u },  /* [/ActiveEcuC/CryIf/CryIfKey_CryIfKey_KeyMCertificate_OSSL_X509_ECDSA_P384_IA, /ActiveEcuC/CryIf, /ActiveEcuC/Csm/CsmKeys/CsmKey_KeyMCertificate_OSSL_X509_ECDSA_P384_IA:CsmKeyRef] */
  ...
  { /*    20 */ CryptoConf_CryptoKey_KeyM_Cert_Root                                           ,                 1u },  /* [/ActiveEcuC/CryIf/CryIfKey_KeyM_Cert_Root, /ActiveEcuC/CryIf, /ActiveEcuC/Csm/CsmKeys/CsmKey_KeyM_Cert_Root:CsmKeyRef] */
