...
/* vatvou: support CAN1 for on P15.2 and P15.3 for TriBoard TC3X2 */
#  elif defined (BRS_EVA_BOARD_TRIBOARD_TC3x2)
BRSHW_PORT_PIN(BRSHW_PORT_CAN1_TX, BRSHW_PORT_PORTGROUP_15, BRSHW_PORT_PORTNUMBER_2, BRSHW_PORT_ALT_5);
BRSHW_PORT_PIN(BRSHW_PORT_CAN1_RX, BRSHW_PORT_PORTGROUP_15, BRSHW_PORT_PORTNUMBER_3, BRSHW_PORT_ALT_0);
