...
))
{
  ...
  while(left < PriorityQueue->Dyn->QueueUsage)                                                                          /* FETA_OS_QUEUEUSAGE */
  {
...
)
{
  ...
  for(idx = OS_PRIORITYQUEUE_ROOT_IDX; idx < (Os_PriorityQueueNodeIdx_IteratorType) PriorityQueue->Dyn->QueueUsage;     /* COV_OS_INVSTATE */ /* FETA_OS_QUEUEUSAGE */
      idx++)
  {
