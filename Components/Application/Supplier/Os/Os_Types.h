...
/*! An OS internal functionality could not be done in time. */
...
typedef enum
{
  ...
  /*! The compare value of the timer could not be set to a future value. */
  OS_STATUS_FRT_NO_FUTURE_VALUE               = E_OS_SYS_TIMEOUT,
  /*! The compare value could not be written to the hardware register. */
