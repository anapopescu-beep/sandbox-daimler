 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_BeltTensionerFunction_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <BeltTensionerFunction>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_BELTTENSIONERFUNCTION_TYPE_H
# define RTE_BELTTENSIONERFUNCTION_TYPE_H
...
#endif /* RTE_BELTTENSIONERFUNCTION_TYPE_H */
