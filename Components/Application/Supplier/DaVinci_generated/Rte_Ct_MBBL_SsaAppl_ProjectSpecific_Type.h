 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_Ct_MBBL_SsaAppl_ProjectSpecific_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <Ct_MBBL_SsaAppl_ProjectSpecific>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_CT_MBBL_SSAAPPL_PROJECTSPECIFIC_TYPE_H
# define RTE_CT_MBBL_SSAAPPL_PROJECTSPECIFIC_TYPE_H
...
#endif /* RTE_CT_MBBL_SSAAPPL_PROJECTSPECIFIC_TYPE_H */
