 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_PMP_AC_PhysicalMeasuresProvider_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <PMP_AC_PhysicalMeasuresProvider>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_PMP_AC_PHYSICALMEASURESPROVIDER_TYPE_H
# define RTE_PMP_AC_PHYSICALMEASURESPROVIDER_TYPE_H
...
#endif /* RTE_PMP_AC_PHYSICALMEASURESPROVIDER_TYPE_H */
