...
#endif
#ifndef ECUM_PROCESSOR_TC322L
#define ECUM_PROCESSOR_TC322L
#endif
...
#define ECUM_SCHM_CONFIG_POINTER                                      EcuM_GlobalPCConfig_Ptr->CfgPtr_SchM_Init
#define ECUM_FIRST_CONFIG_STRUCTURE                                   &EcuM_GlobalConfigRoot.Left
...
/** 
  ...
  \{
*/ 
#define ECUM_ALARMCLOCKTIMEOUT                                                                      STD_OFF  /**< Deactivateable: 'EcuM_AlarmClockTimeOut' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'EcuM_AlarmClockTimeOut' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
#define ECUM_BSWMCURRENTMODULESTATE                                                                 STD_ON
#define ECUM_BSWMREQUESTEDMODULESTATE                                                               STD_ON
#define ECUM_COMMPNCS                                                                               STD_OFF  /**< Deactivateable: 'EcuM_ComMPNCs' Reason: 'the struct is deactivated because all elements are deactivated.' and Deactivateable: 'EcuM_ComMPNCs' Reason: 'the struct is deactivated because all elements are deactivated.' */
#define ECUM_PNCOFCOMMPNCS                                                                          STD_OFF  /**< Deactivateable: 'EcuM_ComMPNCs.PNC' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'EcuM_ComMPNCs.PNC' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
...
#define ECUM_DRIVERRESTARTLIST                                                                      STD_OFF  /**< Deactivateable: 'EcuM_DriverRestartList' Reason: 'the struct is deactivated because all elements are deactivated.' and Deactivateable: 'EcuM_DriverRestartList' Reason: 'the struct is deactivated because all elements are deactivated.' */
#define ECUM_FUNCTIONOFDRIVERRESTARTLIST                                                            STD_OFF  /**< Deactivateable: 'EcuM_DriverRestartList.Function' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'EcuM_DriverRestartList.Function' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
...
#define ECUM_FLEXUSER                                                                               STD_OFF  /**< Deactivateable: 'EcuM_FlexUser' Reason: 'the struct is deactivated because all elements are deactivated.' and Deactivateable: 'EcuM_FlexUser' Reason: 'the struct is deactivated because all elements are deactivated.' */
#define ECUM_ALARMCLOCKIDOFFLEXUSER                                                                 STD_OFF  /**< Deactivateable: 'EcuM_FlexUser.AlarmClockId' Reason: 'Alarm Clock Feature is not active.' and Deactivateable: 'EcuM_FlexUser.AlarmClockId' Reason: 'Alarm Clock Feature is not active.' */
#define ECUM_GODOWNALLOWEDOFFLEXUSER                                                                STD_OFF  /**< Deactivateable: 'EcuM_FlexUser.GoDownAllowed' Reason: 'Defensive Behavior is not active!' and Deactivateable: 'EcuM_FlexUser.GoDownAllowed' Reason: 'Defensive Behavior is not active!' */
#define ECUM_MODULEIDOFFLEXUSER                                                                     STD_OFF  /**< Deactivateable: 'EcuM_FlexUser.ModuleId' Reason: 'Defensive Behavior is not active.' and Deactivateable: 'EcuM_FlexUser.ModuleId' Reason: 'Defensive Behavior is not active.' */
#define ECUM_SETCLOCKALLOWEDOFFLEXUSER                                                              STD_OFF  /**< Deactivateable: 'EcuM_FlexUser.SetClockAllowed' Reason: 'Alarm Clock Feature is not active.' and Deactivateable: 'EcuM_FlexUser.SetClockAllowed' Reason: 'Alarm Clock Feature is not active.' */
...
#define ECUM_PARTITIONDATA                                                                          STD_OFF  /**< Deactivateable: 'EcuM_PartitionData' Reason: 'the struct is deactivated because all elements are deactivated.' and Deactivateable: 'EcuM_PartitionData' Reason: 'the struct is deactivated because all elements are deactivated.' */
#define ECUM_APPLICATIONOFPARTITIONDATA                                                             STD_OFF  /**< Deactivateable: 'EcuM_PartitionData.Application' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'EcuM_PartitionData.Application' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
#define ECUM_BSWMPARTITIONOFPARTITIONDATA                                                           STD_OFF  /**< Deactivateable: 'EcuM_PartitionData.BswMPartition' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'EcuM_PartitionData.BswMPartition' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
#define ECUM_ECUMPARTITIONOFPARTITIONDATA                                                           STD_OFF  /**< Deactivateable: 'EcuM_PartitionData.EcuMPartition' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'EcuM_PartitionData.EcuMPartition' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
#define ECUM_RESOURCEOFPARTITIONDATA                                                                STD_OFF  /**< Deactivateable: 'EcuM_PartitionData.Resource' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'EcuM_PartitionData.Resource' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
...
#define ECUM_SLEEPMODELIST                                                                          STD_OFF  /**< Deactivateable: 'EcuM_SleepModeList' Reason: 'the struct is deactivated because all elements are deactivated.' and Deactivateable: 'EcuM_SleepModeList' Reason: 'the struct is deactivated because all elements are deactivated.' */
#define ECUM_MCUMODEOFSLEEPMODELIST                                                                 STD_OFF  /**< Deactivateable: 'EcuM_SleepModeList.McuMode' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'EcuM_SleepModeList.McuMode' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
#define ECUM_POLLINGOFSLEEPMODELIST                                                                 STD_OFF  /**< Deactivateable: 'EcuM_SleepModeList.Polling' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'EcuM_SleepModeList.Polling' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
#define ECUM_VALIDOFSLEEPMODELIST                                                                   STD_OFF  /**< Deactivateable: 'EcuM_SleepModeList.Valid' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'EcuM_SleepModeList.Valid' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
#define ECUM_WAKEUPSOURCEOFSLEEPMODELIST                                                            STD_OFF  /**< Deactivateable: 'EcuM_SleepModeList.WakeupSource' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'EcuM_SleepModeList.WakeupSource' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
#define ECUM_USERTABLE                                                                              STD_OFF  /**< Deactivateable: 'EcuM_UserTable' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' and Deactivateable: 'EcuM_UserTable' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
#define ECUM_VALIDATIONTIMEOUTTABLE                                                                 STD_OFF  /**< Deactivateable: 'EcuM_ValidationTimeoutTable' Reason: 'No validation timeouts configured.' and Deactivateable: 'EcuM_ValidationTimeoutTable' Reason: 'No validation timeouts configured.' */
#define ECUM_WAKEUPSOURCELIST                                                                       STD_ON
#define ECUM_CHANNELOFWAKEUPSOURCELIST                                                              STD_ON
#define ECUM_CHECKWAKEUPTIMEOFWAKEUPSOURCELIST                                                      STD_OFF  /**< Deactivateable: 'EcuM_WakeupSourceListLeft.CheckWakeupTime' Reason: 'the value of EcuM_CheckWakeupTimeOfWakeupSourceList is always '0' due to this, the array is deactivated.' and Deactivateable: 'EcuM_WakeupSourceListRight.CheckWakeupTime' Reason: 'the value of EcuM_CheckWakeupTimeOfWakeupSourceList is always '0' due to this, the array is deactivated.' */
#define ECUM_COMMPNCSENDIDXOFWAKEUPSOURCELIST                                                       STD_OFF  /**< Deactivateable: 'EcuM_WakeupSourceListLeft.ComMPNCsEndIdx' Reason: 'the optional indirection is deactivated because ComMPNCsUsedOfWakeupSourceList is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'EcuM_WakeupSourceListRight.ComMPNCsEndIdx' Reason: 'the optional indirection is deactivated because ComMPNCsUsedOfWakeupSourceList is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define ECUM_COMMPNCSSTARTIDXOFWAKEUPSOURCELIST                                                     STD_OFF  /**< Deactivateable: 'EcuM_WakeupSourceListLeft.ComMPNCsStartIdx' Reason: 'the optional indirection is deactivated because ComMPNCsUsedOfWakeupSourceList is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'EcuM_WakeupSourceListRight.ComMPNCsStartIdx' Reason: 'the optional indirection is deactivated because ComMPNCsUsedOfWakeupSourceList is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define ECUM_COMMPNCSUSEDOFWAKEUPSOURCELIST                                                         STD_OFF  /**< Deactivateable: 'EcuM_WakeupSourceListLeft.ComMPNCsUsed' Reason: 'the optional indirection is deactivated because ComMPNCsUsedOfWakeupSourceList is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' and Deactivateable: 'EcuM_WakeupSourceListRight.ComMPNCsUsed' Reason: 'the optional indirection is deactivated because ComMPNCsUsedOfWakeupSourceList is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define ECUM_POLLINGOFWAKEUPSOURCELIST                                                              STD_OFF  /**< Deactivateable: 'EcuM_WakeupSourceListLeft.Polling' Reason: 'the value of EcuM_PollingOfWakeupSourceList is always 'false' due to this, the array is deactivated.' and Deactivateable: 'EcuM_WakeupSourceListRight.Polling' Reason: 'the value of EcuM_PollingOfWakeupSourceList is always 'false' due to this, the array is deactivated.' */
#define ECUM_REASONOFWAKEUPSOURCELIST                                                               STD_OFF  /**< Deactivateable: 'EcuM_WakeupSourceListLeft.Reason' Reason: 'No Mcu Reset Reason configured.' and Deactivateable: 'EcuM_WakeupSourceListRight.Reason' Reason: 'No Mcu Reset Reason configured.' */
#define ECUM_VALIDOFWAKEUPSOURCELIST                                                                STD_OFF  /**< Deactivateable: 'EcuM_WakeupSourceListLeft.Valid' Reason: 'the value of EcuM_ValidOfWakeupSourceList is always 'true' due to this, the array is deactivated.' and Deactivateable: 'EcuM_WakeupSourceListRight.Valid' Reason: 'the value of EcuM_ValidOfWakeupSourceList is always 'true' due to this, the array is deactivated.' */
#define ECUM_VALIDATIONTIMEOFWAKEUPSOURCELIST                                                       STD_OFF  /**< Deactivateable: 'EcuM_WakeupSourceListLeft.ValidationTime' Reason: 'the value of EcuM_ValidationTimeOfWakeupSourceList is always '0' due to this, the array is deactivated.' and Deactivateable: 'EcuM_WakeupSourceListRight.ValidationTime' Reason: 'the value of EcuM_ValidationTimeOfWakeupSourceList is always '0' due to this, the array is deactivated.' */
...
#define ECUM_ISDEF_WAKEUPSOURCELISTOFPCCONFIG                                                       STD_OFF
/** 
  \}
*/ 
...
#define ECUM_EQ2_WAKEUPSOURCELISTOFPCCONFIG                                                         
/** 
  \}
*/ 
...
/** 
  ...
  \{
*/ 
#define EcuM_Config_Left_Ptr                                                                        &(EcuM_PCConfig.Config_Left)  /**< symbolic identifier which shall be used to initialize 'EcuM' */
#define EcuM_Config_Right_Ptr                                                                       &(EcuM_PCConfig.Config_Right)  /**< symbolic identifier which shall be used to initialize 'EcuM' */
/** 
  \}
*/ 
...
/** 
  ...
  \{
*/ 
#define EcuM_Config_Left                                                                            EcuM_PCConfig.Config_Left  /**< symbolic identifier which could be used to initialize 'EcuM */
#define EcuM_Config_Right                                                                           EcuM_PCConfig.Config_Right  /**< symbolic identifier which could be used to initialize 'EcuM */
/** 
  \}
*/ 
...
#define ECUM_INIT_DATA_HASH_CODE                                                                    -1075421952  /**< the precompile constant to validate the initialization structure at initialization time of EcuM with a hashcode. The seed value is '0x0A1Eu' */
...
typedef P2VAR(EcuM_StateType, TYPEDEF, ECUM_VAR_NO_INIT) EcuM_BswMCurrentModuleStatePtrType;

/**   \brief  type used to point to EcuM_BswMRequestedModuleState */
typedef P2VAR(EcuM_StateType, TYPEDEF, ECUM_VAR_NO_INIT) EcuM_BswMRequestedModuleStatePtrType;
...
typedef struct sEcuM_PCConfigType
{
  ...
  EcuM_WakeupSourceListPtrType WakeupSourceListOfPCConfig;  /**< the pointer to EcuM_WakeupSourceList */
} EcuM_PCConfigType;
...
{
  EcuM_PCConfigType Config_Left;  /**< [Config_Left] */
  EcuM_PCConfigType Config_Right;  /**< [Config_Right] */
} EcuM_PCConfigsType;
