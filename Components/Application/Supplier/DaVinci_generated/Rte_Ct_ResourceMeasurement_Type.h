 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_Ct_ResourceMeasurement_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <Ct_ResourceMeasurement>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_CT_RESOURCEMEASUREMENT_TYPE_H
# define RTE_CT_RESOURCEMEASUREMENT_TYPE_H
...
#endif /* RTE_CT_RESOURCEMEASUREMENT_TYPE_H */
