 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_BMM_AC_BeltMovementMonitoring_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <BMM_AC_BeltMovementMonitoring>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_BMM_AC_BELTMOVEMENTMONITORING_TYPE_H
# define RTE_BMM_AC_BELTMOVEMENTMONITORING_TYPE_H
...
#endif /* RTE_BMM_AC_BELTMOVEMENTMONITORING_TYPE_H */
