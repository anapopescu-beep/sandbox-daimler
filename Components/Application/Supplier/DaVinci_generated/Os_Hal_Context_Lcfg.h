...
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_ApplBackgroundTask_Core0_Dyn;


/*! HAL dynamic task context data: ApplInitTask_Core0 */
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_ApplInitTask_Core0_Dyn;


/*! HAL dynamic task context data: ApplTask_Core0_HighPrio */
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_ApplTask_Core0_HighPrio_Dyn;


/*! HAL dynamic task context data: ApplTask_Core0_LowPrio */
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_ApplTask_Core0_LowPrio_Dyn;


/*! HAL dynamic task context data: BackgroundTask_Core0 */
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_BackgroundTask_Core0_Dyn;


/*! HAL dynamic task context data: BswTask_Core0_HighPrio */
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_BswTask_Core0_HighPrio_Dyn;


/*! HAL dynamic task context data: BswTask_Core0_LowPrio */
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_BswTask_Core0_LowPrio_Dyn;
...
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_OsTask_ALV_BeltFunctionAlgo_Dyn;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_RCM_PFlashEccFailure_Notification;

/*! HAL ISR2 context configuration data: RCM_SRamEccFailure_Notification */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_RCM_SRamEccFailure_Notification;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_ApplBackgroundTask_Core0;

/*! HAL task context configuration data: ApplInitTask_Core0 */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_ApplInitTask_Core0;

/*! HAL task context configuration data: ApplTask_Core0_HighPrio */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_ApplTask_Core0_HighPrio;

/*! HAL task context configuration data: ApplTask_Core0_LowPrio */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_ApplTask_Core0_LowPrio;

/*! HAL task context configuration data: BackgroundTask_Core0 */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_BackgroundTask_Core0;

/*! HAL task context configuration data: BswTask_Core0_HighPrio */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_BswTask_Core0_HighPrio;

/*! HAL task context configuration data: BswTask_Core0_LowPrio */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_BswTask_Core0_LowPrio;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_OsTask_ALV_BeltFunctionAlgo;
