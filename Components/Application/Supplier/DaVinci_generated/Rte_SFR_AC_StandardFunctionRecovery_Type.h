 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_SFR_AC_StandardFunctionRecovery_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <SFR_AC_StandardFunctionRecovery>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_SFR_AC_STANDARDFUNCTIONRECOVERY_TYPE_H
# define RTE_SFR_AC_STANDARDFUNCTIONRECOVERY_TYPE_H
...
#endif /* RTE_SFR_AC_STANDARDFUNCTIONRECOVERY_TYPE_H */
