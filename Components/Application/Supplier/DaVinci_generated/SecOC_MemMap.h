...
#if defined SECOC_START_SEC_CRYPTO_DRV_ALIGNED_VAR_NOCACHE_INIT_32
...
#ifdef MEMMAP_ERROR
# error No MemMap section found in SecOC_MemMap.h. Check your section define for validity.
#endif
