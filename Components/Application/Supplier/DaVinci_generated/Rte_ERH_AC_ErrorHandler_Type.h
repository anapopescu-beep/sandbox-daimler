 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_ERH_AC_ErrorHandler_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <ERH_AC_ErrorHandler>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_ERH_AC_ERRORHANDLER_TYPE_H
# define RTE_ERH_AC_ERRORHANDLER_TYPE_H
...
#endif /* RTE_ERH_AC_ERRORHANDLER_TYPE_H */
