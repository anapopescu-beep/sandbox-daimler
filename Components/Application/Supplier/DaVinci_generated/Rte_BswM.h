...
#  define Rte_InitValue_Request_ESH_KillAllRunRequest_requestedMode (0U)
 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_BswM_Request_ESH_KillAllRunRequest_requestedMode(P2VAR(BswM_ESH_KillAllRun, AUTOMATIC, RTE_BSWM_APPL_VAR) data); /* PRQA S 1330, 3451, 0786, 3449, 0624 */ /* MD_Rte_1330, MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Switch_BswM_Switch_BswMSwitchPort_SwcDiagCommunicationMode_Mode(uint8 nextMode);
 ...
 *********************************************************************************************************************/
#  define Rte_Read_Request_ESH_KillAllRunRequest_requestedMode Rte_Read_BswM_Request_ESH_KillAllRunRequest_requestedMode
 ...
 * Rte_Switch_<p>_<m>
 *********************************************************************************************************************/
#  define Rte_Switch_Switch_BswMSwitchPort_SwcDiagCommunicationMode_Mode Rte_Switch_BswM_Switch_BswMSwitchPort_SwcDiagCommunicationMode_Mode
