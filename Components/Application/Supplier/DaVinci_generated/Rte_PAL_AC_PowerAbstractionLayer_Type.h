 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_PAL_AC_PowerAbstractionLayer_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <PAL_AC_PowerAbstractionLayer>
 *********************************************************************************************************************/
...
#endif /* RTE_PAL_AC_POWERABSTRACTIONLAYER_TYPE_H */
