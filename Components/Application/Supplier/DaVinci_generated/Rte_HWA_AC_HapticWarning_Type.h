 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_HWA_AC_HapticWarning_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <HWA_AC_HapticWarning>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_HWA_AC_HAPTICWARNING_TYPE_H
# define RTE_HWA_AC_HAPTICWARNING_TYPE_H
...
#endif /* RTE_HWA_AC_HAPTICWARNING_TYPE_H */
