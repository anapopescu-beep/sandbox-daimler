...
# define Dcm_CfgConfig_Left                                                    (Dcm_CfgConfigsRoot.Config_Left)
/*! Direct variant access */
# define Dcm_CfgConfig_Right                                                   (Dcm_CfgConfigsRoot.Config_Right)
...
# define Dcm_CfgWrapMemMgrMidInfo(index)                                       (&Dcm_CfgMemMgrMidInfo[(index)])                                      /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
typedef struct DCM_CONFIGSTYPE_TAG
{
  Dcm_ConfigType Config_Left;
  Dcm_ConfigType Config_Right;
} Dcm_ConfigsType;
# if (DCM_AUTHMGR_SUPPORT_ENABLED == STD_ON)
 ...
 *  \pre           -
 ***********************************************************************************************************************/
FUNC(Std_ReturnType, DCM_CALLOUT_CODE) Ssa_Cdd_DiagnosticService_Authentication_0x29(
  Dcm_OpStatusType opStatus,
  Dcm_MsgContextPtrType pMsgContext,
  Dcm_NegativeResponseCodePtrType ErrorCode
  );
...
extern CONST(Dcm_NetConnRefMemType, DCM_CONST) Dcm_CfgNetTxPduInfo_Left[3];
/*! Map of DCM relevant network handles */
extern CONST(Dcm_CfgNetNetIdRefMemType, DCM_CONST) Dcm_CfgNetConnComMChannelMap_Left[1];
/*! Service 0x28 list of channels for the all-comm-channel parameter */
extern CONST(Dcm_CfgNetNetIdRefMemType, DCM_CONST) Dcm_CfgNetComCtrlChannelListAll_Left[2];
/*! TxPduId to DCM connection map */
extern CONST(Dcm_NetConnRefMemType, DCM_CONST) Dcm_CfgNetTxPduInfo_Right[3];
/*! Map of DCM relevant network handles */
extern CONST(Dcm_CfgNetNetIdRefMemType, DCM_CONST) Dcm_CfgNetConnComMChannelMap_Right[1];
/*! Service 0x28 list of channels for the all-comm-channel parameter */
extern CONST(Dcm_CfgNetNetIdRefMemType, DCM_CONST) Dcm_CfgNetComCtrlChannelListAll_Right[2];
/*! Look up table of all supported ALFIDs */
extern CONST(uint8, DCM_CONST) Dcm_CfgMemMgrAlfidLookUpTable[17];
/*! Look up table of all supported MIDs */
extern CONST(uint8, DCM_CONST) Dcm_CfgMemMgrMidLookUpTable[1];
...
extern CONST(uint8, DCM_CONST) Dcm_CfgSvc11SubFuncLookUpTable[5];
...
# include "Dcm_MemMap.h"                                                                                                                             /* PRQA S 5087 */ /* MD_MSR_MemMap */
/*! DID look up table  */
extern CONST(uint16, DCM_CONST) Dcm_CfgDidMgrDidLookUpTable[94];
/*! RID look up table  */
extern CONST(uint16, DCM_CONST) Dcm_CfgRidMgrRidLookUpTable[25];
...
/*! RxPduId map */
extern CONST(Dcm_CfgNetRxPduInfoType, DCM_CONST) Dcm_CfgNetRxPduInfo_Left[6];
/*! DCM connection descriptor */
extern CONST(Dcm_CfgNetConnectionInfoType, DCM_CONST) Dcm_CfgNetConnectionInfo_Left[3];
/*! DCM protocol descriptor */
extern CONST(Dcm_CfgNetProtocolInfoType, DCM_CONST) Dcm_CfgNetProtocolInfo_Left[1];
/*! Map of all relevant for DCM network handles */
extern CONST(NetworkHandleType, DCM_CONST) Dcm_CfgNetAllComMChannelMap_Left[1];
/*! Look up table of DCM relevant network handles */
extern CONST(NetworkHandleType, DCM_CONST) Dcm_CfgNetNetworkHandleLookUpTable_Left[2];
/*! Communication variant specifics */
extern CONST(Dcm_CfgNetVariantInfoType, DCM_CONST) Dcm_CfgNetConfig_Left;
/*! RxPduId map */
extern CONST(Dcm_CfgNetRxPduInfoType, DCM_CONST) Dcm_CfgNetRxPduInfo_Right[6];
/*! DCM connection descriptor */
extern CONST(Dcm_CfgNetConnectionInfoType, DCM_CONST) Dcm_CfgNetConnectionInfo_Right[3];
/*! DCM protocol descriptor */
extern CONST(Dcm_CfgNetProtocolInfoType, DCM_CONST) Dcm_CfgNetProtocolInfo_Right[1];
/*! Map of all relevant for DCM network handles */
extern CONST(NetworkHandleType, DCM_CONST) Dcm_CfgNetAllComMChannelMap_Right[1];
/*! Look up table of DCM relevant network handles */
extern CONST(NetworkHandleType, DCM_CONST) Dcm_CfgNetNetworkHandleLookUpTable_Right[2];
/*! Communication variant specifics */
extern CONST(Dcm_CfgNetVariantInfoType, DCM_CONST) Dcm_CfgNetConfig_Right;
...
/*! DID properties */
extern CONST(Dcm_CfgDidMgrDidInfoType, DCM_CONST) Dcm_CfgDidMgrDidInfo[93];
/*! DID operation properties */
extern CONST(Dcm_CfgDidMgrDidOpInfoType, DCM_CONST) Dcm_CfgDidMgrDidOpInfo[118];
/*! DID operation classes */
extern CONST(Dcm_CfgDidMgrDidOpClassInfoType, DCM_CONST) Dcm_CfgDidMgrDidOpClassInfo[240];
/*! DID signal operation classes */
extern CONST(Dcm_CfgDidMgrSignalOpClassInfoType, DCM_CONST) Dcm_CfgDidMgrSignalOpClassInfo[442];
/*! RID properties */
extern CONST(Dcm_CfgRidMgrRidInfoType, DCM_CONST) Dcm_CfgRidMgrRidInfo[24];
/*! RID operation properties */
extern CONST(Dcm_CfgRidMgrOpInfoType, DCM_CONST) Dcm_CfgRidMgrOpInfo[36];
...
extern CONST(Dcm_DiagSvcCancelFuncType, DCM_CONST) Dcm_CfgDiagSvcCancellers[6];
/*! OEM notification functions */
extern CONST(Dcm_CfgDiagNotificationInfoType, DCM_CONST) Dcm_CfgDiagOemNotificationInfo[4];
...
extern CONST(Dcm_CfgDiagSvc2ProtMapMemType, DCM_CONST) Dcm_CfgDiagSvcId2ProtMap[13];
/*! Dcm all variant root */
extern CONST(Dcm_ConfigsType, DCM_CONST) Dcm_CfgConfigsRoot;
...
extern CONST(Dcm_CfgSvc11SubFuncInfoType, DCM_CONST) Dcm_CfgSvc11SubFuncInfo[4];
/*! Indirection from service 0x11 sub functions to execution pre conditions */
extern CONST(Dcm_CfgStateRefMemType, DCM_CONST) Dcm_CfgSvc11SubFuncExecPrecondTable[4];
