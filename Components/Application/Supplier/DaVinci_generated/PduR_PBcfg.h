...
#define PDUR_PBPARTITIONCONFIG                                                                      STD_OFF  /**< Deactivateable: 'PduR_PBPartitionConfigLeft' Reason: 'the module configuration is VARIANT_PRE_COMPILE.' and Deactivateable: 'PduR_PBPartitionConfigRight' Reason: 'the module configuration is VARIANT_PRE_COMPILE.' */
/** 
  \}
*/ 
