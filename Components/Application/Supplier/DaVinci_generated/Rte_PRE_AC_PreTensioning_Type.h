 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_PRE_AC_PreTensioning_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <PRE_AC_PreTensioning>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_PRE_AC_PRETENSIONING_TYPE_H
# define RTE_PRE_AC_PRETENSIONING_TYPE_H
...
#endif /* RTE_PRE_AC_PRETENSIONING_TYPE_H */
