 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_EOL_AC_EndOfLifeManagement_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <EOL_AC_EndOfLifeManagement>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_EOL_AC_ENDOFLIFEMANAGEMENT_TYPE_H
# define RTE_EOL_AC_ENDOFLIFEMANAGEMENT_TYPE_H
...
#endif /* RTE_EOL_AC_ENDOFLIFEMANAGEMENT_TYPE_H */
