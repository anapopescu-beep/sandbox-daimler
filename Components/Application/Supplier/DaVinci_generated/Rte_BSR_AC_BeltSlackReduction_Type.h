 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_BSR_AC_BeltSlackReduction_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <BSR_AC_BeltSlackReduction>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_BSR_AC_BELTSLACKREDUCTION_TYPE_H
# define RTE_BSR_AC_BELTSLACKREDUCTION_TYPE_H
...
#endif /* RTE_BSR_AC_BELTSLACKREDUCTION_TYPE_H */
