 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_DIA_AC_DiagOnCAN_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <DIA_AC_DiagOnCAN>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_DIA_AC_DIAGONCAN_TYPE_H
# define RTE_DIA_AC_DIAGONCAN_TYPE_H
...
# define RTE_MODE_DIA_AC_DiagOnCAN_DcmDiagnosticSessionControl_DEFAULT_SESSION (1U)
...
# endif
# define RTE_MODE_DIA_AC_DiagOnCAN_DcmDiagnosticSessionControl_PROGRAMMING_SESSION (2U)
...
# endif
# define RTE_MODE_DIA_AC_DiagOnCAN_DcmDiagnosticSessionControl_EXTENDED_SESSION (3U)
...
#endif /* RTE_DIA_AC_DIAGONCAN_TYPE_H */
