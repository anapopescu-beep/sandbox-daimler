 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Can_Cfg.h
 *   Generation Time: 2023-07-10 14:36:10
...
#define CAN_GENERIC_PRETRANSMIT              STD_ON
...
#define CanConf_CanController_RBTM_FL_BODY3_180ddaa4                  0u      /**< [Left] */
#define CanConf_CanController_RBTM_FR_BODY3_2fec3d37                  0u      /**< [Right] */
/**\} */
#define CanConf_RBTM_FL_BODY3_8uqv9blm85ehm0msat385m76v_03d5f5f6_Tx_Left 0u
#define CanConf_RBTM_FL_BODY3_8uqv9blm85ehm0msat385m76v_d50cf0d9_Rx_Left 1u
#define CanConf_RBTM_FL_BODY3_8uqv9blm85ehm0msat385m76v_e046a621_Rx_Left 2u
#define CanConf_RBTM_FR_BODY3_4xwwtd59665s787n6ctawh7k8_23a94727_Tx_Right 0u
#define CanConf_RBTM_FR_BODY3_4xwwtd59665s787n6ctawh7k8_5b8d9de8_Rx_Right 1u
#define CanConf_RBTM_FR_BODY3_4xwwtd59665s787n6ctawh7k8_6ec7cb10_Rx_Right 2u
...
#define CAN_ISDEF_SIDFEOFPCCONFIG                                                                   STD_OFF
...
#define CAN_ISDEF_XIDFEOFPCCONFIG                                                                   STD_OFF
/** 
  \}
*/ 
...
#define CAN_EQ2_SIDFEOFPCCONFIG                                                                     
...
#define CAN_EQ2_XIDFEOFPCCONFIG                                                                     
/** 
  \}
*/ 
...
/** 
  ...
  \{
*/ 
#define Can_Config_Left_Ptr                                                                         &(Can_PCConfig.Config_Left)  /**< symbolic identifier which shall be used to initialize 'Can' */
#define Can_Config_Right_Ptr                                                                        &(Can_PCConfig.Config_Right)  /**< symbolic identifier which shall be used to initialize 'Can' */
/** 
  \}
*/ 
...
/** 
  ...
  \{
*/ 
#define Can_Config_Left                                                                             Can_PCConfig.Config_Left  /**< symbolic identifier which could be used to initialize 'Can */
#define Can_Config_Right                                                                            Can_PCConfig.Config_Right  /**< symbolic identifier which could be used to initialize 'Can */
/** 
  \}
*/ 
...
#define CAN_INIT_DATA_HASH_CODE                                                                     -656919317  /**< the precompile constant to validate the initialization structure at initialization time of Can with a hashcode. The seed value is '0x501Eu' */
...
#define Can_GetSIDFEOfPCConfig()                                                                    Can_ConfigDataPtr->SIDFEOfPCConfig
#define Can_GetXIDFEOfPCConfig()                                                                    Can_ConfigDataPtr->XIDFEOfPCConfig
/** 
  \}
*/ 
...
#define Can_HasSIDFE()                                                                              (Can_GetSIDFEOfPCConfig() != NULL_PTR)
...
#define Can_HasXIDFE()                                                                              (Can_GetXIDFEOfPCConfig() != NULL_PTR)
...
{
  Can_SIDFEPtrType SIDFEOfPCConfig;  /**< the pointer to Can_SIDFE */
  Can_XIDFEPtrType XIDFEOfPCConfig;  /**< the pointer to Can_XIDFE */
...
{
  Can_PCConfigType Config_Left;  /**< [Config_Left] */
  Can_PCConfigType Config_Right;  /**< [Config_Right] */
} Can_PCConfigsType;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Can_SIDFEType, CAN_CONST) Can_SIDFELeft[1];
#define CAN_STOP_SEC_CONST_32BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Can_SIDFEType, CAN_CONST) Can_SIDFERight[1];
#define CAN_STOP_SEC_CONST_32BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Can_XIDFEType, CAN_CONST) Can_XIDFELeft[1];
#define CAN_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Can_XIDFEType, CAN_CONST) Can_XIDFERight[1];
#define CAN_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
