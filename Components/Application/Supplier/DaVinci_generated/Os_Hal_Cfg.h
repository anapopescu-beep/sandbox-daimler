...
# define OS_ISR_CANISR_1_LEVEL     (60)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_CORE      (0)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_LEVEL     (50)
# define OS_ISR_OS_ISR_BMM_HES_IT_CORE      (0)
# define OS_ISR_OS_ISR_BMM_HES_IT_LEVEL     (63)
# define OS_ISR_OS_ISR_BMM_HES_TOUT_CORE      (0)
# define OS_ISR_OS_ISR_BMM_HES_TOUT_LEVEL     (64)
# define OS_ISR_RCM_PFLASHECCFAILURE_NOTIFICATION_CORE      (0)
# define OS_ISR_RCM_PFLASHECCFAILURE_NOTIFICATION_LEVEL     (62)
# define OS_ISR_RCM_SRAMECCFAILURE_NOTIFICATION_CORE      (0)
# define OS_ISR_RCM_SRAMECCFAILURE_NOTIFICATION_LEVEL     (61)
# define OS_ISR_VHSMRESPONSEISR_CORE      (0)
# define OS_ISR_VHSMRESPONSEISR_LEVEL     (1)

/* Hardware counter timing macros */

/* Counter timing macros and constants: SystemTimer */
# define OSMAXALLOWEDVALUE_SystemTimer     (1073741823u) /* 0x3FFFFFFFu */
# define OSMINCYCLE_SystemTimer            (1u)
# define OSTICKSPERBASE_SystemTimer        (80000u)
...
# define OS_CFG_HAL_ISR_OS_ISR_BMM_HES_IT_CORE      (0U)
# define OS_CFG_HAL_ISR_OS_ISR_BMM_HES_IT_LEVEL     (63U)
	 
# define OS_CFG_HAL_ISR_OS_ISR_BMM_HES_TOUT_CORE      (0U)
# define OS_CFG_HAL_ISR_OS_ISR_BMM_HES_TOUT_LEVEL     (64U)
