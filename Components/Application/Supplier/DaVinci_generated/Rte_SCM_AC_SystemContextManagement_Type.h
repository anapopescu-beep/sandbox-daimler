 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_SCM_AC_SystemContextManagement_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <SCM_AC_SystemContextManagement>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_SCM_AC_SYSTEMCONTEXTMANAGEMENT_TYPE_H
# define RTE_SCM_AC_SYSTEMCONTEXTMANAGEMENT_TYPE_H
...
#endif /* RTE_SCM_AC_SYSTEMCONTEXTMANAGEMENT_TYPE_H */
