 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_MMG_AC_ModeManagement_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <MMG_AC_ModeManagement>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_MMG_AC_MODEMANAGEMENT_TYPE_H
# define RTE_MMG_AC_MODEMANAGEMENT_TYPE_H
...
#endif /* RTE_MMG_AC_MODEMANAGEMENT_TYPE_H */
