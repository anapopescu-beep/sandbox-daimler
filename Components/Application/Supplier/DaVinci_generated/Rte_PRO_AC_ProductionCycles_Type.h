 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_PRO_AC_ProductionCycles_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <PRO_AC_ProductionCycles>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_PRO_AC_PRODUCTIONCYCLES_TYPE_H
# define RTE_PRO_AC_PRODUCTIONCYCLES_TYPE_H
...
#endif /* RTE_PRO_AC_PRODUCTIONCYCLES_TYPE_H */
