 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_RCM_AC_ResetCauseManagement_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <RCM_AC_ResetCauseManagement>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_RCM_AC_RESETCAUSEMANAGEMENT_TYPE_H
# define RTE_RCM_AC_RESETCAUSEMANAGEMENT_TYPE_H
...
#endif /* RTE_RCM_AC_RESETCAUSEMANAGEMENT_TYPE_H */
