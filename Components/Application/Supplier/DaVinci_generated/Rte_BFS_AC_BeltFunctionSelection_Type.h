 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_BFS_AC_BeltFunctionSelection_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <BFS_AC_BeltFunctionSelection>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_BFS_AC_BELTFUNCTIONSELECTION_TYPE_H
# define RTE_BFS_AC_BELTFUNCTIONSELECTION_TYPE_H
...
#endif /* RTE_BFS_AC_BELTFUNCTIONSELECTION_TYPE_H */
