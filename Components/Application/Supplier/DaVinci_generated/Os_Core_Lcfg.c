...
{
  (Os_StackConfigRefType) &OsCfg_Stack_ApplTask_Core0_HighPrio,
  (Os_StackConfigRefType) &OsCfg_Stack_ApplTask_Core0_LowPrio,
  (Os_StackConfigRefType) &OsCfg_Stack_BswTask_Core0_HighPrio,
  (Os_StackConfigRefType) &OsCfg_Stack_BswTask_Core0_LowPrio,
  ...
  (Os_StackConfigRefType) &OsCfg_Stack_OsCore0_Task_Prio99,
  (Os_StackConfigRefType) &OsCfg_Stack_OsTask_ALV_BeltFunctionAlgo,
  NULL_PTR
};
