 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <Ssa_Cdd>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_SSA_CDD_TYPE_H
# define RTE_SSA_CDD_TYPE_H
