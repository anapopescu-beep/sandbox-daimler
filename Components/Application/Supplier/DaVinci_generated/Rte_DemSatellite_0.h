 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_DemSatellite_0_CBReadData_Data_DID_0x10a_Vehicle_Odometer_in_Low_Resolution_ReadData(P2VAR(DataPrimitiveType_uint16, AUTOMATIC, RTE_DEMSATELLITE_0_APPL_VAR) Data); /* PRQA S 1330, 3451, 0786, 3449, 0624 */ /* MD_Rte_1330, MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_DemSatellite_0_CBReadData_Data_DID_0x133_Current_Operating_Time_ReadData(P2VAR(DataPrimitiveType_uint32, AUTOMATIC, RTE_DEMSATELLITE_0_APPL_VAR) Data); /* PRQA S 1330, 3451, 0786, 3449, 0624 */ /* MD_Rte_1330, MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_DemSatellite_0_CBReadData_Data_DID_0x133_Operating_Time_Status_ReadData(P2VAR(DataPrimitiveType_uint8, AUTOMATIC, RTE_DEMSATELLITE_0_APPL_VAR) Data); /* PRQA S 1330, 3451, 0786, 3449, 0624 */ /* MD_Rte_1330, MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
# ifndef RTE_PTR2ARRAYTYPE_PASSING
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_DemSatellite_0_CBReadData_Data_DID_0x18b_SecOcDataID_ReadData(P2VAR(uint8, AUTOMATIC, RTE_DEMSATELLITE_0_APPL_VAR) Data); /* PRQA S 1330, 3451, 0786, 3449, 0624 */ /* MD_Rte_1330, MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
# else
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_DemSatellite_0_CBReadData_Data_DID_0x18b_SecOcDataID_ReadData(P2VAR(DataArrayType_uint8_2, AUTOMATIC, RTE_DEMSATELLITE_0_APPL_VAR) Data); /* PRQA S 1330, 3451, 0786, 3449, 0624 */ /* MD_Rte_1330, MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
# endif
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_DemSatellite_0_CBReadData_Data_DID_0xfd05_Root_Causes_ReadData(P2VAR(DataPrimitiveType_uint8, AUTOMATIC, RTE_DEMSATELLITE_0_APPL_VAR) Data); /* PRQA S 1330, 3451, 0786, 3449, 0624 */ /* MD_Rte_1330, MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
 ...
 *********************************************************************************************************************/
#  define Rte_Call_CBReadData_Data_DID_0x10a_Vehicle_Odometer_in_Low_Resolution_ReadData Rte_Call_DemSatellite_0_CBReadData_Data_DID_0x10a_Vehicle_Odometer_in_Low_Resolution_ReadData
#  define Rte_Call_CBReadData_Data_DID_0x133_Current_Operating_Time_ReadData Rte_Call_DemSatellite_0_CBReadData_Data_DID_0x133_Current_Operating_Time_ReadData
#  define Rte_Call_CBReadData_Data_DID_0x133_Operating_Time_Status_ReadData Rte_Call_DemSatellite_0_CBReadData_Data_DID_0x133_Operating_Time_Status_ReadData
#  define Rte_Call_CBReadData_Data_DID_0x18b_SecOcDataID_ReadData Rte_Call_DemSatellite_0_CBReadData_Data_DID_0x18b_SecOcDataID_ReadData
#  define Rte_Call_CBReadData_Data_DID_0xfd05_Root_Causes_ReadData Rte_Call_DemSatellite_0_CBReadData_Data_DID_0xfd05_Root_Causes_ReadData
