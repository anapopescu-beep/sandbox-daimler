 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_StbM_SystemApplication_OsCore0_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <StbM_SystemApplication_OsCore0>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_STBM_SYSTEMAPPLICATION_OSCORE0_TYPE_H
# define RTE_STBM_SYSTEMAPPLICATION_OSCORE0_TYPE_H
...
#endif /* RTE_STBM_SYSTEMAPPLICATION_OSCORE0_TYPE_H */
