 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_BFE_AC_BeltFunctionExecution_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <BFE_AC_BeltFunctionExecution>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_BFE_AC_BELTFUNCTIONEXECUTION_TYPE_H
# define RTE_BFE_AC_BELTFUNCTIONEXECUTION_TYPE_H
...
#endif /* RTE_BFE_AC_BELTFUNCTIONEXECUTION_TYPE_H */
