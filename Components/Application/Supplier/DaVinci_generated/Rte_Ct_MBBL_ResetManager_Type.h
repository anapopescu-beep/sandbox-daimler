 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_Ct_MBBL_ResetManager_Type.h
 ...
 *          License:  CBD2200333
 *
 *      Description:  Application types header file for SW-C <Ct_MBBL_ResetManager>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_CT_MBBL_RESETMANAGER_TYPE_H
# define RTE_CT_MBBL_RESETMANAGER_TYPE_H
...
#endif /* RTE_CT_MBBL_RESETMANAGER_TYPE_H */
