...
#define EcuM_GetWakeupSourceListOfPCConfig()                                                        EcuM_ConfigDataPtr->WakeupSourceListOfPCConfig
/** 
  \}
*/ 
...
#define EcuM_GetEcuM_CRCHash_LowerOfPCConfig()                                                      0x12B45B21u
#define EcuM_GetEcuM_CRCHash_UpperOfPCConfig()                                                      0x4563B353u
...
#define EcuM_HasWakeupSourceList()                                                                  (EcuM_GetWakeupSourceListOfPCConfig() != NULL_PTR)
...
/** 
  ...
  \{
*/ 
#define EcuM_AddBswMCurrentModuleState(Value)                                                       EcuM_SetBswMCurrentModuleState((EcuM_GetBswMCurrentModuleState() + Value))
#define EcuM_AddBswMRequestedModuleState(Value)                                                     EcuM_SetBswMRequestedModuleState((EcuM_GetBswMRequestedModuleState() + Value))
...
/** 
  ...
  \{
*/ 
#define EcuM_SubBswMCurrentModuleState(Value)                                                       EcuM_SetBswMCurrentModuleState((EcuM_GetBswMCurrentModuleState() - Value))
#define EcuM_SubBswMRequestedModuleState(Value)                                                     EcuM_SetBswMRequestedModuleState((EcuM_GetBswMRequestedModuleState() - Value))
...
extern P2CONST(EcuM_PbConfigType, ECUM_VAR_NO_INIT, ECUM_PBCFG) EcuM_ConfigDataPtr;
...
/*lint -restore */
extern CONST(EcuM_DriverInitOneType, ECUM_CONST) EcuM_DriverInitOneLeft[1];
...
#include "EcuM_MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(EcuM_DriverInitOneType, ECUM_CONST) EcuM_DriverInitOneRight[1];
#define ECUM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "EcuM_MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "EcuM_MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(EcuM_WakeupSourceListType, ECUM_CONST) EcuM_WakeupSourceListLeft[6];
#define ECUM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "EcuM_MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "EcuM_MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(EcuM_WakeupSourceListType, ECUM_CONST) EcuM_WakeupSourceListRight[6];
#define ECUM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "EcuM_MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "EcuM_MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(EcuM_StateType, ECUM_VAR_NO_INIT) EcuM_BswMCurrentModuleState;
...
#include "EcuM_MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(EcuM_StateType, ECUM_VAR_NO_INIT) EcuM_BswMRequestedModuleState;
#define ECUM_STOP_SEC_VAR_NO_INIT_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "EcuM_MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
extern FUNC(void, ECUM_CODE) EcuM_AL_DriverInitOne_Left(void) ;
#if (ECUM_SLEEPMODELIST == STD_ON)
extern FUNC(void, ECUM_CODE) EcuM_AL_DriverRestartList_Left(void) /* COV_ECUM_CALLOUT */;
#endif
extern FUNC(void, ECUM_CODE) EcuM_AL_DriverInitOne_Right(void) ;
#if (ECUM_SLEEPMODELIST == STD_ON)
extern FUNC(void, ECUM_CODE) EcuM_AL_DriverRestartList_Right(void) /* COV_ECUM_CALLOUT */;
#endif
