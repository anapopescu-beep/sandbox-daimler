 ...
 *  01.08.00  2014-01-13  Mmu     ESCAN00070897 AR3-2508: Support Fr_TxConflictStatusType
 **************************************************************************************************/
...
# define DRVFR__BASEASR_VERSION          0x0108u/* BCD coded version number */
...
/** Data type to provide information about Tx conflicts. */
typedef enum
{
  FR_NO_CONFLICT = 0u,
  FR_CONFLICT
} Fr_TxConflictStatusType;
