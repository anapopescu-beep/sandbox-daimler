 ...
 Evolution of the component COMMON.GEN
  (initials, date, modification)
   ...
   modified by :
         ...
         $Log: common.h  $
         Revision 1.14 2024/03/04 12:41:06CET Mirela Obada (mirela.obada) 
         Root cause for snapshot data
         Revision 1.13 2024/01/08 12:37:55EET Mirela Obada (mirela.obada) 
         Fix SC for One shot autotests errors
         Revision 1.12 2023/12/18 14:20:31EET Mirela Obada (mirela.obada) 
         Update interface for Ign status
         Revision 1.11 2023/05/02 15:14:54EEST Madalina Serban (madalina.serban) 
         Added define uint16 100
         Revision 1.10 2023/04/25 20:22:54EEST Stefan Dominte (stefan.dominte) 
         Variant coding initialization first implementation
         Revision 1.9 2023/04/25 11:39:52EEST Andreea Negrea (andreea.negrea) 
         Add define
         Revision 1.8 2023/04/12 16:05:29EEST Roberto Cristoi (roberto.cristoi) 
         added SCM related stuff
         Revision 1.7 2023/01/19 17:21:39EET Andreea Negrea (andreea.negrea) 
         Belt function update for 5.0
         Revision 1.6 2022/11/18 10:17:21EET Stefan Dominte (stefan.dominte) 
         Add Twenty four define
         Revision 1.5 2022/10/31 09:56:08EET Andreea Negrea (andreea.negrea) 
         Update magic number
         Revision 1.4 2022/10/24 15:37:13EEST Andreea Negrea (andreea.negrea) 
         Update CIL for 4.0
         Revision 1.3 2022/08/09 10:16:13EEST Andreea Negrea (andreea.negrea) 
         Add value for 26
         Revision 1.2 2022/03/10 14:07:32EET Stefan Dominte (stefan.dominte) 
         RBTM_Tgl_St3 implementation
         Revision 1.1 2021/12/15 16:50:08EET Jenkins Server 01 (Jenkins01) 
         Initial revision
         ...
         Revision 1.2 2021/11/03 11:22:21EET Roberto Cristoi (roberto.cristoi) 
         Removed useless EXPORTED define
         Revision 1.1 2021/09/27 16:44:01EEST Septimiu Vintila (septimiu.vintila) 
         Initial revision
         Member added to project e:/MKSProjects/SBE/PP/DAIMLER_MMA/Phase_01/View_Development/Components/Application/Bsw/_Common/project.pj
...
#define KU8_TRUE                      ((uint8) 170)
#define KU8_FALSE                     ((uint8) 85)
...
#define KU8_TWENTY_ONE                ((uint8)  0x15)
#define KU8_TWENTY_FOUR               ((uint8)  0x18)
#define KU8_TWENTY_SIX                ((uint8)  0x1A)
#define KU8_TWENTY_SEVEN              ((uint8)  0x1B)
#define KU8_THIRTY                    ((uint8)  30)
#define KU8_THIRTY_THREE              ((uint8)  33)
...
#define KU16_ONEHUNDRED               ((uint16) 0x64)
