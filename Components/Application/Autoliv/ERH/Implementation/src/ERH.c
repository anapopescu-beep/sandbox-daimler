 ...
 */
/*
$Revision: 1.2.11.62.1.6 $
$ProjectName: e:/MKSProjects/SBE/PP/DAIMLER_MMA/Phase_02/View_Development/Components/Application/Autoliv/ERH/Implementation/src/project.pj $
 */
/**
...
/**
 * \brief
 *      Counter threshold for Ignition cycle
 */
...
/**
 * \brief
 *      Macro used to send the inhibition status for storage condition: control DTC
 */
#define KU16_ERH_SC1_ControlDTC            (1u)
/**
 * \brief
 *      Macro used to send the inhibition status for storage condition: ignition
 */
#define KU16_ERH_SC2_IgnitonStatus         (2u)
/**
 * \brief
 *      Macro used to send the inhibition status for storage condition: local voltage
 */
#define KU16_ERH_SC3_LocalVoltage          (4u)
/**
 * \brief
 *      Macro used to send the inhibition status for storage condition: system voltage
 */
#define KU16_ERH_SC4_SystemVoltage         (8u)
/**
 * \brief
 *      Macro used to send the inhibition status for storage condition: transportation mode
 */
#define KU16_ERH_SC5_TransportationMode    (16u)
/**
 * \brief
 *      Macro used to send the inhibition status for storage condition: communication
 */
#define KU16_ERH_SC8_CommunicationStatus   (32u)
/**
 * \brief
 *      Macro used to send the inhibition status for storage condition: debounce timer
 */
...
/**
 * \brief
 *      Macro used to send the inhibition status for storage condition: vehicle startup
 */
#define KU16_ERH_SC11_VehicleStartup       (512u)
/**
 * \brief
 *      Macro used to send the inhibition status for storage condition: production mode
 */
#define KU16_ERH_SC12_ProductionMode          (1024u)

/**
 * \brief
 *      Mask used for Network Communications SC group to check the debounce timer
 */
#define KU16_ERH_MASK_DEBOUNCE_TIMER_NC      ((uint16) 0x63B)
/**
 * \brief
 *      Mask used for Network Communications without 15 SC group to check the debounce timer
 */
#define KU16_ERH_MASK_DEBOUNCE_TIMER_NC15      ((uint16) 0x639)
/**
 * \brief
 *      Mask used for Power Distribution SC group 15 to check the debounce timer
 */
#define KU16_ERH_MASK_DEBOUNCE_TIMER_PD      ((uint16) 0x633)
/**
 * \brief
 *      Threshold counter used for SC10 debounce timer
 */
#define KU16_ERH_TIMER_TRESHOLD              (500u)
/**
 * \brief
 *      Macro used to set the storage condition on true
 */
#define BOOL_ERH_SET_STORAGE_CONDITION       (1u)
/**
 * \brief
 *      Macro used to set the storage condition on false
 */
#define BOOL_ERH_CLEAR_STORAGE_CONDITION     (0u)
/**
 * \brief
 *      Mask used for control DTC
 */
#define KU16_ERH_MASK_CONTROL_DTC            (1u)
/**
 * \brief
 *      Mask used on ECU level for storage group
 */
#define KU16_ERH_MASK_ECU_LEVEL              (517u)
/**
 * \brief
 *      Mask used for power distribution storage group
 */
#define KU16_ERH_MASK_POWER_DISTRIBUTION     ((uint16)0x673)
/**
 * \brief
 *      Mask used for Network Communications storage group
 */
#define KU16_ERH_MASK_NETWORK_COM           ((uint16)0x6BB)
/**
 * \brief
 *      Mask used for Network Communications 15 storage group
 */
#define KU16_ERH_MASK_NETWORK_COM15         ((uint16)0x739)

/**
 * \brief
 *      Mask used for confirmed bit of a DTC
 */
...
/**
 * \brief
 *    The status list for AECs which shall be inhibited, when ECU Level storage condition group is not set
 * \remarks
 *    None.
 */
...
/**
 * \brief
 *    The status list for AECs which shall be inhibited, when Power Distribution storage condition group is not set
 *    None.
 */
...
/**
 * \brief
 *    The status list for AECs which shall be inhibited, when Network Communication storage condition group is not set
 * \remarks
 *    None.
 */
...
/**
 * \brief
 *    The status list for AECs which shall be inhibited, when SC1 group is not set
 * \remarks
 *    None.
 */
...
/**
 * \brief
 *    Index used to loop through the ECU Level storage condition group
 * \remarks
 *    None.
 */
...
/**
 * \brief
 *    Index used to loop through the Power Distribution storage condition group
 * \remarks
 *    None.
 */
...
/**
 * \brief
 *    Index used to loop through the Network Communication storage condition group
 * \remarks
 *    None.
 */
...
/**
 * \brief
 *    Index used to loop through the SC1 group.
 * \remarks
 *    None.
 */
