...
**************************************************************************/
#define KU32_NVFLEX_RAM_START_ADDR        ((uint32) 0x14000000)
#define KU32_NVFLEX_RAM_END_ADDR          ((uint32) 0x14000FFF)
#define KU32_RAM_START_ADDR               ((uint32) 0x1FFF9000)
#define KU32_RAM_END_ADDR                 ((uint32) 0x20006FFF)
...
#define KU8_SIXTYFIVE                 ((uint8)  0x41)
#define KU8_ONE_HUNDRED               ((uint8)  100)
#define KU8_ONEHUNDREDTWENTYNINE      ((uint8)  0x81)
#define KU8_ONEHUNDREDTHIRTYTWO       ((uint8)  0x84)
...
#define U32_SWAP_BYTE_ORDER(u32ToSwap) \
   ( \
      (((u32ToSwap) & 0x000000FFUL) << (uint32)24) | \
      (((u32ToSwap) & 0x0000FF00UL) << (uint32)8 ) | \
      (((u32ToSwap) & 0x00FF0000UL) >> (uint32)8 ) | \
      (((u32ToSwap) & 0xFF000000UL) >> (uint32)24) \
   )
