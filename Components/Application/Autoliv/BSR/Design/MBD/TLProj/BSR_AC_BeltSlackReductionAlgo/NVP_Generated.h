...
#ifndef NVP_GENERATED_H
#define NVP_GENERATED_H
...
/******************************************************************************\
   Should_Be_In_NVM: Calibratable global variables, which are declared in a user-written header file
    | Width: 8
\******************************************************************************/
extern uint8 CAL_KU8_BSR_LOOP_CONTROL_THRS_LSB; /* Description: Smooth release */
