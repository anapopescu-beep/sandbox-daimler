...
\******************************************************************************/
extern uint8 b8AbortingModes; /* Description: system context no car cranking confirmed */
extern uint8 b8InhibitingModes; /* Description: system context no car cranking confirmed */
extern uint8 u8HESAecStatus; /* Description: Status of HES aec */
extern uint8 u8HWProtectionStatus; /* Description: Status of HW protection aec */
