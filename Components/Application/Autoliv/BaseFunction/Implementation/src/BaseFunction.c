 ...
 *        SW-C Type:  BaseFunction
 *  Generation Time:  2021-11-17 12:51:33
 *
 *        Generator:  MICROSAR RTE Generator Version 4.24.0
 *                    RTE Core Version 1.24.0
 *          License:  PAI981
 *
 *      Description:  C-Code implementation template for SW-C <BaseFunction>
 *********************************************************************************************************************/
 ...
 * Port Prototypes:
 * ================
 * P_Awake_Diag_Actv_RBTM_FL_ST3
 *   Stay awake for diagnostics active
 *
 * P_Awake_Ignition_On_RBTM_FL_ST3
 *   Stay awake for ignition on
 *
 * P_Awake_NwStart_RBTM_FL_ST3
 *   Stay awake for network startup
 *
 * P_ECU_Id_RBTM_FL_ST3
 *   ECU identifier
 *
 * P_WakeupRsn_RBTM_FL_ST3
 *   Wakeup reason
 *
 *
 ...
 *
 * ECU_Id_RBTM_FL_ST3 of Port Interface IF_ECU_Id_RBTM_FL_ST3
 *   SHORT: ECU identifier
 *      LONG: ECU identifier
 *
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: BaseFunction_Init
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 ...
 *   ---------------------
 *   uint16 Rte_IrvRead_BaseFunction_Init_NmTimer(void)
 *
 *   Explicit Write Access:
 *   ----------------------
 *   void Rte_IrvWrite_BaseFunction_Init_NmTimer(uint16 data)
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: BaseFunction_Init_doc
 *********************************************************************************************************************/
...
FUNC(void, BaseFunction_CODE) BaseFunction_Init(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: BaseFunction_Init
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: BaseFunction_Main
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Write_P_Awake_Diag_Actv_RBTM_FL_ST3_Awake_Diag_Actv_RBTM_FL_ST3(DC_BOOL data)
 *   Std_ReturnType Rte_Write_P_Awake_Ignition_On_RBTM_FL_ST3_Awake_Ignition_On_RBTM_FL_ST3(DC_BOOL data)
 *   Std_ReturnType Rte_Write_P_Awake_NwStart_RBTM_FL_ST3_Awake_NwStart_RBTM_FL_ST3(DC_BOOL data)
 *   Std_ReturnType Rte_Write_P_ECU_Id_RBTM_FL_ST3_ECU_Id_RBTM_FL_ST3(c12_0_4094_1_SNA data)
 *   Std_ReturnType Rte_Write_P_WakeupRsn_RBTM_FL_ST3_WakeupRsn_RBTM_FL_ST3(c10_WakeupRsn_ST3 data)
 *
 * Inter Runnable Variables:
 * =========================
 *   Explicit Read Access:
 *   ---------------------
 *   uint16 Rte_IrvRead_BaseFunction_Main_NmTimer(void)
 *
 *   Explicit Write Access:
 *   ----------------------
 *   void Rte_IrvWrite_BaseFunction_Main_NmTimer(uint16 data)
 *
 * Service Calls:
 * ==============
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_NM_ComM_UserRequest_RequestComMode(ComM_ModeType ComMode)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_ComM_UserRequest_E_MODE_LIMITATION, RTE_E_ComM_UserRequest_E_NOT_OK
 *   Std_ReturnType Rte_Call_PNC_ComM_UserRequest_RequestComMode(ComM_ModeType ComMode)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_ComM_UserRequest_E_MODE_LIMITATION, RTE_E_ComM_UserRequest_E_NOT_OK
 *
 *********************************************************************************************************************/
...
FUNC(void, BaseFunction_CODE) BaseFunction_Main(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: BaseFunction_Main
 *********************************************************************************************************************/
...
FUNC( void, NM_CODE ) Cdd_NmMessageProcessor( CONST( NetworkHandleType, AUTOMATIC ) nmNetworkHandle ) 
{   
}
