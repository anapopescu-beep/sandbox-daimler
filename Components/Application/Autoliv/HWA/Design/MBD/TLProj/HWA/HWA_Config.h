...
\******************************************************************************/
#define CFG_KU32_HWA_MASK_EXT_ABORTING_MODES ((uint32) 2)
#define CFG_KU32_HWA_MASK_EXT_INHIBITING_MODES ((uint32) 8)
#define CFG_KU32_HWA_MASK_INT_ABORTING_MODES ((uint32) 1)
#define CFG_KU32_HWA_MASK_INT_INHIBITING_MODES ((uint32) 4)

/******************************************************************************\
   MERGEABLE_MACRO: mergeable preprocessor macros
\******************************************************************************/
#define CAL_B8_HWA_FUNCTION_ENABLED ((uint8) 170)
...
/******************************************************************************\
   ...
   r file | Width: 8
\******************************************************************************/
extern u8CycleNumberType CFG_KU8_HWA_HAPTIC_WARNING_0_CYCLE_ID; /* LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 255
    */
extern u8CycleNumberType CFG_KU8_HWA_HAPTIC_WARNING_1_CYCLE_ID; /* LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 255
    */
extern u8CycleNumberType CFG_KU8_HWA_LAST_PRE_SAFE_CYCLE_ID; /* LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 255 */
