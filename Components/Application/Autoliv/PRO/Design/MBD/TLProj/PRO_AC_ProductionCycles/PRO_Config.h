...
\******************************************************************************/
#define CFG_KU32_PRO_MASK_ABORTING_MODES ((uint32) 3)
#define CFG_KU32_PRO_MASK_INHIBITING_MODES ((uint32) 2)
...
/******************************************************************************\
   ...
   er file | Width: 8
\******************************************************************************/
extern uint8 pro_abEndDiagReq_UnitDelay[2];
extern boolean pro_au8PreActivationFlag[2];
extern boolean pro_au8PreActivationFlag_UnitDelay[2];
extern uint8 KU8_NB_PROD_CYCLE;
extern uint8 pro_kau8ProdCycleList[2];
