 ...
 *** Codefile             : BFE_AC_BeltFunctionExecution.h
 ***
...
#ifndef BFE_AC_BELTFUNCTIONEXECUTION_H
#define BFE_AC_BELTFUNCTIONEXECUTION_H
...
\********************************************************************************************************************/
extern sint32 Sa1_IRV_O_FirstOrder;
extern sint32 Sa1_IRV_O_SlopeValue;

/********************************************************************************************************************\
   SLGlobal: Default storage class for global variables | Width: 16
\********************************************************************************************************************/
extern sint16 Sa1_BoostPowerOrder;
extern sint16 Sa1_pclMotorPo__r_SetPowerOrder;

/********************************************************************************************************************\
   SLGlobal: Default storage class for global variables | Width: 8
\********************************************************************************************************************/
extern uint8 Sa1_IRV_O_MotorStageStatus;
extern uint8 Sa1_IRV_O_OrderType;
extern uint8 Sa1_PyroTriggeringStatus;
extern uint8 Sa1_ResetMotorStageStatus;
...
\********************************************************************************************************************/
extern void BFE_AC_BeltFunctionExecution(void);

#endif /* BFE_AC_BELTFUNCTIONEXECUTION_H */
/*------------------------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------------------------*/
