...
LOCAL const uint8 cu8WdgRegister[KU8_SPI_DRV_COMMAND_LENGTH] = {(uint8)0x83, (uint8)0xD7};                                 //0xD783 -- wdg timer period: 10s
...
void SBC_Init(void)
{
   ...
   /* dont clear flags so they can be available in app */
