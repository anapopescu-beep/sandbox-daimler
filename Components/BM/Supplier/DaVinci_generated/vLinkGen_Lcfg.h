...
extern uint8 _BmDataDefault_ROM_LIMIT[]; 
extern uint8 _BmDataDefault_ROM_START[]; 
extern uint8 _BmDataDefault_START[]; 
extern uint8 _BmRamConstSection_ROM_LIMIT[]; 
extern uint8 _BmRamConstSection_ROM_START[]; 
extern uint8 _BmRamConstSection_START[]; 
extern uint8 _STACK_C0_START[]; 
extern uint8 _bss_START[]; 
extern uint8 _lc_ge_BmDataDefault[]; 
extern uint8 _lc_ge_BmRamConstSection[]; 
