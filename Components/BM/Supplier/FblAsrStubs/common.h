 ...
 Evolution of the component COMMON.GEN
  (initials, date, modification)
   ...
   modified by :
         ...
         $Log: common.h  $
         Revision 1.1 2021/12/15 15:50:34CET Jenkins Server 01 (Jenkins01) 
         Initial revision
         Member added to project e:/MKSProjects/SBE/PP/DAIMLER_MMA/Phase_02/View_Development/Components/BM/Supplier/FblAsrStubs/project.pj
         Revision 1.1 2021/11/03 11:40:39EET Roberto Cristoi (roberto.cristoi) 
         Initial revision
         Member added to project e:/MKSProjects/SBE/PP/DAIMLER_MMA/Phase_01/View_Development/Components/BM/FblAsrStubs/project.pj
