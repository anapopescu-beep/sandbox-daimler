...
#define MCU_GTM_ATOM_TRIG_INITCHK_READ_MSK    (0x0000AAAAU)
#define MCU_GTM_ATOM_RSTCN0_INITCHK_READ_MSK  (0xAAAA0000U)

#define MCU_GTM_TOM_TRIG_INITCHK_READ_MSK  (0x0000AAAAU)
#define MCU_GTM_TOM_RSTCN0_INITCHK_READ_MSK   (0xAAAA0000U)
#endif
