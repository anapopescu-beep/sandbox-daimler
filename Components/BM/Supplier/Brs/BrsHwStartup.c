...
void BRS_FORCE_ACTIVE brsStartupEntry(void)
{
  ...
  /* this line is required to make sure the register for the sync from Host to HSM is zeroed */
  *((volatile uint32*)(0xF0040038u)) = 0x00000000u;
...
/*                                                                             */
/* =========================================================================== */
  BrsHwWatchdogInitPowerOn(); /* initialize wdog before startup --- keep the board alive without debugger */
  Brs_PreMainStartup();
