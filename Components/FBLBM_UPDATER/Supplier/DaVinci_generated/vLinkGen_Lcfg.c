...
{
  { /*  UpdRamConstSection  */ 
     /*  .Start  */ (uint32)_UpdRamConstSection_START, 
     /*  .End  */ (uint32)_lc_ge_UpdRamConstSection, 
     /*  .Romstart  */ (uint32)_UpdRamConstSection_ROM_START, 
     /*  .Romend  */ (uint32)_UpdRamConstSection_ROM_LIMIT, 
     /*  .Core  */ 0u, 
     /*  .Alignment  */ 0u
  }, 
  { /*  AppDataDefault  */ 
     /*  .Start  */ (uint32)_AppDataDefault_START, 
     /*  .End  */ (uint32)_lc_ge_AppDataDefault, 
     /*  .Romstart  */ (uint32)_AppDataDefault_ROM_START, 
     /*  .Romend  */ (uint32)_AppDataDefault_ROM_LIMIT, 
     /*  .Core  */ 0u, 
     /*  .Alignment  */ 0u
  }, 
  { /*  UpdRamCodeSection_DSPR0  */ 
     /*  .Start  */ (uint32)_UpdRamCodeSection_DSPR0_START, 
     /*  .End  */ (uint32)_lc_ge_UpdRamCodeSection_DSPR0, 
     /*  .Romstart  */ (uint32)_UpdRamCodeSection_DSPR0_ROM_START, 
     /*  .Romend  */ (uint32)_UpdRamCodeSection_DSPR0_ROM_LIMIT, 
     /*  .Core  */ 0u, 
     /*  .Alignment  */ 0u
  }, 
  {
