...
{
   {0x23, 0x31, 0x00}, /*Sw Version*/
   {"1749041800"}, /*Sw PN*/
   {0x8B, 0x00}, /*Software supplier*/
   {0x20, 0x01}, /*DDS package release*/
   {0u, 0u, 0u}, /*DPV*/
   0x00, /*Verification state*/
   { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
   {0x00u, 0x01u}, /*SW compatibility list*/
   0x03, /*# HW Compatiblity entries*/
   {0x00, 0x11u, 0x00u, 0x12u, 0x00, 0x13u} /*HW compatiblity entries*/
};
