 ...
 *********************************************************************************************************************/
/* vMem_30_Tc3xxInf01 knows two compilers and their abstraction. For all other compilers the integrator
...
\ID COV_VMEM_30_TC3XXINF01_COMPILER
 ...
 \ACCEPT XF
 \ACCEPT XX
 \REASON vMem_30_Tc3xxInf01 has to use the dsync function. Its definition depends on the compiler. vMem_30_Tc3xxInf01 knows three compilers. Tests are performed with GNU.
