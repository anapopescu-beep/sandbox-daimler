 ...
 *        \brief  HKDF_HMAC key derivation function according to ANSI X9.63 using SHA-256 as underlying hash function.
 *
 ...
 *  \param[in]     addInput_length       length of additional input in bytes, possibly 0
 *  \param[in,out] derivedKey            (in)  pointer to the output key buffer
 *                                       (out) pointer to buffer, containing the output key
 *  \param[in]     derivedKey_length     length of output key buffer in bytes
 *  \param[in]     watchdog              pointer to watchdog reset function
 ...
 *  \param[in]     derivedKey_length     length of output key buffer in bytes
 *  \param[in]     watchdog              pointer to watchdog reset function
 *  \return        actEXCEPTION_LENGTH   derivedKeyLength too high, i.e., greater than 4 294 967 281
