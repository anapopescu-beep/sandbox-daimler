                                             ...
                                             const eslt_Length inputSize, VSECPRIM_P2CONST_PARA(eslt_Byte) input, VSECPRIM_P2VAR_PARA(eslt_Length) outputSize, VSECPRIM_P2VAR_PARA(eslt_Byte) output)
{
  ...
  /* Update actCLib RC2 */
  {
    ...
    result = actRC2Encrypt((VSECPRIM_P2VAR_PARA(actRC2STRUCT)) workSpace->wsRC2, input, (int)inputSize, output, &enc_len, 0, workSpace->header.watchdog);
...
VSECPRIM_FUNC(eslt_ErrorCode) esl_finalizeEncryptRC2(VSECPRIM_P2VAR_PARA(eslt_WorkSpaceRC2) workSpace, VSECPRIM_P2VAR_PARA(eslt_Length) outputSize, VSECPRIM_P2VAR_PARA(eslt_Byte) output)
{
  ...
  /* Update actCLib RC2 */
  result = actRC2Encrypt((VSECPRIM_P2VAR_PARA(actRC2STRUCT)) workSpace->wsRC2, (VSECPRIM_P2CONST_PARA(eslt_Byte)) NULL_PTR, 0, output, &enc_len, 1, workSpace->header.watchdog);
  if (result == actEXCEPTION_LENGTH)
  {
    return ESL_ERC_OUTPUT_SIZE_TOO_SHORT;
  }
 ...
 *
 */
VSECPRIM_FUNC(eslt_ErrorCode) esl_encryptRC2Block(VSECPRIM_P2VAR_PARA(eslt_WorkSpaceRC2Block) workSpace, VSECPRIM_P2CONST_PARA(eslt_Byte) inputBlock, VSECPRIM_P2VAR_PARA(eslt_Byte) outputBlock)
{
  /* Any NULLs ? */
