  ...
  eslt_Length entropyLength)
{
  ...
  /* check DRBG mode */
  retVal = esl_CTRDRBG_checkMode(workSpace->wsDRBG.mode); /* SBSW_VSECPRIM_FCT_CALL_P2CONST_PARAM */
  ...
  eslt_Length additionalInputLength)
{
  ...
  if (additionalInputPtr != NULL_PTR)
  {
    ...
    retVal = esl_CTRDRBG_checkInputLengthNoDF(workSpace->wsDRBG.mode, additionalInputLength); /* SBSW_VSECPRIM_FCT_CALL_PASSED_BUFFER */
    if (retVal == ESL_ERC_NO_ERROR)
    {
  ...
  eslt_Length personalizationStringLength)
{
  ...
  if (retVal == ESL_ERC_NO_ERROR)
  {
    if (personalizationStringPtr != NULL_PTR)
    {
      ...
      retVal = esl_CTRDRBG_checkInputLengthNoDF(workSpace->wsDRBG.mode, personalizationStringLength); /* SBSW_VSECPRIM_FCT_CALL_PASSED_BUFFER */
  ...
  eslt_Length additionalInputLength)
{
  ...
  else if ((retVal = esl_getBytesCTRDRBG_checkInput(workSpace->wsDRBG.mode, requestedLength, actAESCTRDRBG_MAX_OUTPUT_SIZE, additionalInputLength)) != ESL_ERC_NO_ERROR) /* PRQA S 3326 */ /* MD_VSECPRIM_13.1 */ /* SBSW_VSECPRIM_FCT_CALL_P2CONST_PARAM */
  {
    /* retVal already set */
  }
