  ...
  eslt_SPAKE2PMode ciphersuite)
{
  ...
  if ((retVal = esl_initSPAKE2P_inputCheck(workSpace, domain, domainExt, pointM, mlength, pointN, nlength, ciphersuite)) != ESL_ERC_NO_ERROR) /* PRQA S 3326 */ /* MD_VSECPRIM_13.1 */ /* SBSW_VSECPRIM_CALL_FUNCTION */ /* SBSW_VSECPRIM_FCT_CALL_P2CONST_PARAM */
  {
    /* retVal already set */
  }
  else
