  ...
  const eslt_Length maxDigestLength)
{
  ...
  {
    outputBuffer = workSpace->tempHash; /* SBSW_VSECPRIM_FCT_CALL_PASSED_BUFFER */
  }
  else
  {
    outputBuffer = messageDigest; /* SBSW_VSECPRIM_FCT_CALL_PASSED_BUFFER */
  }
  ...
  VSECPRIM_P2VAR_PARA(eslt_Byte) messageDigest)
{
  ...
  else if ((retVal = (esl_CheckWorkSpaceState(&workSpace->header, ESL_WST_ALGO_HASH))) != ESL_ERC_NO_ERROR) /* PRQA S 3326 */ /* MD_VSECPRIM_13.1 */ /* SBSW_VSECPRIM_FCT_CALL_P2CONST_PARAM */ /* SBSW_VSECPRIM_FCT_CALL_P2CONST_PARAM */
  {
    /* retVal already set
