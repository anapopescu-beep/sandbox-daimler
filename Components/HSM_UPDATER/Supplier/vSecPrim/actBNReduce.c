  ...
  actLengthType shift)
{
 ...
 /* shift b one digit to the left */
  actBNCopy(b, &b[1], b_length - 1u);  /* SBSW_VSECPRIM_FCT_CALL_PASSED_BUFFER_FIXED_SIZE */  /* SBSW_VSECPRIM_FCT_CALL_PASSED_BUFFER_FIXED_SUBADDRESS */
  ...
  VSECPRIM_P2FUNC(VSECPRIM_NONE, void, watchdog)(void))
{
  ...
  {
    --(*qDig);  /* SBSW_VSECPRIM_ARRAY_WRITE_ACCESS_PASSED_BUFFER_FIXED_INDEX */
    r[b_length] = actBNMulDigit(b, b_length, *qDig, r); /* SBSW_VSECPRIM_ARRAY_WRITE_ACCESS_PASSED_BUFFER_FIXED_INDEX */ /* SBSW_VSECPRIM_FCT_CALL_P2CONST_PARAM */ /* SBSW_VSECPRIM_FCT_CALL_PASSED_BUFFER */
  }
  actL3trigger(watchdog); /* PRQA S 1338, 2983, 3112  */ /* MD_MSR_DummyStmt */ /*lint -e438 */ /* SBSW_VSECPRIM_FUNCTION_CALL_WATCHDOG */
} /* PRQA S 6060 */ /* MD_VSECPRIM_STPAR */
   ...
   VSECPRIM_P2VAR_PARA(actBNDIGIT) r, VSECPRIM_P2FUNC(VSECPRIM_NONE, void, watchdog)(void))
{
  ...
  retVal = actBNReduceLengthCheck(a, &a_len, b, &b_len, r); /* SBSW_VSECPRIM_FCT_CALL_P2CONST_PARAM */  /* SBSW_VSECPRIM_FCT_CALL_LOCAL_BUFFER */ /* SBSW_VSECPRIM_FCT_CALL_PASSED_BUFFER_FIXED_SIZE */
