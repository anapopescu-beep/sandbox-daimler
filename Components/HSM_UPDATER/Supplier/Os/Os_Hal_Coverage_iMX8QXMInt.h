...
#if !defined (OS_HAL_COVERAGE_IMX8QXMINT_H)                                                                            /* PRQA S 0883 */ /* MD_Os_0883 */
# define OS_HAL_COVERAGE_IMX8QXMINT_H
...
\ID COV_OS_HALPLATFORMNONAUTOSTARTCORE
  \ACCEPT TX
  \REASON This coverage token is not relevant to IMX8xDualCore derivatives.

\ID COV_OS_HALPLATFORMGETSPINLOCK
  \ACCEPT XF
  \REASON However this code may be reached, the correctness is proved by code review and unit test.

\ID COV_OS_HALPLATFORMMASTERSTARTALLOWED
  \ACCEPT XF
  \REASON The feature of starting the master core is not available on IMX8xDualCore derivatives.
 ...
 */
/***********************************************************************************************************************
 *  END OF FILE: Os_Hal_Coverage_iMX8QXMInt.h
 **********************************************************************************************************************/
