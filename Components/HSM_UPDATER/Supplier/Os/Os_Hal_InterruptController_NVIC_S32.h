...
))
{
  ...
  OS_HAL_MSCM_IRSPRC(IsrConfig->CoreInterruptSource) |= (uint16)(1UL << OS_HAL_MSCM_IRSPRC_COREID2FIELD(CoreId));       /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_INTC_NVIC_IPR */
}
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE,                                           /* COV_OS_HALPLATFORMISRMAPPINGAVAILABILITY */ /* PRQA S 3219 */ /* MD_Os_Hal_3219 */
Os_Hal_INTC_EnableMappedSource,
(
...
))
{
  ...
  OS_HAL_INTC_NVIC_ISER(CoreInterruptSource >> 5u) = (1uL << (CoreInterruptSource & 31uL));                            /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_INTC_NVIC_ISER */
}
...
))
{
  ...
  OS_HAL_INTC_NVIC_ICPR(IsrConfig->CoreInterruptSource >> 5u) = (1uL << (IsrConfig->CoreInterruptSource & 31uL));       /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_INTC_NVIC_ICPR */
}
...
(
  Os_Hal_IntSourceType Source
))                                                                                                                      /* COV_OS_HALPLATFORMUNUSED */
{
  /* #10 Set pending bit in ISPR register for given source. */
  OS_HAL_INTC_NVIC_ISPR(Source >> 5u) = (1uL << (Source & 31uL));                                                       /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_INTC_NVIC_ISPR */
}
...
))
{
  ...
  isInterruptSourceEnabled = ((OS_HAL_INTC_NVIC_ICER(Source >> 5u) & (uint32)(1uL << (Source & 31uL))) != 0u);          /* PRQA S 4404, 0303 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Hal_Rule11.4_0303 */
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE uint8, OS_CODE, OS_ALWAYS_INLINE,                                          /* COV_OS_HALPLATFORMCLEARPENDINGAVAILABILITY */ /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
Os_Hal_INTC_IsInterruptPending,
(
  P2CONST(Os_Hal_IntIsrConfigType, AUTOMATIC, OS_APPL_DATA) IsrConfig
))                                                                                                                      /* COV_OS_HALPLATFORMCLEARPENDINGAVAILABILITY */
{
  ...
  return (uint8)((OS_HAL_INTC_NVIC_ICPR(IsrConfig->CoreInterruptSource >> 5u)                                           /* PRQA S 0303, 4304 */ /* MD_Os_Hal_Rule11.4_0303, MD_Os_C90BooleanCompatibility  */
