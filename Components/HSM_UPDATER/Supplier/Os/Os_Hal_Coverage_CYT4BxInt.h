...
#if !defined (OS_HAL_COVERAGE_CYT4BXINT_H)                                                                               /* PRQA S 0883 */ /* MD_Os_0883 */
# define OS_HAL_COVERAGE_CYT4BXINT_H
...
\ID COV_OS_HALPLATFORMMULTICOREORTPUNSUPPORTED
  ...
  \ACCEPT TX
  \ACCEPT XF
  \REASON See COV_OS_HALPLATFORMTPUNSUPPORTED_XX.
...
\ID COV_OS_HALPLATFORMNONAUTOSTARTCORE
  \ACCEPT TX
  \REASON This coverage token is not relevant for CYT4Bx derivatives.

\ID COV_OS_HALPLATFORMNEEDMORETHAN2CORES
  \ACCEPT XF
  \REASON This coverage token is never reached on a dual-core derivative.

\ID COV_OS_HALPLATFORMCORESTARTUNSUPPORTED
  \ACCEPT XX
  \REASON All cores in Cortex-M subsystem are auto-started on this derivative.
...
\ID COV_OS_HALPLATFORMCOREIDNOTREADABLE
   \ACCEPT XF
   \ACCEPT XX
   \REASON The CoreID is not readable in user mode. This function is not called from the core
           when the thread pointer is also not readable in user mode.

END_COVERAGE_JUSTIFICATION */

#endif /* OS_HAL_COVERAGE_CYT2BXINT_H */

/*!
 * \}
 */
/***********************************************************************************************************************
 *  END OF FILE: Os_Hal_Coverage_CYT2BxInt.h
 **********************************************************************************************************************/
