...
# if defined(OS_HAL_MEMORY_PROTECTION_NXP)
...
# elif defined(OS_HAL_MEMORY_PROTECTION_PMSAV8M)                                                                        /* COV_OS_DERIVATIVEDUMMYMODULE */
#  include "Os_Hal_MemoryProtection_PMSAv8mInt.h"
# else
