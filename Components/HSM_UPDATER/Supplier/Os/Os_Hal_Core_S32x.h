...
# define OS_HAL_MSCM_CPUXNUM                         (*(volatile uint32*) (0x40198004uL))
/*! Control Key Register.  */
# define OS_HAL_MC_ME_CTL_KEY                        (*(volatile uint32*) (0x40088000uL))

/*! XRDC Hardware Configuration 1 register. */
# define OS_HAL_XRDC_HWCFG1                          (*(volatile uint32*) (0x401A40F4uL))
...
#define OS_HAL_MC_ME_PRTN0_CORE_BASE(Id)     (0x40088140uL + (Id * 0x20u))
...
# define OS_HAL_MSCM_IRCPSR(a)     (*(volatile uint32*) (OS_HAL_INTC_MSCM_BASE + (0x200uL) + (0x20uL * (a + 4u))))
/*! Interrupt Router CPa Interrupt 0 Generation Register (IRCPaIGR0). */
# define OS_HAL_MSCM_IRCPGR(a)     (*(volatile uint32*) (OS_HAL_INTC_MSCM_BASE + (0x204uL) + (0x20uL * (a + 4u))))
...
))
{
  ...
  return (Os_CorePhysicalIdType)(OS_HAL_MSCM_CPUXNUM & 0x03uL);                                                         /* PRQA S 0303 */ /* MD_Os_Hal_0303 */
}
 ...
 *
 ...
 ))
 {
   ...
   OS_HAL_SEMA42_RSTGT = OS_HAL_SEMA42_RSTGT_RSTGDP_FIRST_VALUE;                                                         /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_SPINLOCK_SEMA42_RSTGT */

   /* #20 Perform second part of gate reset. */
   OS_HAL_SEMA42_RSTGT = OS_HAL_SEMA42_RSTGT_RSTGDP_SECOND_VALUE;                                                        /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_SPINLOCK_SEMA42_RSTGT */
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(                                                                                           /* PRQA S 3219, 3673 */ /* MD_Os_Rule2.1_3219, MD_Os_Hal_3673_NotUsed */
...
))
{
  ...
  do
  {
      OS_HAL_SEMA42_GATE = (uint8)OS_HAL_SEMA42_LOCK_VALUE;                                                             /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_SPINLOCK_SEMA42_GATE */
  }
  while(OS_HAL_SEMA42_GATE != (uint8)OS_HAL_SEMA42_LOCK_VALUE);                                                         /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* COV_OS_HALPLATFORMSPINLOCKTRYTOLOCKCONDITION */
  ...
  OS_HAL_SEMA42_GATE = OS_HAL_SEMA42_UNLOCK_VALUE;                                                                      /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_SPINLOCK_SEMA42_GATE */
...
))
{
  ...
  OS_HAL_MSCM_IRCPGR(XSigConfig->TargetCoreId) |= (uint32)OS_HAL_MSCM_IRCPGR_TRIGGER_MASK;                              /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_XSIGNAL_MSCM_IRCPGR */
}
...
))
{
  ...
  OS_HAL_MSCM_IRCPSR(XSigConfig->TargetCoreId) = (uint32)OS_HAL_MSCM_IRCPSR_ACKNOWLEDGE_MASK;                           /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_XSIGNAL_MSCM_IRCPSR */
}
...
))
{
  ...
  if(OS_UNLIKELY(Core->CoreId > 2u))                                                                                    /* COV_OS_HALPLATFORMINVSTATE */
  {
    Os_Hal_CoreFreeze();
  }

  /* #20 Set the core boot address and enable the clock. */
  OS_HAL_MC_ME_PRTN0_CORE_ADDR(Core->CoreId) = (Core->CoreStartAddress) | 1u;                                           /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_CORECONFIG_MC_ME_PRTN0_COREX_ADDR */
  OS_HAL_MC_ME_PRTN0_CORE_PCONF(Core->CoreId) |= 1u;                                                                    /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_CORECONFIG_MC_ME_PRTN0_COREX_PCONF */
  OS_HAL_MC_ME_PRTN0_CORE_PUPD(Core->CoreId) |= 1u;                                                                     /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_CORECONFIG_MC_ME_PRTN0_COREX_PUPD */

  /* #30 Start the hardware prosess for core x. */
  OS_HAL_MC_ME_CTL_KEY = (uint32)0x5AF0u;                                                                               /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_CORECONFIG_MC_ME_CTL_KEY */
  OS_HAL_MC_ME_CTL_KEY = (uint32)0xA50Fu;                                                                               /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_CORECONFIG_MC_ME_CTL_KEY */

  /* #40 Wait Until clock is enabled. */
  while ((OS_HAL_MC_ME_PRTN0_CORE_STAT(Core->CoreId) & (uint32)0x01u) != 1u)                                            /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* COV_OS_HALPLATFORMINVSTATE */
  {
    /* Do nothing. */
  }

  /* #50 Release the core reset. */
  *(volatile uint32*)(OS_HAL_RGM_PRST_BASE) &= ~(uint32)(0x1uL << Core->CoreId);                                        /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_CORECONFIG_MC_RGM_PRST_BASE */

  /* #60 Wait until reset has been deasserted. */
  while (((*(volatile uint32*)(OS_HAL_RGM_PSTAT_BASE)) & (0x1uL << Core->CoreId)) == 1u)                                /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* COV_OS_HALPLATFORMINVSTATE */
  {
    /* Do nothing. */
  }
}
