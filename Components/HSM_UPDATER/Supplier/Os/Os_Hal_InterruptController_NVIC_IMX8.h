...
))
{
  ...
  Os_Assert((Os_StdReturnType)((VectorTableStartAddress & 0x7FuL) == 0uL));                                             /* PRQA S 4304 */ /* MD_Os_C90BooleanCompatibility */
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE,                                           /* COV_OS_HALPLATFORMUNUSED */ /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
Os_Hal_INTC_TriggerSoftwareInterrupt,
(
  Os_Hal_IntSourceType Source
...
))
{
  ...
  isInterruptSourceEnabled = ((OS_HAL_INTC_NVIC_ICER(Source >> 5) & (1uL << (Source & 31uL))) != 0u);                   /* PRQA S 4404, 0303 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Hal_Rule11.4_0303 */
...
))
{
  ...
  isInterruptSourceEnabled = (((isInternalInterruptEnabled) & (isExternalInterruptEnabled)) != 0u);                     /* PRQA S 4404, 0404 */ /* MD_Os_C90BooleanCompatibility, MD_Os_MISRA2004-Rule13.2_0404 */
...
))                                                                                                                      /* COV_OS_HALPLATFORMCLEARPENDINGAVAILABILITY */
{
  ...
  return (uint8)((OS_HAL_INTC_NVIC_ICPR(IsrConfig->CoreInterruptSource >> 5) &                                          /* PRQA S 4304, 0303 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Hal_Rule11.4_0303 */
