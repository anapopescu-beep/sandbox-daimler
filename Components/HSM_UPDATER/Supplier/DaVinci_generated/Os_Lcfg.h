...
# define OS_START_SEC_vHsm_Hal_ExternalRequestIsr_CODE
# include "Os_MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */

/**********************************************************************************************************************
 *  vHsm_Hal_ExternalRequestIsr()
 *********************************************************************************************************************/
extern FUNC(void, OS_VHSM_HAL_EXTERNALREQUESTISR_CODE) Os_Isr_vHsm_Hal_ExternalRequestIsr(void);

# define OS_STOP_SEC_vHsm_Hal_ExternalRequestIsr_CODE
# include "Os_MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */
