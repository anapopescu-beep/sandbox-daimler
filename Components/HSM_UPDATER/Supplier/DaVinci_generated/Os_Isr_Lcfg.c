...
/*! Dynamic ISR data: vHsm_Hal_ExternalRequestIsr */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_vHsm_Hal_ExternalRequestIsr_Dyn;
...
CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_vHsm_Hal_ExternalRequestIsr_HwConfig =
{
...
;  
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_vHsm_Hal_ExternalRequestIsr =
{
  /* .Thread   = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_vHsm_Hal_ExternalRequestIsr,
    /* .Context               = */ &OsCfg_Hal_Context_OsCore0_Isr_Level1_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Isr_Core,
    /* .Dyn                   = */ OS_ISR_CASTDYN_ISR_2_THREAD(OsCfg_Isr_vHsm_Hal_ExternalRequestIsr_Dyn),
  ...
  /* .SourceConfig              = */ &OsCfg_Isr_vHsm_Hal_ExternalRequestIsr_HwConfig,
  /* .IsrId                     = */ vHsm_Hal_ExternalRequestIsr,
...
{
  OS_ISR_CASTCONFIG_ISR_2_ISR(OsCfg_Isr_vHsm_Hal_ExternalRequestIsr),
  NULL_PTR
};
