...
/*! HAL ISR2 context configuration data: vHsm_Hal_ExternalRequestIsr */
CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_vHsm_Hal_ExternalRequestIsr =
{
  ...
  /* .Basepri          = */ 32uL,
  /* .Entry            = */ (uint32)&Os_Isr_vHsm_Hal_ExternalRequestIsr,   /* PRQA S 0305 */ /* MD_Os_Hal_Rule11.1_0305 */ /* COMP_WARN_OS_HAL_EXPR_NOT_ARITHMETIC_TYPE */ /* COMP_WARN_OS_EXTENDED_CONST_INITIALIZER */
