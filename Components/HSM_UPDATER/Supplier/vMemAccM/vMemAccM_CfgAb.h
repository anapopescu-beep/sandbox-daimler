 ...
 *********************************************************************************************************************/
/*!
 * \brief       Retrieves the priority of the partition with the given token value.
 * \details     -
 * \param[in]   Token as the partition identifier. Valid range: 0-255 (NOT uint32)
 ...
 */
FUNC(vMemAccM_PublishPriorityType, VMEMACCM_CODE) vMemAccM_CfgAbGetMpTokenPriority
(
