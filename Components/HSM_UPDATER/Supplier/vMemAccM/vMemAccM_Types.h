...
typedef struct
{
  vMemAccM_AddressType Address;             /*!< Current vMemAccM request address. */
  ...
  vMemAccM_AddressAreaIdType AddressAreaId; /*!< Current vMemAccM address area ID. */
