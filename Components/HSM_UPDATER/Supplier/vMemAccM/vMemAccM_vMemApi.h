 ...
 *                with the addresses of respective functions.
 ...
 *
 *                Note that each MemDriver should provide an init function. However, this is not part of vMemAccM,
 *                because it will be called by another instance (SchM), and this interface may be published at
 *                configuration time (node INTERNAL-BEHAVIOR).
 *                A MainFunction is also optional; we assume that especially internal flash devices won't need it.
 *                If necessary, will also be called by SchM; the interface is published at same location as init.
 *********************************************************************************************************************/
...
# define VMEMACCM_VMEMAPI_MAJOR_VERSION                    (3u)
