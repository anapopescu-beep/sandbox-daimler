 ...
 *  \pre          -
 **********************************************************************************************************************/
#define Os_Hal_ReadStackPointer(void)  __get_MSP()
 ...
 *  \pre          -
 **********************************************************************************************************************/
#define Os_Hal_ReadLinkRegister()  __get_return_address();
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE LOCAL_INLINE void Os_Hal_SysCall(uint32 TrapPacket)
{
 ...
 *  Os_Hal_ReadPsr()
 **********************************************************************************************************************/
/*! \brief        Returns the core's special-purpose program status registers (IPSR).
 *  \details      -
 *  \return       iPSR value.
 *  \context      ANY
 *  \reentrant    TRUE
 ...
 *  \pre          -
 **********************************************************************************************************************/
#define Os_Hal_ReadPsr()  __getipsr()
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE LOCAL_INLINE void Os_Hal_Trigger_Context_SvCall(uint32 NewSp)
{
  __asm("mov r0, %0 \n"
        "\tsvc 1"
  :
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE LOCAL_INLINE uint32 Os_Hal_DisableAndReturnPriorState(void)
{
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE LOCAL_INLINE uint32 Os_Hal_LoadExclusive(const volatile uint32* Addr)
{
  uint32 ret;
  __asm( "ldrex %0, [%1]"
  : "=r" (ret)
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE LOCAL_INLINE uint32 Os_Hal_StoreExclusive(volatile uint32* Addr, uint32 Value)
{
  uint32 ret = 1;
  __asm( " strex %0, %2, [%1] "
  : "=r" (ret), "=r" (Addr)
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE LOCAL_INLINE void Os_Hal_StoreFpuRegisters(uint32 FpuRegs)
{
  __asm( " vstm %0, {s16-s31} "
  :
  : "r" (FpuRegs)
  :);
}
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE LOCAL_INLINE void Os_Hal_RestoreFpuRegisters(uint32 FpuRegs)
{
  __asm( " vldm %0, {s16-s31} "
  :
  : "r" (FpuRegs)
  :);
}
