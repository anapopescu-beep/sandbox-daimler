...
))
{
  ...
  return (Os_CorePhysicalIdType)(OS_HAL_MSCM_CPUXNUM & 0x03uL);                                                         /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */
}
...
))
{
  ...
  do
  {
      OS_HAL_SEMA42_GATE = (uint8)OS_HAL_SEMA42_LOCK_VALUE;                                                             /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_SPINLOCK_SEMA42_GATE */
  }
  while(OS_HAL_SEMA42_GATE != (uint8)OS_HAL_SEMA42_LOCK_VALUE);                                                         /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* COV_OS_HALPLATFORMSPINLOCKTRYTOLOCKCONDITION */
...
))
{
  ...
  OS_HAL_MC_ME_PRTN0_CORE_ADDR(Core->CoreId) = (Core->CoreStartAddress) | 1u;                                           /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_CORECONFIG_MC_ME_PRTN0_COREX_ADDR */
  ...
  *(volatile uint32*)(OS_HAL_RGM_PRST_BASE) &= ~(uint32)(0x1uL << Core->CoreId);                                        /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_CORECONFIG_MC_RGM_PRST_BASE */

  /* #60 Wait until reset has been deasserted. */
  while (((*(volatile uint32*)(OS_HAL_RGM_PSTAT_BASE)) & (0x1uL << Core->CoreId)) == 1u)                                /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* COV_OS_HALPLATFORMINVSTATE */
  {
    /* Do nothing. */
  }
}
