 ...
 *
 *  \file
 *  \brief        Compiler abstraction for Microchip compiler.
 *  \details
...
#ifndef OS_HAL_COMPILER_MICROCHIPINT_H
# define OS_HAL_COMPILER_MICROCHIPINT_H
...
#endif /* OS_HAL_COMPILER_MICROCHIPINT_H */

/*!
 * \}
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_Compiler_MicrochipInt.h
 *********************************************************************************************************************/
