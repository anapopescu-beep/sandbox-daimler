...
/* Check the version of vHsmUpd header file */
    ...
    || (VHSMUPD_SW_MINOR_VERSION != (2u)) \
    || (VHSMUPD_SW_PATCH_VERSION != (1u)) )
...
FUNC(void, VHSMUPD_CODE) vHsmUpd_Init( void )
{
  ...
  while(vHsmUpd_AlwaysTrue == TRUE) /* COV_VHSMUPD_ENDLESSLOOP */ /* PRQA S 2871, 2990 */ /* MD_vHsmUpd_Endlessloop */ /*lint !e506 */
  {
...
\ID COV_VHSMUPD_CUSTOMERSWITCH
  \ACCEPT XF
  \ACCEPT TX
  \REASON Switch which is set manually by customer
