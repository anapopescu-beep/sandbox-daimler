 ...
 *  02.02.00  2022-03-18  visfnn  HSM-2356                  vMem function calls moved to callout (compatibility to
 *                                                          vMemAccM version >= 6)
 *  02.02.01  2022-04-04  visfnn  HSM-2431                  Fix Callout example implementation
 *********************************************************************************************************************/
...
# define VHSMUPD_SW_MINOR_VERSION                    (2u)
# define VHSMUPD_SW_PATCH_VERSION                    (1u)
