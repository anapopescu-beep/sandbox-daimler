...
/*! Dynamic task data: Ostask_HighPrio */
OS_LOCAL VAR(Os_TaskType, OS_VAR_NOINIT) OsCfg_Task_Ostask_HighPrio_Dyn;

/*! Dynamic task data: vHsmMainFunctionTask */
OS_LOCAL VAR(Os_TaskType, OS_VAR_NOINIT) OsCfg_Task_vHsmMainFunctionTask_Dyn;
...
CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_Default_Init_Task =
{
  /* .Thread                 = */
  {
    ...
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Task_Prio4294967294,
...
CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_Default_Init_Task_Trusted =
{
  /* .Thread                 = */
  {
    ...
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Task_Prio4294967293,
...
CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_OsTask =
{
  ...
  /* .MaxActivations         = */ (Os_ActivationCntType)10u,
...
/*! Task configuration data: Ostask_HighPrio */
CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_Ostask_HighPrio =
{
  /* .Thread                 = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_Ostask_HighPrio,
    /* .Context               = */ &OsCfg_Hal_Context_Ostask_HighPrio_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Task_Prio20,
    /* .Dyn                   = */ OS_TASK_CASTDYN_TASK_2_THREAD(OsCfg_Task_Ostask_HighPrio_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
...
/*! Task configuration data: vHsmMainFunctionTask */
CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_vHsmMainFunctionTask =
{
  /* .Thread                 = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_vHsmMainFunctionTask,
    /* .Context               = */ &OsCfg_Hal_Context_vHsmMainFunctionTask_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_vHsmMainFunctionTask,
    /* .Dyn                   = */ OS_TASK_CASTDYN_TASK_2_THREAD(OsCfg_Task_vHsmMainFunctionTask_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
