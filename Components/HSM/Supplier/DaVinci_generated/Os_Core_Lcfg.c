...
OS_LOCAL CONST(Os_StackConfigRefType, OS_CONST) OsCfg_Core_OsCore0_StackRefs[OS_CFG_NUM_CORE_OSCORE0_STACKS + 1u] =
{
  ...
  (Os_StackConfigRefType) &OsCfg_Stack_OsCore0_Task_Prio10,
  (Os_StackConfigRefType) &OsCfg_Stack_OsCore0_Task_Prio20,
  (Os_StackConfigRefType) &OsCfg_Stack_OsCore0_Task_Prio4294967293,
  (Os_StackConfigRefType) &OsCfg_Stack_OsCore0_Task_Prio4294967294,
  (Os_StackConfigRefType) &OsCfg_Stack_OsCore0_Task_Prio4294967295,
  (Os_StackConfigRefType) &OsCfg_Stack_vHsmMainFunctionTask,
  NULL_PTR
};
