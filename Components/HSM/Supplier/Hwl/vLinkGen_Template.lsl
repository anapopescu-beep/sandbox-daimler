...
derivative mpe
{
  ...
  memory RegionBlock_HSM_FLASH
  {
    ...
    type = rom;
    size = 243708; /* 238 KiB */
    map (dest=bus:local_bus, dest_offset = 0x80004804, size = 243708);
  }
...
section_layout mpe:vtc:linear
{
  ...
  group VHSM_RAMCODE_ROM_GROUP (ordered, contiguous, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group VHSM_RAMCODE_GROUP (ordered, contiguous, run_addr = mem:mpe:RegionBlock_HSM_RAM)
  {
