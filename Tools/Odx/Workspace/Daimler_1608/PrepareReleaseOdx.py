...
hexViewPath = "S:/Tools/HexView/Installation/HexView-1.14.00/hexview.exe"
...
os.system(hsmScriptPath + hsmMainScript)

# 2 - Prepare the hex files
#   Merge the appheader
subprocess.call(hexViewPath + " " + hsmContainerName +" /MO:"+ appHeaderName + " /XI /s -o " + hsmContainerName)

print("Merged the App Header")

#   Split the data in 0x8 data and 0xA data
subprocess.call(hexViewPath + " " + hsmContainerName +" /AR:0x80000000-0x80FFFFFF /XI /s -o " + hsmContainerName + "_0x8")
subprocess.call(hexViewPath + " " + hsmContainerName +" /AR:0xA0000000-0xA0FFFFFF /XI /s -o " + hsmContainerName + "_0xA")

#   Merge the data into one 0xA file
subprocess.call(hexViewPath + " " + hsmContainerName + "_0xA" +" /MO:"+ hsmContainerName + "_0x8;0x20000000" + " /XI /s -o " + hsmContainerName)

print("Remapped 0x80000000...0x80FFFFFF to 0xA0000000...0xA0FFFFFF")

#   Align the hexfile
subprocess.call(hexViewPath + " " + hsmContainerName + " /AD:0x20 /AL:0x20 /XI /s -o " + hsmContainerName)

print("Aligned the data for TriCore flashing")

#   Remove temporary files
os.remove(hsmContainerName + "_0x8")
os.remove(hsmContainerName + "_0xA")
