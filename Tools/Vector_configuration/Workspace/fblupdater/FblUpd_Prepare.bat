...
set APPL_PATH_SRC=%~dp0\..\..\..\..\Components\FBL_UPDATER\Autoliv\FblUsr\Implementation\src
set APPL_PATH_INC=%~dp0\..\..\..\..\Components\FBL_UPDATER\Autoliv\FblUsr\Implementation\inc
set FBL_HEX_LOCATION=%~dp0\..\..\..\Build_Env\Workspace\Outputs\fbl\Out\fbl.hex
set NEW_FBL_DIR=%~dp0\..\..\..\Build_Env\Workspace\Outputs\fbl_upd\Out
