...
set fblbm_upd_LOCATION=%~dp0\..\..\..\Build_Env\Workspace\Outputs\fblbm_upd\Out
...
rem dag_swdl_files_create.py -i %fblbm_upd_LOCATION%\bm_upd.hex

echo Moving DAG SWDL files to bm_updATER's output folder

move bm_upd.crc %fblbm_upd_LOCATION% > nul
move bm_upd_cccv2.sig %fblbm_upd_LOCATION% > nul
move bm_upd_enc.hex %fblbm_upd_LOCATION% > nul
move bm_upd_enc_cccv2.sig %fblbm_upd_LOCATION% > nul
move bm_upd_lz77.hex %fblbm_upd_LOCATION% > nul
move bm_upd_lz77_cccv2.sig %fblbm_upd_LOCATION% > nul
move bm_upd_lz77_enc.hex %fblbm_upd_LOCATION% > nul
move bm_upd_lz77_enc_cccv2.sig %fblbm_upd_LOCATION% > nul
move bm_upd_lzma.hex %fblbm_upd_LOCATION% > nul
move bm_upd_lzma_cccv2.sig %fblbm_upd_LOCATION% > nul
move bm_upd_lzma_enc.hex %fblbm_upd_LOCATION% > nul
move bm_upd_lzma_enc_cccv2.sig %fblbm_upd_LOCATION% > nul
