...
def upload_file_in_PTC(PTC_User_Name, PTC_Password, PTC_File_Path, PTC_Change_Package_ID):
    ...
    sync = os.system(path_to_si + "ci --cpid=" + PTC_Change_Package_ID + " --nocloseCP --description='Jenkins File Updater - Update automatically files'  --forceConfirm=yes " + PTC_File_Path )
