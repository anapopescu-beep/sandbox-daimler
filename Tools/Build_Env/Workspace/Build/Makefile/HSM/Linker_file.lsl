...
derivative mpe
{
  ...
  memory RegionBlock_HSM_RAM
  {
    ...
    type = ram;
    size = 97904; /* 96 KiB */
    map (dest=bus:local_bus, dest_offset = 0x20000180, size = 97904);
  }
  memory RegionBlock_HSM_INTVEC_FLASH
  {
    ...
    type = rom;
    size = 256; /* 256 Byte */
    map (dest=bus:local_bus, dest_offset = 0x80008060, size = 256);
  }
  memory RegionBlock_HSM_ENTRY
  {
    mau = 8;
    type = rom;
    size = 256; /* 256 Byte */
    map (dest=bus:local_bus, dest_offset = 0x80008160, size = 256);
  }
  memory RegionBlock_HSM_FLASH
  {
    ...
    type = rom;
    size = 243452; /* 238 KiB */
    map (dest=bus:local_bus, dest_offset = 0x80008260, size = 243452);
  }
  memory RegionBlock_HSM_DATA_FLASH
  {
    mau = 8;
    type = nvram;
    size = 131072; /* 128 KiB */
    map (dest=bus:local_bus, dest_offset = 0xAFC00000, size = 131072);
  }
  memory vLinkGenMemoryRegionBlock
  {
    ...
    type = ram;
    size = 65536; /* 64 KiB */
    map (dest=bus:local_bus, dest_offset = 0xF0050000, size = 65536);
  }
}
...
section_layout mpe:vtc:linear
{
  ...
  "VHSM_FIRMWARE_UPDATER" = 0x80000001;

  group OS_DATA_CORE0_VAR_ROM_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group OS_DATA_CORE0_VAR_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_RAM)
  {
  ...
  group OS_DATA_SHARED_VAR_ROM_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group OS_DATA_SHARED_VAR_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_RAM)
  {
  ...
  group OS_EXCVEC_CORE0_CODE_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group OS_EXCVEC_CORE0_CONST_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group OS_GLOBALSHARED_CONST_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group OS_GLOBALSHARED_VAR_ROM_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group OS_GLOBALSHARED_VAR_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_RAM)
  {
  ...
  group OS_GLOBALSHARED_VAR_SAVED_ZONE_ROM_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
    group OS_GLOBALSHARED_VAR_SAVED_ZONE_INIT_ROM (ordered, contiguous, fill, align = 4)
    {
  ...
  group OS_GLOBALSHARED_VAR_SAVED_ZONE_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_RAM)
  {
    group OS_GLOBALSHARED_VAR_SAVED_ZONE_INIT (ordered, contiguous, fill, align = 4)
    {
    ...
    {
      reserved "OS_GLOBALSHARED_VAR_SAVED_ZONE_INIT_PAD" (size = 0);
    }
    "_OS_GLOBALSHARED_VAR_SAVED_ZONE_INIT_START" = "_lc_gb_OS_GLOBALSHARED_VAR_SAVED_ZONE_INIT";
    "_OS_GLOBALSHARED_VAR_SAVED_ZONE_INIT_END" = ("_lc_ge_OS_GLOBALSHARED_VAR_SAVED_ZONE_INIT" == 0) ? 0 : "_lc_ge_OS_GLOBALSHARED_VAR_SAVED_ZONE_INIT" - 1;
    "_OS_GLOBALSHARED_VAR_SAVED_ZONE_INIT_LIMIT" = "_lc_ge_OS_GLOBALSHARED_VAR_SAVED_ZONE_INIT";

    group OS_GLOBALSHARED_VAR_SAVED_ZONE_NOINIT (ordered, contiguous, fill)
    {
    ...
    "_OS_GLOBALSHARED_VAR_SAVED_ZONE_NOINIT_END" = ("_lc_ge_OS_GLOBALSHARED_VAR_SAVED_ZONE_NOINIT" == 0) ? 0 : "_lc_ge_OS_GLOBALSHARED_VAR_SAVED_ZONE_NOINIT" - 1;
    "_OS_GLOBALSHARED_VAR_SAVED_ZONE_NOINIT_LIMIT" = "_lc_ge_OS_GLOBALSHARED_VAR_SAVED_ZONE_NOINIT";
  ...
  group OS_INTVEC_CODE_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group OS_INTVEC_CONST_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group OS_INTVEC_CORE0_CODE_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group OS_INTVEC_CORE0_CONST_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group OS_STACKS_CORE0_VAR_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_RAM)
  {
  ...
  group OS_USER_CODE_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group STACK_C0_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_RAM)
  {
  ...
  group Startup_Code_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group VHSM_RAMCODE_ROM_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
    group VHSM_RAMCODE_ROM (ordered, contiguous, fill, align = 4)
    {
      section "VHSM_RAMCODE_ROM_SEC" (fill, blocksize = 1, attributes = rx)
      {
        group (load_addr)
        {
    ...
    "_VHSM_RAMCODE_ROM_START" = "_lc_gb_VHSM_RAMCODE_ROM";
    "_VHSM_RAMCODE_ROM_LIMIT" = "_lc_ge_VHSM_RAMCODE_ROM";

  }

  group VHSM_RAMCODE_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_RAM)
  {
    group VHSM_RAMCODE_ALIGN (align = 4)
    {
      reserved "VHSM_RAMCODE_ALIGN" (size = 4);
    }
    group VHSM_RAMCODE (ordered, contiguous, fill, align = 1, copy)
    {
      /* Due to a Linker issue: 'COPY_TO_RAM' const groups cannot be created with inner output section */
      select "[.]text.vHsmRamCode";
    }
    group VHSM_RAMCODE_PAD (align = 4)
    {
      reserved "VHSM_RAMCODE_PAD" (size = 0);
    }
    "_VHSM_RAMCODE_START" = "_lc_gb_VHSM_RAMCODE";
    "_VHSM_RAMCODE_END" = ("_lc_ge_VHSM_RAMCODE" == 0) ? 0 : "_lc_ge_VHSM_RAMCODE" - 1;
    "_VHSM_RAMCODE_LIMIT" = "_lc_ge_VHSM_RAMCODE";

    "_VHSM_RAMCODE_ALL_START" = "_VHSM_RAMCODE_START";
    "_VHSM_RAMCODE_ALL_END" = "_VHSM_RAMCODE_END";
    "_VHSM_RAMCODE_ALL_LIMIT" = "_VHSM_RAMCODE_LIMIT";
  }

  group vHsmEntryPoint_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_ENTRY)
  {
    group vLinkGenConstSectionGroup (ordered, contiguous, fill)
    {
      section "vLinkGenConstSectionGroup_SEC" (fill, blocksize = 2, attributes = rx)
      {
        select ".text.vHsmEntryPoint";
      }
    }
    "_vLinkGenConstSectionGroup_START" = "_lc_gb_vLinkGenConstSectionGroup";
    "_vLinkGenConstSectionGroup_END" = ("_lc_ge_vLinkGenConstSectionGroup" == 0) ? 0 : "_lc_ge_vLinkGenConstSectionGroup" - 1;
    "_vLinkGenConstSectionGroup_LIMIT" = "_lc_ge_vLinkGenConstSectionGroup";

    "_vHsmEntryPoint_ALL_START" = "_vLinkGenConstSectionGroup_START";
    "_vHsmEntryPoint_ALL_END" = "_vLinkGenConstSectionGroup_END";
    "_vHsmEntryPoint_ALL_LIMIT" = "_vLinkGenConstSectionGroup_LIMIT";
  }

  group OS_CODE_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group OS_CONST_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group Const_Default_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group Data_Default_ROM_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_FLASH)
  {
  ...
  group Data_Default_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:RegionBlock_HSM_RAM)
  {
