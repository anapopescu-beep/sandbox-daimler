# 1 "S:/Tools/Tessy/WORKSP~1/Stubs/Nvp_Tessy_Stubs.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "S:/Tools/Tessy/WORKSP~1/Stubs/Nvp_Tessy_Stubs.c"
# 37 "S:/Tools/Tessy/WORKSP~1/Stubs/Nvp_Tessy_Stubs.c"
# 1 "S:/Tools/Tessy/WORKSP~1/Stubs/Nvp_Generated.h" 1
# 24 "S:/Tools/Tessy/WORKSP~1/Stubs/Nvp_Generated.h"
# 1 "S:/COMPON~1/APPLIC~1/Autoliv/TL_Lib/IMPLEM~1/inc/common.h" 1
# 25 "S:/Tools/Tessy/WORKSP~1/Stubs/Nvp_Generated.h" 2
...
# 27 "S:/Tools/Tessy/WORKSP~1/Stubs/Nvp_Generated.h" 2
...
# 38 "S:/Tools/Tessy/WORKSP~1/Stubs/Nvp_Tessy_Stubs.c" 2
# 54 "S:/Tools/Tessy/WORKSP~1/Stubs/Nvp_Tessy_Stubs.c"
...
NVP_BLOCK_ID_ECU_LOCATION_StorageType NVP_BLOCK_ID_ECU_LOCATION_DefaultData = {0U};

NVP_BLOCK_ID_BELT_ASSEMBLY_MANUF_DATE_AND_SN_StorageType NVP_BLOCK_ID_BELT_ASSEMBLY_MANUF_DATE_AND_SN_DefaultData = {0U};

NVP_BLOCK_ID_HB_CALIBRATION_StorageType NVP_BLOCK_ID_HB_CALIBRATION_DefaultData = {0U};

NVP_BLOCK_ID_AEE_TRACEABILITY_StorageType NVP_BLOCK_ID_AEE_TRACEABILITY_DefaultData = {0U};

NVP_BLOCK_ID_EXECUTION_COUNTERS_StorageType NVP_BLOCK_ID_EXECUTION_COUNTERS_DefaultData = {0U};

NVP_BLOCK_ID_TESTS_PARAM_StorageType NVP_BLOCK_ID_TESTS_PARAM_DefaultData = {0U};

NVP_BLOCK_ID_CYCLE_0_StorageType NVP_BLOCK_ID_CYCLE_0_DefaultData = {0U};

NVP_BLOCK_ID_STEP_0_StorageType NVP_BLOCK_ID_STEP_0_DefaultData = {0U};
...
CALIB_BLOCK_ID_EOL_PARAM_StorageType CALIB_BLOCK_ID_EOL_PARAM_RomBlockData = {0U};

CALIB_BLOCK_ID_BFS_PRIO_PARAM_StorageType CALIB_BLOCK_ID_BFS_PRIO_PARAM_RomBlockData = {0U};

CALIB_BLOCK_ID_PID_PARAM_StorageType CALIB_BLOCK_ID_PID_PARAM_RomBlockData = {0U};

CALIB_BLOCK_ID_WEIGHT_REL_TABLE_StorageType CALIB_BLOCK_ID_WEIGHT_REL_TABLE_RomBlockData = {0U};

CALIB_BLOCK_ID_WEIGHT_TENS0_TABLE_StorageType CALIB_BLOCK_ID_WEIGHT_TENS0_TABLE_RomBlockData = {0U};

CALIB_BLOCK_ID_WEIGHT_TENS1_TABLE_StorageType CALIB_BLOCK_ID_WEIGHT_TENS1_TABLE_RomBlockData = {0U};

CALIB_BLOCK_ID_WEIGHT_TENS2_TABLE_StorageType CALIB_BLOCK_ID_WEIGHT_TENS2_TABLE_RomBlockData = {0U};

CALIB_BLOCK_ID_WEIGHT_TENS3_TABLE_StorageType CALIB_BLOCK_ID_WEIGHT_TENS3_TABLE_RomBlockData = {0U};

CALIB_BLOCK_ID_INT_CURRENT_CORR_StorageType CALIB_BLOCK_ID_INT_CURRENT_CORR_RomBlockData = {0U};

CALIB_BLOCK_ID_INT_CURRENT_TABLE_StorageType CALIB_BLOCK_ID_INT_CURRENT_TABLE_RomBlockData = {0U};

CALIB_BLOCK_ID_POWER_DEGRADATION_StorageType CALIB_BLOCK_ID_POWER_DEGRADATION_RomBlockData = {0U};

CALIB_BLOCK_ID_ECPL_ALPHA_TABLE_StorageType CALIB_BLOCK_ID_ECPL_ALPHA_TABLE_RomBlockData = {0U};

CALIB_BLOCK_ID_ECPL_BETA_TABLE_StorageType CALIB_BLOCK_ID_ECPL_BETA_TABLE_RomBlockData = {0U};

CALIB_BLOCK_ID_ECPL_OTHER_PARAM_StorageType CALIB_BLOCK_ID_ECPL_OTHER_PARAM_RomBlockData = {0U};

CALIB_BLOCK_ID_BPA_MOTOR_CURRENT_StorageType CALIB_BLOCK_ID_BPA_MOTOR_CURRENT_RomBlockData = {0U};

CALIB_BLOCK_ID_VOLT_THRS_StorageType CALIB_BLOCK_ID_VOLT_THRS_RomBlockData = {0U};

CALIB_BLOCK_ID_BATTERY_LOSS_DETECTION_THRS_StorageType CALIB_BLOCK_ID_BATTERY_LOSS_DETECTION_THRS_RomBlockData = {0U};

CALIB_BLOCK_ID_BOOST_StorageType CALIB_BLOCK_ID_BOOST_RomBlockData = {0U};

CALIB_BLOCK_ID_ECU_PROPERTIES_StorageType CALIB_BLOCK_ID_ECU_PROPERTIES_RomBlockData = {0U};

CALIB_BLOCK_ID_SW_SELF_PROTECTION_THRS_StorageType CALIB_BLOCK_ID_SW_SELF_PROTECTION_THRS_RomBlockData = {0U};

CALIB_BLOCK_ID_MOTOR_RESIST_PARAM_StorageType CALIB_BLOCK_ID_MOTOR_RESIST_PARAM_RomBlockData = {0U};

CALIB_BLOCK_ID_BOOST_ACTIVATION_StorageType CALIB_BLOCK_ID_BOOST_ACTIVATION_RomBlockData = {0U};
