...
**  VERSION   : 15.0.0                                                        **
**                                                                            **
**  DATE, TIME: 2021-05-17, 10:38:58  !!!IGNORE-LINE!!!                   **
**                                                                            **
...
{
  0U, /* Physical index value for Channel SpiChannel_0 Channel ID 0 */
...
static const Spi_JobConfigType Spi_kJobConfig_Core0[] =
{
  ...
  /* Job:SpiJob_0 */
  {
    ...
    Spi_BaudRateAndClockParam(  /* Baudrate = 200000.0Hz */
...
static const Spi_ChannelConfigType Spi_kChannelConfig_Core0[] =
{
  ...
  /* Channel:SpiChannel_0 */
  {
    ...
    0xffffU,         /* Number of Data Elements */
